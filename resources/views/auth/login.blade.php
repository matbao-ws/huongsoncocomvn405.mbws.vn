<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}" dir="ltr" data-bs-theme="light" data-color-theme="Orange_Theme"
                                        ...
                                        <div class="col-lg-11">
                                            <div class="card-body">
                                                <a href="{{ route('admin.login') }}"
                                                    ...
                                                    <img src="{{ $siteBranding['admin_logo_url'] }}" width="140"
                                                        class="dark-logo" alt="MatBaoWS">
                                                </a>
                                                <h3 class="lh-base mb-4">{{ __('auth.login.heading') }}</h3>
                                                ...
                                                <form method="POST" action="{{ route('admin.login.store') }}"
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <a class="text-primary link-dark fs-3"
                                                                href="{{ route('admin.password.request') }}">{{ __('auth.login.forgot_password') }}</a>
                                                        </div>
                                                        <div class="position-relative">
                                                            <input type="password" name="password"
                                                                class="form-control pe-5" id="password"
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <iconify-icon id="toggle-password-icon"
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                                        <div class="form-check">
                                                            <input class="form-check-input primary" type="checkbox"
                                                                value="1" name="remember" id="remember"
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-primary w-100 py-8 mb-4 rounded-1"
                                                        id="login-submit">
                                                        <span
                                                            class="login-submit-text">{{ __('auth.login.submit') }}</span>
                                                    ...
                                                    @foreach (__('auth.login.slides') as $index => $slide)
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <img src="{{ asset('admin-assets/images/backgrounds/' . ($index === 2 ? 'auth-icon2.png' : 'auth-icon.png')) }}"
                                                                    alt="{{ $slide['title'] }}"
                                                                    width="{{ $index === 2 ? 235 : 350 }}"
                                                                    class="img-fluid">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (togglePasswordBtn && passwordInput && togglePasswordIcon) {
                togglePasswordBtn.addEventListener('click', function() {
                    ...
                    togglePasswordIcon.setAttribute('icon', isPassword ? 'solar:eye-line-duotone' :
            ...
            const setLoading = function(isLoading) {
                ...
                submitText.textContent = isLoading ? @json(__('auth.login.processing')) :
                @json(__('auth.login.submit'));
            };
