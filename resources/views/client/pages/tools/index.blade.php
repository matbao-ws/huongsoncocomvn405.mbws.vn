...
<head>
  ...
  <title>Công cụ tính chi phí thuê máy và TCO | Hương Sơn</title>
  <meta name="description" content="Công cụ ước tính chi phí thuê máy photocopy và so sánh TCO giữa mua và thuê." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/cong-cu/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Công cụ tính chi phí thuê máy và TCO | Hương Sơn" />
  <meta property="og:description" content="Công cụ ước tính chi phí thuê máy photocopy và so sánh TCO giữa mua và thuê." />
  <meta property="og:url" content="https://huongsonco.com.vn/cong-cu/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Công cụ tính toán chi phí" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Công cụ tính toán chi phí</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Ước tính nhanh chi phí thuê máy và so sánh tổng chi phí sở hữu (TCO) trước khi nhận báo giá chính thức.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Công cụ</span>
      </nav>
    </div>
  </section>
