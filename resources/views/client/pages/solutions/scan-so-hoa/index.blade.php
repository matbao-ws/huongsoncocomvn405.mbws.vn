...
@section('title', "Dịch vụ scan và số hóa tài liệu – scan tốc độ cao, OCR, chuẩn hóa dữ liệu | Hương Sơn")
@section('meta_description', "Giải pháp scan và số hóa tài liệu cho cơ quan, trường học, ngân hàng và doanh nghiệp: máy scan tốc độ cao, OCR, chuẩn hóa metadata và bàn giao dữ liệu có kiểm soát chất lượng.")
@section('canonical', url('/giai-phap/scan-so-hoa/'))
@section('jsonld')
...
<head>
  ...
  <title>Dịch vụ scan và số hóa tài liệu – scan tốc độ cao, OCR, chuẩn hóa dữ liệu | Hương Sơn</title>
  <meta name="description" content="Giải pháp scan và số hóa tài liệu cho cơ quan, trường học, ngân hàng và doanh nghiệp: máy scan tốc độ cao, OCR, chuẩn hóa metadata và bàn giao dữ liệu có kiểm soát chất lượng." />
  <meta name="keywords" content="dịch vụ scan tài liệu, dịch vụ số hóa tài liệu, dịch vụ số hóa hồ sơ, máy scan tốc độ cao A4 A3, dịch vụ scan OCR, chuyển hồ sơ giấy sang PDF, scan tài liệu số lượng lớn, số hóa hồ sơ lưu trữ, máy scan có OCR, máy scan OCR, scan OCR tiếng Việt, scan tài liệu OCR, scan PDF OCR, scan văn bản thành Word, scan tài liệu thành PDF, quản lý tài liệu điện tử, quản lý hồ sơ điện tử, phần mềm quản lý tài liệu, OCR tiếng Việt, phần mềm OCR tiếng Việt, OCR tài liệu, lưu trữ tài liệu số, lưu trữ hồ sơ điện tử" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/scan-so-hoa/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Dịch vụ scan và số hóa tài liệu – scan tốc độ cao, OCR, chuẩn hóa dữ liệu | Hương Sơn" />
  <meta property="og:description" content="Giải pháp scan và số hóa tài liệu cho cơ quan, trường học, ngân hàng và doanh nghiệp: máy scan tốc độ cao, OCR, chuẩn hóa metadata và bàn giao dữ liệu có kiểm soát chất lượng." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/scan-so-hoa/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Giải pháp scan và số hóa tài liệu" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Scan &amp; Digital Document</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Giải pháp scan và số hóa tài liệu</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp thiết bị và dịch vụ số hóa tài liệu theo mô hình đầy đủ: scan tốc độ cao, kiểm soát chất lượng, OCR, chuẩn hóa tên và metadata, bàn giao dữ liệu kèm biên bản.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Giải pháp scan và số hóa tài liệu</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Hồ sơ giấy tăng theo năm, chiếm diện tích và xuống cấp theo thời gian.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tra cứu một hồ sơ cũ phụ thuộc vào người biết cách sắp xếp.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Mua máy scan rồi tự làm nhưng không có quy ước đặt tên và metadata nên dữ liệu vẫn không tra cứu được.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tài liệu có nhiều dạng: A4 và A3, một mặt và hai mặt, giấy mỏng và giấy dày, hồ sơ đã đóng quyển.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Không có tiêu chí kiểm tra chất lượng nên không biết dữ liệu bàn giao có đủ và đúng hay không.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Yêu cầu bảo mật khiến việc đưa tài liệu ra ngoài xử lý trở nên phức tạp.</span>
        </li>
      </ul>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-6">Hương Sơn xây giải pháp theo chuỗi Scan → OCR → phân loại → lưu trữ → tra cứu → workflow, và đóng vai trò tích hợp giải pháp: khảo sát, thiết bị, triển khai, quy trình, đào tạo và vận hành. Phần OCR, hệ thống quản lý tài liệu, lưu trữ và API do đối tác chuyên môn cung cấp.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Khảo sát khối lượng và phân loại tài liệu: khổ giấy, số mặt, độ dày giấy, tình trạng đóng quyển.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chọn dòng máy scan phù hợp: máy để bàn, máy theo phòng ban, máy tốc độ cao, máy scan mạng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Thiết lập quy trình scan và tiêu chí kiểm soát chất lượng trước khi bắt đầu.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">OCR khi phạm vi dịch vụ yêu cầu, để dữ liệu tìm kiếm được theo nội dung.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quy ước đặt tên, cấu trúc thư mục và các trường metadata được đơn vị phê duyệt trước.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kiểm tra tỷ lệ lỗi, thiếu trang và lệch trang; scan lại phần chưa đạt.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bàn giao dữ liệu kèm biên bản số lượng và chất lượng, kèm hướng dẫn vận hành.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hai hình thức: đơn vị mua thiết bị và tự làm với sự hỗ trợ của Hương Sơn, hoặc thuê Hương Sơn thực hiện dịch vụ.</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-scan-so-hoa/" class="text-[#181923] hover:text-[#1A9900] transition">Máy scan tốc độ cao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Chọn theo khối lượng, khổ giấy và loại tài liệu</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="text-[#181923] hover:text-[#1A9900] transition">Máy photocopy – máy đa chức năng có scan</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Cho khối lượng vừa và scan phát sinh hằng ngày</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="text-[#181923] hover:text-[#1A9900] transition">Thiết bị văn phòng phụ trợ</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Workstation và thiết bị cho khu vực scan</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="text-[#181923] hover:text-[#1A9900] transition">Vật tư – linh kiện máy scan</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Con lăn, tấm ma sát và vật tư thay theo số trang</td></tr>
          </tbody>
        </table>
      </div>
        </div>
      ...
      <ol class="mt-2">
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Số hồ sơ, số trang, khổ giấy, tình trạng tài liệu và mức độ ưu tiên từng nhóm.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Định dạng file, độ phân giải, có OCR hay không, quy ước đặt tên, cấu trúc thư mục và trường metadata.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Chọn thiết bị và hình thức thực hiện</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Chọn dòng máy scan; xác định đơn vị tự làm hay Hương Sơn thực hiện dịch vụ, và địa điểm thực hiện.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Kiểm đếm hồ sơ và số trang, lập biên bản tiếp nhận.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Chuẩn bị và scan</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Phân loại, tháo ghim, làm phẳng; scan kèm kiểm soát chất lượng trong quá trình.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">OCR và chuẩn hóa</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">OCR khi có yêu cầu; đặt tên, nhập metadata theo quy ước đã phê duyệt.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Kiểm tra và bàn giao</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Soát tỷ lệ lỗi, thiếu trang, lệch trang; bàn giao dữ liệu kèm biên bản và hướng dẫn vận hành.</p>
        </li>
      </ol>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kiểm đếm và lập biên bản ở cả hai đầu: khi tiếp nhận và khi bàn giao.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quy ước đặt tên và metadata được phê duyệt trước khi bắt đầu, không tự quyết giữa quá trình.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tiêu chí kiểm soát chất lượng rõ ràng theo tỷ lệ lỗi, thiếu trang và lệch trang.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo mật: không sao lưu hoặc chuyển tài liệu ngoài phạm vi hợp đồng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đào tạo vận hành cho nhân sự của đơn vị sau khi bàn giao.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo trì và cung cấp vật tư thay thế cho thiết bị scan theo số trang đã sử dụng.</span>
        </li>
      </ul>
        <div class="mt-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Tiến độ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Theo kế hoạch từng giai đoạn</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Báo cáo khối lượng hoàn thành theo kỳ đã thống nhất</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Chất lượng dữ liệu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Kiểm tra 100% số trang</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Scan lại phần không đạt, không tính thêm phí</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Bảo mật tài liệu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Cam kết trong hợp đồng</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Chỉ xử lý trong phạm vi và địa điểm đơn vị chấp thuận</td></tr>
          </tbody>
        </table>
      </div></div>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">Số hóa chỉ có giá trị khi dữ liệu tra cứu được. Vì vậy phần quy ước dữ liệu và kiểm soát chất lượng quan trọng không kém phần thiết bị.</p>
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Thời gian tra cứu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Hồ sơ giấy: phụ thuộc kho và người phụ trách</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Đã số hóa: tra theo tên, metadata, hoặc nội dung nếu có OCR</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Rủi ro mất tài liệu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Hồ sơ giấy: hỏng, ẩm, cháy, thất lạc</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Đã số hóa: có bản dữ liệu và sao lưu</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Diện tích lưu trữ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tăng theo năm</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Hồ sơ gốc lưu trữ gọn, làm việc trên dữ liệu</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Tự làm hay thuê dịch vụ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tự làm: đầu tư thiết bị, bố trí nhân sự, tự chịu rủi ro chất lượng</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê dịch vụ: trả theo khối lượng thực tế, có cam kết chất lượng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Khả năng dùng chung dữ liệu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Hồ sơ giấy: một bản, một nơi</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Đã số hóa: nhiều người tra cứu cùng lúc theo phân quyền</td></tr>
          </tbody>
        </table>
      </div>
        <div class="mt-7">
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          ...
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Thường tính theo số trang đã scan, phân biệt theo khổ giấy, một mặt hoặc hai mặt, tình trạng tài liệu, có OCR hay không và số trường metadata cần nhập. Đơn giá được chốt sau khảo sát khối lượng thực tế.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn thực hiện tại đơn vị hay đưa tài liệu đi?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Cả hai đều thực hiện được, nhưng địa điểm luôn do đơn vị quyết định và ghi rõ trong hợp đồng. Với tài liệu có yêu cầu bảo mật cao, phương án thực hiện tại đơn vị thường được chọn.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Nên mua máy scan tự làm hay thuê dịch vụ?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Nếu khối lượng phát sinh liên tục hằng ngày thì nên có thiết bị riêng. Nếu là một khối hồ sơ tồn cần xử lý một lần, thuê dịch vụ thường nhanh và rẻ hơn. Nhiều đơn vị làm cả hai: thuê dịch vụ cho khối tồn và mua máy cho phát sinh hằng ngày.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Chọn máy scan theo tiêu chí nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Theo khối lượng trang mỗi ngày, khổ giấy lớn nhất cần scan, có cần scan hai mặt một lần chạy hay không, độ dày và tình trạng giấy, và có cần scan qua mạng dùng chung hay không. Xem <a class="text-[#1A9900] font-medium hover:underline" href="/san-pham/may-scan-so-hoa/">danh mục máy scan</a>.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Dữ liệu bàn giao ở định dạng nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Theo yêu cầu của đơn vị, thường là PDF hoặc PDF có lớp văn bản khi có OCR, kèm cấu trúc thư mục và quy ước đặt tên đã được phê duyệt trước.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="sol-scan-so-hoa-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="solution" />
          <input type="hidden" name="product_model" value="" />
          <input type="hidden" name="solution_slug" value="scan-so-hoa" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-sol-scan-so-hoa-hp">Bỏ trống ô này</label>
            <input type="text" id="f-sol-scan-so-hoa-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Yêu cầu khảo sát số hóa cho đơn vị</h2>
        <p class="text-gray-300 text-[15px] leading-relaxed">Hương Sơn khảo sát khối lượng và loại tài liệu, đề xuất thiết bị, quy trình, quy ước dữ liệu và đơn giá theo trang.</p>
      </div>
