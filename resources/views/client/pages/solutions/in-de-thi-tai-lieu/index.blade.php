...
@section('canonical', url('/giai-phap/in-de-thi-tai-lieu/'))
@section('jsonld')
...
<head>
  ...
  <title>Giải pháp in đề thi và in tài liệu số lượng lớn – máy in nhân bản, phối trang | Hương Sơn</title>
  <meta name="description" content="Máy in nhân bản siêu tốc, máy photocopy tốc độ cao và thiết bị hoàn thiện sau in cho nhu cầu in đề thi, biểu mẫu, tài liệu và ấn phẩm nội bộ số lượng lớn." />
  <meta name="keywords" content="in đề thi số lượng lớn, máy in nhân bản tốc độ cao, máy in đề thi tốc độ cao, in tài liệu số lượng lớn, máy phối trang tài liệu, máy DFC phối đề, thiết bị hoàn thiện sau in, giải pháp phòng in, máy in tài liệu khảo thí, máy in giáo trình số lượng lớn, máy in tài liệu trường học số lượng lớn, máy in tài liệu đào tạo, máy in tài liệu hội nghị" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/in-de-thi-tai-lieu/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Giải pháp in đề thi và in tài liệu số lượng lớn – máy in nhân bản, phối trang | Hương Sơn" />
  <meta property="og:description" content="Máy in nhân bản siêu tốc, máy photocopy tốc độ cao và thiết bị hoàn thiện sau in cho nhu cầu in đề thi, biểu mẫu, tài liệu và ấn phẩm nội bộ số lượng lớn." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/in-de-thi-tai-lieu/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Giải pháp in đề thi và in tài liệu số lượng lớn" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Giải pháp in đề thi và in tài liệu số lượng lớn</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp thiết bị và giải pháp cho nhu cầu in sản lượng lớn: máy in nhân bản siêu tốc, máy photocopy tốc độ cao, máy phối trang và thiết bị hoàn thiện sau in – dùng cho in đề thi, biểu mẫu, tài liệu và ấn phẩm nội bộ.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Giải pháp in đề thi và in tài liệu số lượng lớn</span>
      </nav>
    </div>
  </section>
