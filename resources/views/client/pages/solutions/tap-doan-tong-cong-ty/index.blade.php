...
@section('canonical', "https://huongsonco.com.vn/giai-phap/tap-doan-tong-cong-ty/")
@section('jsonld')
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-solutions.jpg" alt="Giải pháp in ấn, tài liệu và số hóa cho Tập đoàn – Tổng công ty" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      <span class="font-handwriting text-2xl sm:text-3xl text-[#5eb74c] font-bold block mb-2">Enterprise Solutions</span>
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Giải pháp in ấn, tài liệu và số hóa cho Tập đoàn – Tổng công ty</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Hương Sơn cung cấp thiết bị, dịch vụ quản lý in ấn theo sản lượng, scan và số hóa tài liệu cho tập đoàn, tổng công ty, nhà máy, đơn vị logistics và doanh nghiệp có nhiều chi nhánh.</p>
