...
@section('canonical', url('/giai-phap/ngan-hang-tai-chinh/'))
@section('jsonld')
...
<head>
  ...
  <title>Giải pháp máy in, photocopy và scan cho Ngân hàng – Tài chính | Hương Sơn</title>
  <meta name="description" content="Cung cấp máy photocopy A3, máy in A4, máy scan, quản lý in ấn theo hệ thống chi nhánh, vật tư và dịch vụ kỹ thuật cho ngân hàng và tổ chức tài chính." />
  <meta name="keywords" content="máy photocopy cho ngân hàng, máy in cho ngân hàng, giải pháp in ấn ngân hàng, secure print, quản lý máy in hệ thống chi nhánh, máy scan chứng từ ngân hàng, vật tư máy in ngân hàng, máy scan ngân hàng, giải pháp số hóa cho ngân hàng" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/ngan-hang-tai-chinh/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Giải pháp máy in, photocopy và scan cho Ngân hàng – Tài chính | Hương Sơn" />
  <meta property="og:description" content="Cung cấp máy photocopy A3, máy in A4, máy scan, quản lý in ấn theo hệ thống chi nhánh, vật tư và dịch vụ kỹ thuật cho ngân hàng và tổ chức tài chính." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/ngan-hang-tai-chinh/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Giải pháp thiết bị in ấn và tài liệu cho Ngân hàng – Tài chính" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Banking &amp; Finance</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Giải pháp thiết bị in ấn và tài liệu cho Ngân hàng – Tài chính</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp thiết bị in ấn, máy scan, vật tư và dịch vụ kỹ thuật cho ngân hàng và tổ chức tài chính – với yêu cầu cao về tính liên tục, bảo mật tài liệu và khả năng phục vụ nhiều điểm giao dịch.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Giải pháp thiết bị in ấn và tài liệu cho Ngân hàng – Tài chính</span>
      </nav>
    </div>
  </section>
