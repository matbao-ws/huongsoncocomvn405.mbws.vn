...
@section('title', "Cho thuê máy photocopy cho trường học – A3/A4, mực và bảo trì | Hương Sơn")
@section('meta_description', "Cho thuê máy photocopy và máy in A3/A4 cho trường THPT, THCS và đơn vị giáo dục. Thuê theo tháng, theo định mức bản in hoặc gói trọn gói có mực, bảo trì và hỗ trợ kỹ thuật.")
@section('canonical', url('/giai-phap/giao-duc/cho-thue-may-truong-hoc/'))
@section('jsonld')
...
<head>
  ...
  <title>Cho thuê máy photocopy cho trường học – A3/A4, mực và bảo trì | Hương Sơn</title>
  <meta name="description" content="Cho thuê máy photocopy và máy in A3/A4 cho trường THPT, THCS và đơn vị giáo dục. Thuê theo tháng, theo định mức bản in hoặc gói trọn gói có mực, bảo trì và hỗ trợ kỹ thuật." />
  <meta name="keywords" content="cho thuê máy photocopy cho trường học, cho thuê máy photocopy trường THPT, cho thuê máy photocopy trường THCS, cho thuê máy photocopy A3 cho trường học, thuê máy photocopy bao mực bảo trì, bảng giá thuê máy photocopy trường học, thuê máy photocopy cho phòng giáo vụ" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/giao-duc/cho-thue-may-truong-hoc/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Cho thuê máy photocopy cho trường học – A3/A4, mực và bảo trì | Hương Sơn" />
  <meta property="og:description" content="Cho thuê máy photocopy và máy in A3/A4 cho trường THPT, THCS và đơn vị giáo dục. Thuê theo tháng, theo định mức bản in hoặc gói trọn gói có mực, bảo trì và hỗ trợ kỹ thuật." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/giao-duc/cho-thue-may-truong-hoc/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Cho thuê máy photocopy, máy in A3/A4 cho trường học" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">SCHOOL PRINT</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Cho thuê máy photocopy, máy in A3/A4 cho trường học</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp dịch vụ cho thuê máy photocopy và máy in A3/A4 cho trường THCS, THPT và các đơn vị giáo dục. Đơn vị có thể chọn thuê theo tháng, theo định mức bản in, hoặc gói có mực, bảo trì và hỗ trợ kỹ thuật.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/giao-duc/" class="hover:text-white transition">Giải pháp thiết bị &amp; in ấn cho ngành Giáo dục</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Cho thuê máy photocopy, máy in A3/A4 cho trường học</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Dịch vụ cho thuê máy photocopy và máy in A3/A4 phục vụ công việc in ấn thường xuyên của trường học, tính phí theo tháng hoặc theo sản lượng bản in.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường THPT, THCS, Tiểu học, phòng giáo vụ, phòng đào tạo, văn phòng trường và các đơn vị trực thuộc Sở GD&ĐT.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Đảm bảo máy luôn hoạt động và chi phí in ấn dự đoán được theo tháng, thay vì đầu tư mua máy rồi tự lo mực, linh kiện và sửa chữa.</p>
          </div>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Máy photocopy cũ hỏng liên tục vào đúng đầu năm học và mùa kiểm tra, không có phương án thay thế nhanh.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chi phí mực, drum, linh kiện và sửa chữa phát sinh rời rạc, khó dự toán cho cả năm học.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kinh phí đầu tư mua máy mới không sẵn có hoặc phải chờ chu kỳ ngân sách.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Sản lượng in dao động mạnh giữa mùa thấp điểm và mùa cao điểm nhưng thiết bị chỉ có một cấu hình cố định.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Không có số liệu sản lượng theo phòng ban nên không biết chi phí in thực tế là bao nhiêu.</span>
        </li>
      </ul>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-6">Đơn vị không mua thiết bị mà mua năng lực in ấn ổn định theo tháng. Hương Sơn chịu trách nhiệm về máy, vật tư và bảo trì; đơn vị chỉ trả phí thuê và phần sản lượng vượt định mức nếu có.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Khảo sát trước khi báo giá: số giáo viên, số học sinh, số phòng ban, sản lượng bình quân tháng, tháng cao điểm và khổ giấy sử dụng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chọn cấu hình A3 hoặc A4 theo nhu cầu thực tế, không chào máy vượt nhu cầu.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Cấu trúc phí: phí thuê cố định + định mức bản in miễn phí + đơn giá bản vượt định mức.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Thời hạn hợp đồng linh hoạt 12, 24 hoặc 36 tháng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Giao máy, chốt counter đầu kỳ và đào tạo sử dụng cho nhân sự của đơn vị.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chốt counter định kỳ và xuất hóa đơn theo kỳ đã thống nhất.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo trì, thay vật tư và xử lý sự cố trong phạm vi hợp đồng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đánh giá gia hạn hoặc nâng cấp cấu hình trước 90 ngày khi hợp đồng gần hết hạn.</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="text-[#181923] hover:text-[#1A9900] transition">Máy photocopy – máy đa chức năng A3</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Copy, in, scan hồ sơ cho văn phòng trường và phòng chuyên môn</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-in-laser/" class="text-[#181923] hover:text-[#1A9900] transition">Máy in laser A4 – máy in đa chức năng A4</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Phòng giáo vụ, phòng đào tạo, văn thư</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-scan-so-hoa/" class="text-[#181923] hover:text-[#1A9900] transition">Máy scan tài liệu</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Bổ sung cho gói có nhu cầu số hóa hồ sơ</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="text-[#181923] hover:text-[#1A9900] transition">Vật tư – linh kiện – tiêu hao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mực, drum, bột từ, linh kiện thay thế trong quá trình thuê</td></tr>
          </tbody>
        </table>
      </div>
        </div>
      ...
      <ol class="mt-2">
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Khảo sát nhu cầu</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Xác định số giáo viên, học sinh, phòng ban, sản lượng bình quân tháng, tháng cao điểm và khổ giấy.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Tính sản lượng và chọn cấu hình</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Tính sản lượng bình quân và cao điểm, từ đó chọn cấu hình A3, A4 hoặc kết hợp cho phù hợp.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Xây gói phí thuê</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Xác định phí thuê, định mức bản in miễn phí và đơn giá bản vượt; gửi báo giá kèm cơ cấu giá rõ ràng.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Ký hợp đồng</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Ký hợp đồng 12, 24 hoặc 36 tháng với phạm vi cung cấp, cơ chế nghiệm thu và thanh toán xác định.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Giao máy và đào tạo</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Giao – lắp đặt, chốt counter đầu kỳ, hướng dẫn sử dụng cho nhân sự phụ trách.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Vận hành và chốt kỳ</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Bảo trì, thay vật tư, xử lý sự cố; chốt counter định kỳ và xuất hóa đơn.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Đánh giá gia hạn</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Trước 90 ngày hết hạn, đánh giá lại nhu cầu để gia hạn hoặc nâng cấp cấu hình.</p>
        </li>
      </ol>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo trì định kỳ theo lịch, không chờ đến khi máy hỏng mới xử lý.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Vật tư trong phạm vi hợp đồng do Hương Sơn cung cấp và quản lý tồn.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kênh tiếp nhận sự cố qua điện thoại, Zalo và email với đầu mối kỹ thuật xác định.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Theo dõi lịch sử thiết bị, vật tư và số lần xử lý theo từng mã máy.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phương án thay máy khi thiết bị không khắc phục được tại chỗ.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chốt counter đúng kỳ để hai bên có cùng số liệu sản lượng khi nghiệm thu.</span>
        </li>
      </ul>
        <div class="mt-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">P1 – Máy dừng hoàn toàn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tiếp nhận ≤ 30 phút</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mục tiêu có mặt ≤ 2 giờ; thay máy nếu không khắc phục được</td></tr>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">So sánh nên đặt trên tổng chi phí một năm học, gồm cả mực, linh kiện, sửa chữa và thời gian máy dừng – không chỉ so sánh giá mua máy.</p>
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Vốn ban đầu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: chi trả toàn bộ giá máy trong một kỳ ngân sách</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: không cần vốn đầu tư, chi phí trải theo tháng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Mực và linh kiện</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: đơn vị tự mua từng lần, giá và chất lượng không ổn định</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: trong phạm vi hợp đồng hoặc theo định mức đã thống nhất</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Sửa chữa và máy dừng</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: chi phí phát sinh không dự đoán được</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: có cam kết thời gian xử lý và phương án thay máy</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Dự toán chi phí in</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: khó tách chi phí in thực tế</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: có số liệu counter theo kỳ, dự toán được</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Nâng cấp khi nhu cầu tăng</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: phải đầu tư máy mới</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: đánh giá lại và đổi cấu hình khi gia hạn</td></tr>
          </tbody>
        </table>
      </div>
        <div class="mt-7">
      <div class="border-l-4 border-[#1A9900] bg-[#f5f8fb] px-6 py-5">
        <p class="text-[14.5px] text-gray-600 leading-relaxed">Ba cấu hình gợi ý: Basic – 01 máy A3 đa chức năng cho trường quy mô nhỏ; Standard – 01 máy A3 kết hợp 01 máy A4 cho trường THCS/THPT; Plus – 01 máy A3, 02 máy A4 và 01 máy scan cho trường có bộ phận văn thư hoặc có nhu cầu số hóa hồ sơ.</p>
      </div></div>
        </div>
      </div>
    </div>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Thuê máy photocopy cho trường học tính phí như thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Theo cấu trúc phí thuê cố định hàng tháng, kèm định mức bản in miễn phí và đơn giá cho bản in vượt định mức. Định mức được xác định từ sản lượng khảo sát thực tế của đơn vị, không áp một con số chung.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Gói thuê có bao gồm mực và bảo trì không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có gói bao mực và bảo trì. Đơn vị cũng có thể chọn gói chỉ thuê máy và tự lo vật tư. Phạm vi cung cấp được ghi rõ trong báo giá và hợp đồng.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Thời hạn thuê tối thiểu là bao lâu?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Hợp đồng thuê thường xuyên ký theo 12, 24 hoặc 36 tháng. Với nhu cầu ngắn hạn theo mùa vụ hoặc theo kỳ thi, xem <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/in-de-thi/">gói thuê máy in đề thi theo kỳ</a>.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Máy cho thuê là máy mới hay máy đã qua sử dụng?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Tùy cấu hình và ngân sách của đơn vị. Tình trạng thiết bị, model và cấu hình được ghi rõ trong báo giá, hợp đồng và biên bản bàn giao – dùng cùng một tên thiết bị trên toàn bộ hồ sơ.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Nếu sản lượng vượt định mức thì tính thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Phần vượt định mức tính theo đơn giá bản in đã thống nhất trong hợp đồng, căn cứ counter được chốt định kỳ và có xác nhận của hai bên.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Trường ở tỉnh xa Hà Nội có thuê được không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Hương Sơn xem xét theo địa bàn và khả năng phục vụ kỹ thuật thực tế, vì cam kết SLA chỉ có giá trị khi đội kỹ thuật tiếp cận được trong thời gian cam kết. Vui lòng gửi địa chỉ đơn vị để Hương Sơn xác nhận phạm vi phục vụ.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có thể vừa thuê máy vừa nhờ Hương Sơn quản lý toàn bộ hệ thống in không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Được, đó là gói <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/quan-ly-in-an-truong-hoc/">quản lý in ấn trọn gói (Managed Print Service)</a> – Hương Sơn quản lý thiết bị, vật tư, bảo trì, counter và SLA.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Nhận bảng giá thuê máy</h2>
        ...
        <form class="lead-form" id="sol-cho-thue-may-truong-hoc-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="solution" />
          <input type="hidden" name="product_model" value="" />
          <input type="hidden" name="solution_slug" value="cho-thue-may-truong-hoc" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-sol-cho-thue-may-truong-hoc-hp">Bỏ trống ô này</label>
            <input type="text" id="f-sol-cho-thue-may-truong-hoc-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
          ...
          </div><input type="hidden" name="nhu_cau" value="PRINT" />
          <div class="sm:col-span-1">
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Nhận bảng giá thuê máy theo đúng sản lượng của trường</h2>
        <p class="text-gray-300 text-[15px] leading-relaxed">Gửi số phòng ban và sản lượng in bình quân tháng – Hương Sơn đề xuất cấu hình, định mức bản in và phí thuê để đơn vị đưa vào kế hoạch năm học.</p>
      </div>
