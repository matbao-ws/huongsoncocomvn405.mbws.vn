...
@section('canonical', "https://huongsonco.com.vn/giai-phap/giao-duc/cho-thue-may-truong-hoc/")
@section('jsonld')
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Cho thuê máy photocopy, máy in A3/A4 cho trường học
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Hương Sơn cung cấp dịch vụ cho thuê máy photocopy và máy in A3/A4 cho trường THCS, THPT và các đơn vị giáo dục. Đơn vị có thể chọn thuê theo tháng, theo định mức bản in, hoặc gói có mực, bảo trì và hỗ trợ kỹ thuật.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Cho thuê máy photocopy, máy in A3/A4 cho trường học" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
