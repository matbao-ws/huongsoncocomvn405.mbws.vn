...
<!-- PAGE HERO (REDESIGNED BREADCRUMB BANNER) -->
  <section class="relative bg-[#0d1626] py-10 sm:py-14 overflow-hidden border-b border-white/10">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-education.jpg" alt="Cho thuê máy in đề thi – in sao đề thi cho Sở GD&amp;ĐT" class="w-full h-full object-cover object-center opacity-40 scale-105 transform motion-safe:transition-transform motion-safe:duration-1000" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
      ...
      <p class="max-w-2xl mx-auto text-gray-200 text-[14.5px] sm:text-[15.5px] leading-relaxed mb-6 font-normal">
        Hương Sơn cung cấp dịch vụ cho thuê máy in đề thi, máy in nhân bản Duplo tốc độ cao và giải pháp in sao đề thi cho Sở GD&amp;ĐT, Hội đồng thi và các điểm sao in. Dịch vụ bao gồm thiết bị, Master, mực, vận chuyển, lắp đặt, kỹ thuật trực và phương án máy dự phòng.
      </p>
