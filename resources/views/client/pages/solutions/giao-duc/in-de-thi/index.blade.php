...
@section('title', "Cho thuê máy in đề thi Duplo – Giải pháp EXAM PRO cho Sở GD&ĐT | Hương Sơn")
@section('meta_description', "Cho thuê máy in đề thi, máy in nhân bản Duplo tốc độ cao và giải pháp in sao đề thi cho Sở GD&ĐT, Hội đồng thi và điểm sao in. Gồm thiết bị, Master, mực, vận chuyển, lắp đặt, kỹ thuật trực và máy dự phòng.")
@section('canonical', url('/giai-phap/giao-duc/in-de-thi/'))
@section('jsonld')
<script type="application/ld+json">{
  ...
  "logo": "https://huongsonco.com.vn/assets/images/brand/logo-huong-son.svg",
...
<head>
  ...
  <title>Cho thuê máy in đề thi Duplo – Giải pháp EXAM PRO cho Sở GD&ĐT | Hương Sơn</title>
  <meta name="description" content="Cho thuê máy in đề thi, máy in nhân bản Duplo tốc độ cao và giải pháp in sao đề thi cho Sở GD&ĐT, Hội đồng thi và điểm sao in. Gồm thiết bị, Master, mực, vận chuyển, lắp đặt, kỹ thuật trực và máy dự phòng." />
  <meta name="keywords" content="cho thuê máy in đề thi, cho thuê máy in sao đề thi, dịch vụ in sao đề thi, cho thuê máy in đề thi Duplo, cho thuê máy in nhân bản Duplo, máy in đề thi tốc độ cao, thuê máy in nhân bản phục vụ kỳ thi tốt nghiệp THPT, máy dự phòng in đề thi, vật tư Master mực Duplo, giải pháp in đề thi bảo mật, in đề thi THPT, in đề thi tốt nghiệp THPT, in đề thi vào lớp 10, thuê máy photocopy mùa thi, giải pháp in đề thi THPT, giải pháp in đề thi cho Sở GDĐT, giải pháp in đề thi cho Phòng GDĐT, EXAM PRO, giải pháp EXAM PRO" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/giao-duc/in-de-thi/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Cho thuê máy in đề thi Duplo – Giải pháp EXAM PRO cho Sở GD&ĐT | Hương Sơn" />
  <meta property="og:description" content="Cho thuê máy in đề thi, máy in nhân bản Duplo tốc độ cao và giải pháp in sao đề thi cho Sở GD&ĐT, Hội đồng thi và điểm sao in. Gồm thiết bị, Master, mực, vận chuyển, lắp đặt, kỹ thuật trực và máy dự phòng." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/giao-duc/in-de-thi/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Cho thuê máy in đề thi – in sao đề thi cho Sở GD&amp;ĐT" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">EXAM PRO</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Cho thuê máy in đề thi – in sao đề thi cho Sở GD&amp;ĐT</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp dịch vụ cho thuê máy in đề thi, máy in nhân bản Duplo tốc độ cao và giải pháp in sao đề thi cho Sở GD&amp;ĐT, Hội đồng thi và các điểm sao in. Dịch vụ bao gồm thiết bị, Master, mực, vận chuyển, lắp đặt, kỹ thuật trực và phương án máy dự phòng.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/giao-duc/" class="hover:text-white transition">Giải pháp thiết bị &amp; in ấn cho ngành Giáo dục</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Cho thuê máy in đề thi – in sao đề thi cho Sở GD&amp;ĐT</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Dịch vụ cho thuê máy in đề thi và vận hành điểm sao in theo kỳ thi: máy in nhân bản siêu tốc, máy photocopy tốc độ cao, vật tư, kỹ thuật trực và máy dự phòng.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Sở GD&ĐT, Phòng Khảo thí – QLCLGD, Hội đồng thi và các điểm sao in đề thi có nhu cầu in sản lượng lớn trong thời gian ngắn.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Đảm bảo kỳ thi in đủ, in đúng tiến độ và không bị phụ thuộc vào một thiết bị duy nhất – không cần đơn vị đầu tư mua máy cho nhu cầu chỉ dùng theo mùa.</p>
          </div>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Sản lượng in của kỳ thi dồn vào một vài ngày, vượt xa công suất thiết bị thường ngày của đơn vị.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kỳ thi phụ thuộc vào một máy duy nhất: máy dừng là toàn bộ tiến độ sao in dừng theo.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Mua máy nhân bản siêu tốc cho nhu cầu vài ngày mỗi năm là đầu tư kém hiệu quả, còn phát sinh khấu hao, lưu kho và bảo trì cả năm.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Vật tư Master và mực nếu thiếu giữa kỳ sẽ làm gián đoạn công việc, trong khi việc dự trù định mức không đơn giản.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Yêu cầu bảo mật khu vực sao in rất cao – không phải nhà cung cấp nào cũng có quy trình phù hợp.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hồ sơ dự toán, hợp đồng và nghiệm thu phải khớp về số ngày thuê, khối lượng và vật tư thực tế.</span>
        </li>
      </ul>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-6">EXAM PRO là gói dịch vụ trọn phạm vi cho một kỳ in sao đề thi. Hương Sơn chịu trách nhiệm về thiết bị, vật tư, kỹ thuật và phương án dự phòng; đơn vị tập trung vào nghiệp vụ khảo thí.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Máy chính: máy in nhân bản siêu tốc được chọn theo sản lượng dự kiến của từng điểm in.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Máy dự phòng: tối thiểu 01 máy dự phòng cho mỗi cụm in của kỳ thi lớn.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Vật tư: Master và mực đủ cho toàn kỳ, kèm tồn dự phòng tại điểm in.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bàn giao trước: máy được vệ sinh, bảo dưỡng, in test đạt và giao trước thời điểm in chính thức để đơn vị làm quen.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kỹ thuật: đầu mối kỹ thuật xác định, hỗ trợ từ xa và có mặt tại hiện trường theo cam kết.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hoàn thiện sau in: bổ sung máy phối trang khi đơn vị có nhu cầu phối đề, đóng bộ.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo mật: tuân thủ tuyệt đối quy định an ninh khu vực sao in của đơn vị.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hồ sơ: biên bản bàn giao, nhật ký vận hành, biên bản chốt counter, nghiệm thu và thanh lý đầy đủ.</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="text-[#181923] hover:text-[#1A9900] transition">Máy in nhân bản tốc độ cao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Máy chính cho in sao đề thi sản lượng lớn – lựa chọn theo bản/phút và quy mô điểm in</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="text-[#181923] hover:text-[#1A9900] transition">Máy photocopy tốc độ cao A3</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Máy in sao đề thi khổ A3/A4, dùng độc lập hoặc bổ trợ cho máy nhân bản</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-phoi-trang-hoan-thien-sau-in/" class="text-[#181923] hover:text-[#1A9900] transition">Máy phối trang – hoàn thiện sau in</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Phối đề, đóng bộ, hoàn thiện tài liệu sau khi in</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="text-[#181923] hover:text-[#1A9900] transition">Vật tư Master – mực – linh kiện</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Định mức cho toàn kỳ thi kèm tồn dự phòng tại điểm in</td></tr>
          </tbody>
        </table>
      </div>
        </div>
      ...
      <ol class="mt-2">
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">T-60 → T-30</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Khảo sát kỳ thi</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Xác định các kỳ thi và đợt khảo sát cần sao in trong năm, số điểm sao in, số máy dự kiến tại mỗi điểm, sản lượng và khổ giấy, yêu cầu an ninh khu vực sao in.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">T-30 → T-15</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Chốt giải pháp</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Cấu hình máy chính và máy dự phòng, định mức Master/mực, nhân sự kỹ thuật, phương án vận chuyển; xác định đầu mối kỹ thuật và đầu mối nghiệm thu của đơn vị.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">T-15 → T-7</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Chuẩn bị thiết bị và vật tư</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Vệ sinh, bảo dưỡng và in test đạt yêu cầu; chuẩn bị Master, mực, phụ kiện và thiết bị phụ trợ; phân công kỹ thuật trực; xác nhận máy dự phòng đã sẵn sàng.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">T-2</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Bàn giao tại điểm in</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Giao và lắp máy, kiểm tra nguồn điện, chạy thử, chốt counter đầu kỳ, lập biên bản bàn giao. Không giao máy sát giờ in chính thức.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Ngày in</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Vận hành và trực kỹ thuật</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Kỹ thuật trực theo phương án, ghi nhật ký vận hành, bổ sung vật tư khi cần, xử lý sự cố theo cấp độ; chuyển sang máy dự phòng nếu không khắc phục được tại chỗ.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Sau kỳ thi</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Thu hồi và nghiệm thu</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Chốt counter và vật tư thực tế, thu hồi thiết bị, nghiệm thu, xuất hóa đơn và thanh lý; hồ sơ dùng cùng tên thiết bị và cấu hình với báo giá và hợp đồng.</p>
        </li>
      </ol>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Checklist bắt buộc trước khi xe rời kho: đúng model và serial, đã vệ sinh – bảo dưỡng, in test đạt, đủ Master/mực, đủ phụ kiện và thiết bị phụ trợ, có biên bản bàn giao, xác định địa chỉ và đầu mối nhận máy, tên kỹ thuật trực, máy dự phòng đã sẵn sàng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kênh liên lạc ưu tiên trong ngày in: điện thoại và Zalo tới đầu mối kỹ thuật được chỉ định.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhật ký vận hành ghi nhận sản lượng, vật tư đã dùng và sự cố phát sinh theo từng máy.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phương án thay máy dự phòng được xác định trước, không xử lý theo tình huống.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tuân thủ tuyệt đối quy định bảo mật khu vực sao in; không ghi nhận, sao lưu hoặc công bố nội dung đề thi.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Biên bản nghiệm thu xác nhận máy, số ngày thuê, vật tư thực tế, tình trạng thiết bị và counter.</span>
        </li>
      </ul>
        <div class="mt-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">P1 – Máy dừng hoàn toàn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tiếp nhận ≤ 30 phút</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mục tiêu có mặt ≤ 2 giờ; không khắc phục được thì thay máy dự phòng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">P2 – Ảnh hưởng chức năng chính</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tiếp nhận ≤ 30 phút</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Xử lý ngay trong ngày in</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">P3 – Lỗi nhỏ, không ảnh hưởng tiến độ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tiếp nhận trong ngày</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Xử lý theo lịch, không làm dừng công việc</td></tr>
          </tbody>
        </table>
      </div></div>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">Với nhu cầu chỉ phát sinh theo kỳ thi, thuê máy thường hiệu quả hơn mua – vì chi phí chỉ tồn tại trong thời gian thực dùng, còn rủi ro thiết bị được chuyển sang nhà cung cấp.</p>
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Thời gian sử dụng thực tế</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: máy nằm kho phần lớn thời gian trong năm</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chỉ tính chi phí cho số ngày thuê thực tế</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Khấu hao và lưu kho</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: phát sinh cả 12 tháng</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: không phát sinh</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Máy dự phòng</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: phải mua thêm máy thứ hai mới có dự phòng</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: nằm trong phương án dịch vụ theo quy mô kỳ thi</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Vật tư Master – mực</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: đơn vị tự dự trù và tự quản tồn</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: theo thực tế hoặc theo định mức đã thống nhất</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Kỹ thuật trực trong kỳ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: đơn vị tự bố trí hoặc thuê ngoài từng lần</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: nằm trong phạm vi dịch vụ</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Thủ tục ngân sách</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: thủ tục đầu tư tài sản</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chi phí dịch vụ, nghiệm thu theo khối lượng thực tế</td></tr>
          </tbody>
        </table>
      </div>
        <div class="mt-7">
      <div class="border-l-4 border-[#1A9900] bg-[#f5f8fb] px-6 py-5">
        <p class="text-[14.5px] text-gray-600 leading-relaxed">Ba cách báo giá để phù hợp với cách lập dự toán của đơn vị: (A) thuê máy khô – Master/mực tính theo thực tế, dùng khi đơn vị muốn tách vật tư; (B) máy kèm định mức vật tư, dùng khi sản lượng kỳ thi dự báo được; (C) trọn gói một đơn giá theo phạm vi hợp đồng, dùng khi đơn vị cần kiểm soát ngân sách đơn giản. Báo giá luôn ghi rõ VAT, vận chuyển – lắp đặt, mực, Master, giấy, kỹ thuật, thời gian thuê và điều kiện phát sinh.</p>
      </div></div>
        </div>
      </div>
    </div>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Thuê máy in đề thi thì giá tính theo gì?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Theo phạm vi cung cấp và cách báo giá được chọn: tiền máy theo thời gian thuê, vật tư Master và mực theo thực tế hoặc theo định mức, cộng vận chuyển – lắp đặt và kỹ thuật trực. Mọi khoản được tách rõ trong báo giá, không dùng một chữ trọn gói gây hiểu nhầm phạm vi.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Máy được giao trước ngày in bao lâu?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Hương Sơn giao máy trước thời điểm in chính thức để đơn vị kiểm tra và làm quen thiết bị, theo thông lệ là khoảng 2 ngày trở lên tùy quy mô. Nguyên tắc điều hành của Hương Sơn là không giao máy sát giờ in.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có máy dự phòng không, và tính phí thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Phương án dự phòng được xác định ngay khi chốt giải pháp – tối thiểu 01 máy dự phòng cho mỗi cụm in của kỳ thi lớn. Cách tính phí máy dự phòng được ghi rõ trong báo giá.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Máy in nhân bản đạt được tốc độ bao nhiêu bản/phút?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Tùy dòng máy và cấu hình. Trong hợp đồng đã thực hiện với Sở GD&ĐT Quảng Trị năm 2026, yêu cầu kỹ thuật là máy đạt khoảng 150–155 bản/phút. Hương Sơn chọn máy theo sản lượng và tiến độ thực tế của từng điểm in.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn có nhận in sao đề thi hộ đơn vị không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Phạm vi dịch vụ của Hương Sơn là cung cấp thiết bị, vật tư, kỹ thuật và phương án dự phòng để đơn vị vận hành điểm sao in. Nghiệp vụ khảo thí và nội dung đề thi do đơn vị chịu trách nhiệm và quản lý theo quy định bảo mật.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Kỹ thuật có trực tại điểm in trong ngày in không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Kỹ thuật trực theo phương án đã thống nhất trong hợp đồng, với đầu mối được chỉ định tên cụ thể, hỗ trợ từ xa và có mặt tại hiện trường theo cam kết SLA.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Nếu sản lượng thực tế thấp hơn dự kiến thì nghiệm thu thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Nghiệm thu theo khối lượng thực tế. Trong hồ sơ đã thực hiện với Sở GD&ĐT Vĩnh Phúc, hợp đồng ghi 05 ngày thuê nhưng khối lượng thực tế xác nhận là 04 ngày và giá trị nghiệm thu được điều chỉnh tương ứng. Mọi thay đổi số ngày thuê hoặc khối lượng đều thể hiện rõ trong biên bản nghiệm thu.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Sau kỳ thi có thể tiếp tục thuê máy cho công việc thường xuyên không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Được. Nhiều đơn vị bắt đầu từ nhu cầu theo kỳ thi rồi mở rộng sang <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/cho-thue-may-truong-hoc/">thuê máy photocopy thường xuyên</a> và <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/quan-ly-in-an-truong-hoc/">quản lý in ấn trọn gói</a>.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Yêu cầu phương án in đề thi</h2>
        ...
        <form class="lead-form" id="sol-in-de-thi-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="solution" />
          <input type="hidden" name="product_model" value="" />
          <input type="hidden" name="solution_slug" value="in-de-thi" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-sol-in-de-thi-hp">Bỏ trống ô này</label>
            <input type="text" id="f-sol-in-de-thi-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
          ...
          </div><input type="hidden" name="nhu_cau" value="EXAM" />
          <div class="sm:col-span-1">
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Kỳ thi sắp tới của Quý đơn vị cần bao nhiêu máy?</h2>
        <p class="text-gray-300 text-[15px] leading-relaxed">Gửi số điểm in, sản lượng dự kiến và thời gian in – Hương Sơn đề xuất cấu hình máy chính, máy dự phòng, định mức vật tư và cơ cấu giá để Quý đơn vị đưa vào dự toán.</p>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-14 border-b border-gray-800/80">
        ...
        <div class="lg:col-span-4 space-y-5">
          <a href="/" class="inline-block"><span class="inline-flex items-center bg-white px-3 py-1.5 h-11 sm:h-12"><img src="/assets/images/brand/logo-huong-son.svg" alt="Hương Sơn" class="h-full w-auto object-contain" /></span></a>
  ...
  <div id="mobile-drawer" class="fixed top-0 left-0 bottom-0 w-80 max-w-[85vw] bg-[#181924] z-50 shadow-2xl transform -translate-x-full transition-transform duration-300 flex flex-col">
    <div class="p-6 border-b border-gray-800 flex items-center justify-between">
      <a href="/"><span class="inline-flex items-center bg-white px-3 py-1.5 h-11 sm:h-12"><img src="/assets/images/brand/logo-huong-son.svg" alt="Hương Sơn" class="h-full w-auto object-contain" /></span></a>
