...
@section('title', "Giải pháp in ấn – scan – số hóa cho Sở GD&ĐT và trường học | Hương Sơn")
@section('meta_description', "Hương Sơn cung cấp thiết bị, cho thuê máy, vật tư, kỹ thuật và giải pháp scan – số hóa cho Sở GD&ĐT, trường THPT/THCS và cơ sở đào tạo: từ in sao đề thi đến số hóa hồ sơ.")
@section('canonical', url('/giai-phap/giao-duc/'))
@section('jsonld')
...
<head>
  ...
  <title>Giải pháp in ấn – scan – số hóa cho Sở GD&ĐT và trường học | Hương Sơn</title>
  <meta name="description" content="Hương Sơn cung cấp thiết bị, cho thuê máy, vật tư, kỹ thuật và giải pháp scan – số hóa cho Sở GD&ĐT, trường THPT/THCS và cơ sở đào tạo: từ in sao đề thi đến số hóa hồ sơ." />
  <meta name="keywords" content="giải pháp in ấn cho Sở GD&ĐT, dịch vụ in ấn cho Sở Giáo dục, thiết bị in đề thi cho Sở Giáo dục, giải pháp máy in cho trường THPT, dịch vụ scan số hóa tài liệu trường học, máy photocopy trường học, máy photocopy cho trường học, thiết bị in ấn trường học, giải pháp in ấn trường học, giải pháp photocopy trường học, giải pháp scan trường học, giải pháp tài liệu trường học, thiết bị cho sở giáo dục, thiết bị cho phòng giáo dục, giải pháp in đề thi trường học, giải pháp số hóa trường học" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/giao-duc/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Giải pháp in ấn – scan – số hóa cho Sở GD&ĐT và trường học | Hương Sơn" />
  <meta property="og:description" content="Hương Sơn cung cấp thiết bị, cho thuê máy, vật tư, kỹ thuật và giải pháp scan – số hóa cho Sở GD&ĐT, trường THPT/THCS và cơ sở đào tạo: từ in sao đề thi đến số hóa hồ sơ." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/giao-duc/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Giải pháp thiết bị &amp; in ấn cho ngành Giáo dục" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Hương Sơn Education Solutions</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Giải pháp thiết bị &amp; in ấn cho ngành Giáo dục</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Từ in đề thi đến số hóa tài liệu – Hương Sơn cung cấp thiết bị, cho thuê, vật tư, kỹ thuật và giải pháp scan/số hóa theo đúng nhu cầu của từng đơn vị.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Giải pháp thiết bị &amp; in ấn cho ngành Giáo dục</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Kỳ thi có sản lượng in rất lớn dồn vào vài ngày, trong khi thiết bị sẵn có của đơn vị không đủ công suất và không có máy dự phòng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đầu tư mua máy cho nhu cầu theo mùa gây tồn đọng tài sản, khấu hao và chi phí bảo trì cả năm cho vài ngày sử dụng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chi phí in ấn thường xuyên (mực, drum, linh kiện, sửa chữa) rời rạc, khó dự toán và khó kiểm soát theo từng phòng ban.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Sự cố thiết bị giữa kỳ thi không có phương án thay thế rõ ràng, không có cam kết thời gian xử lý.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Khối lượng hồ sơ giấy (văn bằng, chứng chỉ, hồ sơ học sinh, hồ sơ giáo viên, tài liệu lưu trữ) tăng liên tục nhưng chưa được số hóa và tra cứu được.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hồ sơ báo giá – hợp đồng – bàn giao – nghiệm thu – thanh lý phải khớp nhau về tên thiết bị, cấu hình và khối lượng thực tế.</span>
        </li>
      </ul>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">Hương Sơn không chào từng chiếc máy rời. Hương Sơn chào một gói năng lực gồm thiết bị, vật tư, kỹ thuật, dự phòng và hồ sơ – chia thành 4 nhóm theo đầu việc của đơn vị.</p>
      ...
      <ol class="mt-2">
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Xác định kỳ thi hoặc nhu cầu thường xuyên, số điểm in, số máy, sản lượng dự kiến, khổ giấy và yêu cầu an ninh khu vực sao in.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Chốt phương án</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Cấu hình máy chính và máy dự phòng, định mức vật tư, nhân sự kỹ thuật, phương án vận chuyển; gửi phương án kỹ thuật kèm cơ cấu giá.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Chuẩn bị thiết bị</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Vệ sinh, bảo dưỡng, in test đạt yêu cầu; chuẩn bị Master/mực đủ cho toàn kỳ và tồn dự phòng; phân công kỹ thuật trực.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Giao và lắp đặt</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Giao máy trước thời điểm in chính thức để đơn vị làm quen; kiểm tra nguồn điện, chạy thử, chốt counter đầu kỳ và lập biên bản bàn giao.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Trong kỳ</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Vận hành và trực kỹ thuật</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Kỹ thuật trực theo phương án đã thống nhất, ghi nhật ký vận hành, bổ sung vật tư, xử lý sự cố theo cấp độ.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Sau kỳ</p>
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Thu hồi và nghiệm thu</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Chốt counter và vật tư thực tế, thu hồi thiết bị, nghiệm thu, xuất hóa đơn và thanh lý – hồ sơ khớp với báo giá và hợp đồng.</p>
        </li>
      </ol>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Kênh tiếp nhận sự cố qua điện thoại, Zalo và email; mỗi hợp đồng có đầu mối kỹ thuật xác định.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phân loại sự cố theo cấp độ P1/P2/P3 với cam kết thời gian tương ứng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phương án máy dự phòng cho nhiệm vụ trọng yếu – tối thiểu 01 máy dự phòng cho mỗi cụm in của kỳ thi lớn.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Theo dõi lịch sử thiết bị, vật tư đã cấp và số lần xử lý sự cố theo từng mã máy.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo dưỡng định kỳ và đánh giá thiết bị trước mỗi mùa cao điểm.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hồ sơ nghiệm thu ghi rõ máy, số ngày thuê, vật tư thực tế, tình trạng và counter được xác nhận.</span>
        </li>
      </ul>
        <div class="mt-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            ...
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">P3 – Lỗi nhỏ, không ảnh hưởng vận hành</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tiếp nhận trong ngày</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Xử lý theo lịch bảo trì gần nhất</td></tr>
          </tbody>
        </table>
      </div></div>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">Điều đơn vị mua không phải là chiếc máy, mà là năng lực in ấn ổn định trong một khoảng thời gian xác định. Vì vậy nên so sánh bằng tổng chi phí sở hữu, không so sánh bằng giá máy.</p>
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Chi phí đầu tư ban đầu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: chi trả toàn bộ giá thiết bị ngay trong năm ngân sách</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chỉ chi phí thuê theo thời gian thực dùng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Chi phí cả năm cho nhu cầu theo mùa</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: khấu hao, bảo trì, lưu kho cả 12 tháng</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chỉ phát sinh trong kỳ thi hoặc thời gian thuê</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Vật tư và linh kiện</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: đơn vị tự dự trù, tự mua, tự quản tồn</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê/MPS: nằm trong gói hoặc theo định mức đã thống nhất</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Rủi ro sự cố</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: đơn vị tự chịu, tự tìm phương án thay thế</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: có cam kết SLA và máy dự phòng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Dự toán và nghiệm thu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: tài sản, thủ tục đầu tư</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chi phí dịch vụ, nghiệm thu theo khối lượng thực tế</td></tr>
          </tbody>
        </table>
      </div>
        <div class="mt-7">
      <div class="border-l-4 border-[#1A9900] bg-[#f5f8fb] px-6 py-5">
        <p class="text-[14.5px] text-gray-600 leading-relaxed">Hương Sơn cung cấp 3 cách báo giá để phù hợp với cách lập dự toán của đơn vị: (A) thuê máy khô – vật tư tính theo thực tế; (B) máy kèm định mức vật tư; (C) trọn gói một đơn giá theo phạm vi hợp đồng. Mọi báo giá ghi rõ VAT, vận chuyển – lắp đặt, mực, Master, kỹ thuật, thời gian thuê và điều kiện phát sinh.</p>
      </div></div>
        </div>
      </div>
    </div>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn có kinh nghiệm triển khai cho Sở GD&amp;ĐT chưa?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Hương Sơn đã thực hiện hợp đồng thuê máy photocopy phục vụ in sao đề thi cho Sở GD&ĐT Vĩnh Phúc và hợp đồng thuê máy in nhân bản siêu tốc phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT năm 2026 cho Sở GD&ĐT Quảng Trị. Chi tiết xem tại mục <a class="text-[#1A9900] font-medium hover:underline" href="/du-an/">Dự án – Case study</a>.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Thuê máy theo kỳ thi thì thuê tối thiểu bao lâu?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Theo hồ sơ đã triển khai, thời gian thuê phục vụ kỳ thi thường từ vài ngày đến khoảng hai tuần, tùy số điểm in và sản lượng. Hương Sơn giao máy trước thời điểm in chính thức để đơn vị làm quen và kiểm tra, chứ không giao sát giờ in.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Vật tư Master và mực do bên nào cung cấp?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Phụ thuộc mô hình báo giá được chọn. Mô hình A tách vật tư và tính theo thực tế sử dụng; mô hình B đi kèm định mức vật tư; mô hình C là trọn gói. Điều này được ghi rõ trong báo giá và hợp đồng để không gây hiểu nhầm phạm vi.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Nếu máy gặp sự cố trong ngày in đề thi thì xử lý thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Sự cố được phân loại theo cấp độ. Với sự cố P1 – máy dừng hoàn toàn, Hương Sơn tiếp nhận trong vòng 30 phút, mục tiêu có mặt trong vòng 2 giờ; nếu không khắc phục được thì thay bằng máy dự phòng đã chuẩn bị sẵn theo hợp đồng.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn có đảm bảo bảo mật khu vực sao in không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Hương Sơn tuân thủ tuyệt đối quy định về an ninh và bảo mật khu vực sao in của đơn vị. Nội dung đề thi, dữ liệu học sinh và thông tin vận hành nhạy cảm không được ghi nhận, sao lưu hay công bố dưới bất kỳ hình thức nào.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Đơn vị cần chuẩn bị gì trước khi nhận máy?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Vị trí đặt máy có nguồn điện phù hợp, đầu mối kỹ thuật và đầu mối nghiệm thu của đơn vị, xác nhận số lượng và khổ giấy, và xác nhận thời điểm nhận máy – thời điểm in chính thức – thời điểm trả máy.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có thể vừa thuê máy in đề thi vừa thuê máy photocopy thường xuyên không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Được. Đây là mô hình phổ biến: bắt đầu bằng nhu cầu theo kỳ thi, sau đó mở rộng sang thuê máy photocopy thường xuyên cho văn phòng và các đơn vị trực thuộc, rồi tới quản lý in ấn trọn gói và số hóa hồ sơ.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn có nhận số hóa hồ sơ văn bằng, chứng chỉ không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có, đây là nhóm dịch vụ Hương Sơn đang phát triển. Quy trình gồm tiếp nhận và kiểm đếm hồ sơ, phân loại, scan tốc độ cao, kiểm soát chất lượng, OCR khi phạm vi yêu cầu, đặt tên và nhập metadata, bàn giao dữ liệu kèm biên bản số lượng và chất lượng.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="sol-giao-duc-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="solution" />
          <input type="hidden" name="product_model" value="" />
          <input type="hidden" name="solution_slug" value="giao-duc" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-sol-giao-duc-hp">Bỏ trống ô này</label>
            <input type="text" id="f-sol-giao-duc-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
