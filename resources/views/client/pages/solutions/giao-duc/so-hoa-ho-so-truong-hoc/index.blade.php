...
@section('canonical', url('/giai-phap/giao-duc/so-hoa-ho-so-truong-hoc/'))
@section('jsonld')
...
<head>
  ...
  <title>Dịch vụ scan, OCR và số hóa hồ sơ Sở Giáo dục – DIGITAL DOCUMENT | Hương Sơn</title>
  <meta name="description" content="Dịch vụ scan tốc độ cao, OCR và số hóa hồ sơ, tài liệu cho Sở GD&ĐT, trường học, phòng đào tạo, văn thư và thư viện – từ tiếp nhận hồ sơ giấy đến bàn giao dữ liệu số." />
  <meta name="keywords" content="dịch vụ số hóa tài liệu, dịch vụ số hóa hồ sơ, dịch vụ scan tài liệu, số hóa hồ sơ Sở Giáo dục, số hóa hồ sơ trường học, số hóa hồ sơ học sinh, số hóa hồ sơ giáo viên, dịch vụ scan OCR, chuyển hồ sơ giấy sang PDF, số hóa tài liệu thư viện, số hóa hồ sơ cơ quan nhà nước, giải pháp số hóa cho cơ quan nhà nước, giải pháp số hóa cho Sở GDĐT, giải pháp số hóa trường học, số hóa tài liệu trường học" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/giao-duc/so-hoa-ho-so-truong-hoc/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Dịch vụ scan, OCR và số hóa hồ sơ Sở Giáo dục – DIGITAL DOCUMENT | Hương Sơn" />
  <meta property="og:description" content="Dịch vụ scan tốc độ cao, OCR và số hóa hồ sơ, tài liệu cho Sở GD&ĐT, trường học, phòng đào tạo, văn thư và thư viện – từ tiếp nhận hồ sơ giấy đến bàn giao dữ liệu số." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/giao-duc/so-hoa-ho-so-truong-hoc/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Scan, OCR và số hóa hồ sơ cho Sở GD&amp;ĐT và trường học" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">DIGITAL DOCUMENT</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Scan, OCR và số hóa hồ sơ cho Sở GD&amp;ĐT và trường học</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp dịch vụ scan, OCR và số hóa hồ sơ, tài liệu cho Sở GD&amp;ĐT, trường học, phòng đào tạo, văn thư và thư viện; từ tiếp nhận hồ sơ giấy, scan, kiểm tra chất lượng, OCR đến bàn giao dữ liệu số.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/giao-duc/" class="hover:text-white transition">Giải pháp thiết bị &amp; in ấn cho ngành Giáo dục</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Scan, OCR và số hóa hồ sơ cho Sở GD&amp;ĐT và trường học</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Dịch vụ số hóa tài liệu theo quy trình: Hương Sơn không chỉ bán máy scan mà nhận cả công đoạn tiếp nhận, scan, kiểm soát chất lượng, OCR, chuẩn hóa tên và metadata rồi bàn giao dữ liệu.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Sở GD&ĐT và các đơn vị quản lý văn bằng – chứng chỉ, phòng chuyên môn có khối lượng hồ sơ lớn, trường THPT, trung tâm giáo dục, thư viện và bộ phận văn thư – lưu trữ.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Chuyển khối hồ sơ giấy đang tăng liên tục thành dữ liệu tra cứu được, đáp ứng yêu cầu số hóa dữ liệu văn bằng – chứng chỉ của Bộ GD&ĐT, mà không cần đơn vị tự đầu tư thiết bị và tự tổ chức nhân sự scan.</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            ...
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="text-[#181923] hover:text-[#1A9900] transition">Máy photocopy – máy đa chức năng có chức năng scan</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Dùng cho khối lượng vừa và scan phát sinh hằng ngày</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="text-[#181923] hover:text-[#1A9900] transition">Thiết bị văn phòng phụ trợ</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Workstation và thiết bị hỗ trợ cho khu vực scan</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="text-[#181923] hover:text-[#1A9900] transition">Vật tư – linh kiện máy scan</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Con lăn, tấm ma sát và vật tư thay thế theo số trang đã scan</td></tr>
          </tbody>
        </table>
      </div>
        </div>
