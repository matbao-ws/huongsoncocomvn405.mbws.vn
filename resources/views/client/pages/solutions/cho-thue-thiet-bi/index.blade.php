...
@section('title', "Cho thuê máy photocopy Hà Nội – thuê máy in, máy scan trọn gói | Hương Sơn")
@section('meta_description', "Cho thuê máy photocopy, máy in A3/A4, máy scan và máy in nhân bản theo tháng, theo sản lượng hoặc theo đợt. Có gói bao mực, bảo trì và cam kết thời gian xử lý sự cố.")
@section('canonical', url('/giai-phap/cho-thue-thiet-bi/'))
@section('jsonld')
...
<head>
  ...
  <title>Cho thuê máy photocopy Hà Nội – thuê máy in, máy scan trọn gói | Hương Sơn</title>
  <meta name="description" content="Cho thuê máy photocopy, máy in A3/A4, máy scan và máy in nhân bản theo tháng, theo sản lượng hoặc theo đợt. Có gói bao mực, bảo trì và cam kết thời gian xử lý sự cố." />
  <meta name="keywords" content="cho thuê máy photocopy Hà Nội, thuê máy photocopy trọn gói, thuê máy photocopy bao mực bảo trì, cho thuê máy in, cho thuê máy scan, thuê máy photocopy theo tháng, bảng giá thuê máy photocopy, dịch vụ cho thuê máy phục vụ kỳ thi, thuê máy photocopy theo năm, thuê máy photocopy dài hạn, thuê máy in văn phòng, cho thuê máy in văn phòng, thuê máy in siêu tốc, cho thuê máy in siêu tốc, hợp đồng bảo trì máy photocopy, hợp đồng thuê máy photocopy" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/cho-thue-thiet-bi/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Cho thuê máy photocopy Hà Nội – thuê máy in, máy scan trọn gói | Hương Sơn" />
  <meta property="og:description" content="Cho thuê máy photocopy, máy in A3/A4, máy scan và máy in nhân bản theo tháng, theo sản lượng hoặc theo đợt. Có gói bao mực, bảo trì và cam kết thời gian xử lý sự cố." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/cho-thue-thiet-bi/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Cho thuê máy photocopy, máy in và thiết bị văn phòng" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Rental Solutions</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Cho thuê máy photocopy, máy in và thiết bị văn phòng</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cho thuê máy photocopy, máy in A3/A4, máy scan và máy in nhân bản theo tháng, theo sản lượng hoặc theo đợt – kèm vật tư, bảo trì và cam kết thời gian xử lý sự cố.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Cho thuê máy photocopy, máy in và thiết bị văn phòng</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhu cầu thiết bị phát sinh ngay nhưng kinh phí đầu tư chưa có hoặc phải chờ chu kỳ ngân sách.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhu cầu chỉ theo đợt hoặc theo mùa – mua máy thì máy nằm không phần lớn thời gian.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Mua máy rồi vẫn phải tự lo mực, drum, linh kiện và tìm người sửa mỗi lần hỏng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Không có phương án thay máy khi thiết bị hỏng vào lúc công việc gấp.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chi phí in không dự đoán được vì phát sinh theo từng lần mua và từng lần sửa.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhu cầu thay đổi theo thời gian nhưng thiết bị đã mua thì cấu hình cố định.</span>
        </li>
      </ul>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-6">Điều khách hàng cần không phải là sở hữu một chiếc máy, mà là năng lực in ấn ổn định trong một khoảng thời gian. Hương Sơn cung cấp năng lực đó theo 4 gói.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gói Basic – máy kèm giao lắp và bảo trì cơ bản, cho văn phòng và trường quy mô nhỏ.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gói Standard – máy kèm vật tư và bảo trì, phù hợp nhu cầu in thường xuyên.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gói Business – máy kèm vật tư, linh kiện và cam kết SLA, cho đơn vị không được phép dừng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gói Enterprise – quản lý toàn bộ đội máy với monitoring, SLA, báo cáo và tối ưu định kỳ.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gói theo đợt – thuê ngắn hạn cho kỳ thi, hội nghị, đợt in tài liệu hoặc dự án.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Thời hạn linh hoạt: theo ngày cho nhu cầu theo đợt; 12, 24 hoặc 36 tháng cho nhu cầu thường xuyên.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Cơ chế giá: phí thuê cố định kèm định mức bản in, hoặc tính theo sản lượng thực tế.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đánh giá lại trước 90 ngày hết hạn để gia hạn, đổi cấu hình hoặc nâng gói.</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="text-[#181923] hover:text-[#1A9900] transition">Máy photocopy – máy đa chức năng A3/A4</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thiết bị được thuê nhiều nhất cho văn phòng và phòng chuyên môn</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="text-[#181923] hover:text-[#1A9900] transition">Máy in nhân bản tốc độ cao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê theo đợt cho kỳ thi và các đợt in sản lượng lớn</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-in-laser/" class="text-[#181923] hover:text-[#1A9900] transition">Máy in laser A4</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thiết bị phân tán theo phòng ban</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-scan-so-hoa/" class="text-[#181923] hover:text-[#1A9900] transition">Máy scan tốc độ cao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê cho đợt số hóa hồ sơ hoặc nhu cầu scan thường xuyên</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="text-[#181923] hover:text-[#1A9900] transition">Thiết bị văn phòng – hội họp</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Trang bị theo đợt cho hội nghị và sự kiện</td></tr>
          </tbody>
        </table>
      </div>
        </div>
      ...
      <ol class="mt-2">
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Xác định loại thiết bị, số lượng, thời gian thuê, địa điểm và sản lượng dự kiến.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Khảo sát và chọn gói</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Chọn gói Basic, Standard, Business, Enterprise hoặc gói theo đợt cho phù hợp nhu cầu và ngân sách.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Báo giá</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Gửi báo giá tách rõ phí thuê, định mức vật tư, vận chuyển – lắp đặt, kỹ thuật, thời gian thuê và điều kiện phát sinh.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Hợp đồng ghi rõ model và cấu hình thiết bị, phạm vi dịch vụ, mức SLA, cơ chế nghiệm thu và thanh toán.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Giao máy</p>
        ...
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Cung cấp vật tư, bảo trì theo lịch, xử lý sự cố theo SLA, chốt counter định kỳ.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Kết thúc hoặc gia hạn</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Trước 90 ngày hết hạn: đánh giá gia hạn, đổi cấu hình hoặc nâng gói. Nếu kết thúc: thu hồi, nghiệm thu và thanh lý.</p>
        </li>
      </ol>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phân loại sự cố theo cấp độ với cam kết thời gian tương ứng theo từng gói.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phương án thay máy hoặc máy dự phòng cho nhiệm vụ trọng yếu.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Theo dõi lịch sử thiết bị, vật tư đã cấp và số lần xử lý theo từng mã máy.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chốt counter đúng kỳ để hai bên có cùng số liệu khi nghiệm thu.</span>
        </li>
      </ul>
        <div class="mt-8">
      <div class="overflow-x-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">So sánh thuê và mua nên đặt trên tổng chi phí sở hữu trong cả thời gian sử dụng, bao gồm cả vật tư, sửa chữa và thời gian máy dừng.</p>
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Vốn ban đầu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: chi trả toàn bộ giá thiết bị ngay</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: không cần vốn, chi phí trải theo kỳ</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Nhu cầu theo đợt</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: thiết bị nhàn rỗi phần lớn thời gian</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chỉ trả cho thời gian sử dụng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Vật tư và linh kiện</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: tự dự trù, tự mua, tự quản tồn</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: trong phạm vi hợp đồng hoặc theo định mức</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Rủi ro thiết bị</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: đơn vị tự chịu và tự tìm phương án</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: nhà cung cấp chịu, có SLA và phương án thay máy</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Thay đổi nhu cầu</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: cấu hình cố định</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: đổi cấu hình khi gia hạn</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Hình thức chi</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: chi đầu tư tài sản</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chi phí dịch vụ, nghiệm thu theo thực tế</td></tr>
          </tbody>
        </table>
      </div>
        <div class="mt-7">
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Thuê máy photocopy giá bao nhiêu một tháng?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Phụ thuộc cấu hình máy, sản lượng in, gói dịch vụ và thời hạn hợp đồng, nên Hương Sơn báo giá sau khi biết sản lượng dự kiến và loại máy phù hợp. Việc báo một con số chung mà chưa biết sản lượng sẽ dẫn tới phát sinh về sau.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có thuê ngắn hạn theo ngày được không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Được, cho nhu cầu theo đợt như kỳ thi, hội nghị hoặc đợt in tài liệu. Đây là hình thức Hương Sơn đã thực hiện cho các Sở GD&ĐT trong các kỳ thi.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
          ...
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Tùy gói. Gói Basic gồm máy, giao lắp và bảo trì cơ bản. Gói Standard trở lên có vật tư. Gói Business có thêm linh kiện và cam kết SLA. Phạm vi được ghi rõ trong báo giá và hợp đồng.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
          ...
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Tùy cấu hình và ngân sách. Tình trạng thiết bị, model và cấu hình được ghi rõ trong báo giá, hợp đồng và biên bản bàn giao – dùng cùng một tên thiết bị trên toàn bộ hồ sơ.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hết hạn hợp đồng thì thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Trước 90 ngày hết hạn, hai bên đánh giá lại nhu cầu để gia hạn, đổi cấu hình hoặc nâng gói. Nếu kết thúc, Hương Sơn thu hồi thiết bị, nghiệm thu và thanh lý theo hồ sơ.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn cho thuê ở những địa bàn nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Hương Sơn xác nhận phạm vi phục vụ theo địa chỉ cụ thể, vì cam kết SLA chỉ có giá trị khi đội kỹ thuật tiếp cận được trong thời gian cam kết. Vui lòng gửi địa chỉ để Hương Sơn xác nhận.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="sol-cho-thue-thiet-bi-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="solution" />
          <input type="hidden" name="product_model" value="" />
          <input type="hidden" name="solution_slug" value="cho-thue-thiet-bi" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-sol-cho-thue-thiet-bi-hp">Bỏ trống ô này</label>
            <input type="text" id="f-sol-cho-thue-thiet-bi-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Nhận báo giá thuê máy theo đúng nhu cầu</h2>
        <p class="text-gray-300 text-[15px] leading-relaxed">Gửi loại thiết bị, số lượng, thời gian thuê và sản lượng dự kiến – Hương Sơn đề xuất gói phù hợp kèm cơ cấu giá tách rõ từng khoản.</p>
      </div>
