...
@section('title', "Giải pháp thiết bị in ấn, scan và số hóa cho Cơ quan Nhà nước | Hương Sơn")
@section('meta_description', "Cung cấp thiết bị, cho thuê máy, vật tư, dịch vụ kỹ thuật và số hóa hồ sơ cho Bộ, Sở, UBND và đơn vị sự nghiệp. Hồ sơ đầy đủ phục vụ dự toán, đấu thầu, nghiệm thu và thanh toán.")
@section('canonical', url('/giai-phap/co-quan-nha-nuoc/'))
@section('jsonld')
...
<head>
  ...
  <title>Giải pháp thiết bị in ấn, scan và số hóa cho Cơ quan Nhà nước | Hương Sơn</title>
  <meta name="description" content="Cung cấp thiết bị, cho thuê máy, vật tư, dịch vụ kỹ thuật và số hóa hồ sơ cho Bộ, Sở, UBND và đơn vị sự nghiệp. Hồ sơ đầy đủ phục vụ dự toán, đấu thầu, nghiệm thu và thanh toán." />
  <meta name="keywords" content="dịch vụ scan tài liệu cho cơ quan nhà nước, thiết bị in ấn cho cơ quan nhà nước, cho thuê máy photocopy cơ quan nhà nước, số hóa hồ sơ lưu trữ, giải pháp in ấn cho UBND, thiết bị văn phòng cho đơn vị sự nghiệp, số hóa hồ sơ cơ quan nhà nước, giải pháp số hóa cho cơ quan nhà nước, máy photocopy cho cơ quan" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/co-quan-nha-nuoc/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Giải pháp thiết bị in ấn, scan và số hóa cho Cơ quan Nhà nước | Hương Sơn" />
  <meta property="og:description" content="Cung cấp thiết bị, cho thuê máy, vật tư, dịch vụ kỹ thuật và số hóa hồ sơ cho Bộ, Sở, UBND và đơn vị sự nghiệp. Hồ sơ đầy đủ phục vụ dự toán, đấu thầu, nghiệm thu và thanh toán." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/co-quan-nha-nuoc/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Giải pháp thiết bị, in ấn và số hóa cho Cơ quan Nhà nước" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Government Solutions</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Giải pháp thiết bị, in ấn và số hóa cho Cơ quan Nhà nước</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp thiết bị, dịch vụ cho thuê, vật tư, kỹ thuật và giải pháp số hóa hồ sơ cho Bộ, Sở, UBND, đơn vị sự nghiệp và cơ quan hành chính – kèm bộ hồ sơ đầy đủ phục vụ dự toán, nghiệm thu và thanh toán.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/giai-phap/" class="hover:text-white transition">Giải pháp</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Giải pháp thiết bị, in ấn và số hóa cho Cơ quan Nhà nước</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhu cầu thiết bị phải được đưa vào dự toán trước, trong khi công việc thực tế lại phát sinh theo đợt và theo mùa.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Thủ tục mua sắm tài sản mất thời gian, còn nhu cầu sử dụng thì cần ngay.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hồ sơ báo giá, hợp đồng, bàn giao, nghiệm thu và thanh lý nếu không khớp về tên thiết bị và khối lượng sẽ gây vướng khi thanh toán.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Khối hồ sơ lưu trữ giấy tăng theo năm, chiếm diện tích và khó tra cứu.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Yêu cầu bảo mật thông tin trong quá trình in và scan tài liệu nội bộ.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-circle-exclamation text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Thiết bị phân tán nhiều phòng ban, nhiều đời máy, khó quản lý chi phí và vật tư.</span>
        </li>
      </ul>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-6">Với khu vực công, một giải pháp chỉ dùng được khi vừa đúng nhu cầu kỹ thuật vừa đi qua được thủ tục. Vì vậy Hương Sơn chuẩn hóa cả hai phần: phương án kỹ thuật và bộ hồ sơ thương mại.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Cung cấp thiết bị: máy photocopy đa chức năng A3/A4, máy in laser, máy scan, máy in nhân bản và thiết bị văn phòng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Cho thuê thiết bị cho nhu cầu theo đợt hoặc theo mùa – chi phí dịch vụ, không phải thủ tục đầu tư tài sản.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quản lý in ấn trọn gói cho đơn vị có nhiều thiết bị phân tán, kèm counter và báo cáo sản lượng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Số hóa hồ sơ lưu trữ theo quy trình có kiểm đếm, kiểm soát chất lượng và biên bản bàn giao.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Cung cấp vật tư và linh kiện, bao gồm nhãn Fansipan cho các dòng máy thông dụng.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Dịch vụ kỹ thuật, bảo trì và sửa chữa theo cam kết thời gian xử lý.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bộ hồ sơ chuẩn: báo giá có cơ cấu giá rõ ràng, hợp đồng, biên bản bàn giao, nghiệm thu và thanh lý dùng cùng một tên thiết bị và cấu hình.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Ba cách báo giá để phù hợp với cách lập dự toán: thuê máy khô, máy kèm định mức vật tư, hoặc trọn gói theo phạm vi hợp đồng.</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="text-[#181923] hover:text-[#1A9900] transition">Máy photocopy – máy đa chức năng A3/A4</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thiết bị trục chính cho văn phòng và phòng chuyên môn</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-in-laser/" class="text-[#181923] hover:text-[#1A9900] transition">Máy in laser – thiết bị in</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thiết bị phân tán theo phòng ban</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-scan-so-hoa/" class="text-[#181923] hover:text-[#1A9900] transition">Máy scan tốc độ cao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Số hóa hồ sơ lưu trữ và hồ sơ phát sinh hằng ngày</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="text-[#181923] hover:text-[#1A9900] transition">Máy in nhân bản tốc độ cao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">In tài liệu số lượng lớn theo đợt</td></tr>
            ...
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="text-[#181923] hover:text-[#1A9900] transition">Vật tư – linh kiện – tiêu hao</a></th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mực, drum, linh kiện thay thế cho nhiều dòng máy</td></tr>
          </tbody>
        </table>
      </div>
        </div>
      ...
      <ol class="mt-2">
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Tiếp nhận nhu cầu</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Xác định phạm vi công việc, số lượng thiết bị, khối lượng in hoặc scan, thời điểm cần và bộ phận đầu mối.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Khảo sát hiện trạng</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Kiểm kê thiết bị hiện có, sản lượng, tình trạng và loại vật tư đang dùng; xác định yêu cầu bảo mật.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Đề xuất phương án</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Gửi phương án kỹ thuật kèm cơ cấu giá tách rõ thiết bị, vật tư, vận chuyển – lắp đặt, kỹ thuật, thời gian và điều kiện phát sinh.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Hoàn thiện hồ sơ</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Chuẩn bị hồ sơ thương mại và hồ sơ năng lực theo yêu cầu của đơn vị, phục vụ dự toán hoặc hồ sơ gói thầu.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Giao – lắp đặt – chạy thử, chốt counter đầu kỳ, đào tạo sử dụng và lập biên bản bàn giao.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Vận hành và bảo trì</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Cung cấp vật tư, bảo trì định kỳ, xử lý sự cố theo cam kết thời gian.</p>
        </li>
        <li class="relative pl-12 pb-8 last:pb-0 border-l border-gray-200 last:border-transparent ml-4">
          ...
          <p class="text-[16px] font-bold text-[#181923] mb-1.5">Nghiệm thu và thanh lý</p>
          <p class="text-[14.5px] text-gray-500 leading-relaxed">Chốt khối lượng thực tế, nghiệm thu, xuất hóa đơn và thanh lý; mọi thay đổi khối lượng được thể hiện rõ trong biên bản.</p>
        </li>
      </ol>
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đầu mối kỹ thuật xác định cho từng hợp đồng, tiếp nhận qua điện thoại, Zalo và email.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Bảo trì định kỳ theo lịch, có biên bản sau mỗi lần thực hiện.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Vật tư và linh kiện cung cấp theo hợp đồng, có chứng từ đầy đủ.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phương án thiết bị thay thế cho nhiệm vụ trọng yếu.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Theo dõi lịch sử thiết bị và vật tư theo từng mã máy để phục vụ báo cáo và nghiệm thu.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tuân thủ quy định bảo mật thông tin của đơn vị trong quá trình in, scan và số hóa tài liệu.</span>
        </li>
      </ul>
        <div class="mt-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            ...
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">P3 – Lỗi nhỏ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tiếp nhận trong ngày</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Xử lý theo lịch bảo trì định kỳ</td></tr>
          </tbody>
        </table>
      </div></div>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-14 border-t border-gray-200 first:border-t-0 first:pt-0">
        ...
        <div class="lg:col-span-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-7">Ở khu vực công, hiệu quả không chỉ là giá thấp nhất mà là phương án đi được qua thủ tục, đúng tiến độ và không phát sinh ngoài dự toán.</p>
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Hình thức chi</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua thiết bị: chi đầu tư, thủ tục mua sắm tài sản</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê dịch vụ: chi thường xuyên, nghiệm thu theo khối lượng thực tế</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Nhu cầu theo đợt và theo mùa</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: thiết bị nhàn rỗi phần lớn thời gian</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: chỉ phát sinh trong thời gian sử dụng</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Vật tư và bảo trì</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Tự quản: nhiều lần mua nhỏ, nhiều chứng từ</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Hợp đồng dịch vụ: một đầu mối, chứng từ gọn</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Rủi ro tiến độ</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Mua: phụ thuộc thời gian thủ tục và giao hàng</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thuê: triển khai nhanh hơn theo phương án đã chuẩn bị</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Kiểm soát chi phí in</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Không có counter: không tách được chi phí thực tế</td><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Có counter và báo cáo: dự toán và giải trình được</td></tr>
          </tbody>
        </table>
      </div>
        <div class="mt-7">
      <div class="border-l-4 border-[#1A9900] bg-[#f5f8fb] px-6 py-5">
        <p class="text-[14.5px] text-gray-600 leading-relaxed">Hương Sơn coi đấu thầu là một kênh tiếp cận khách hàng chứ không chỉ là nghiệp vụ hồ sơ, và chọn lọc gói thầu theo mức độ phù hợp về năng lực triển khai. Với các gói mà Hương Sơn không đủ điều kiện phục vụ đúng cam kết, Hương Sơn không tham gia.</p>
      </div></div>
        </div>
      </div>
    </div>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn có tham gia đấu thầu không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Hương Sơn tham gia có chọn lọc, ưu tiên các gói phù hợp với năng lực triển khai và dịch vụ thực tế của mình. Với gói mà Hương Sơn không đảm bảo được cam kết kỹ thuật hoặc dịch vụ, Hương Sơn không tham gia.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hồ sơ năng lực của Hương Sơn gồm những gì?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Thông tin pháp lý, năng lực thiết bị, năng lực kho, năng lực kỹ thuật, năng lực logistics, năng lực cho thuê, danh mục hãng và đối tác, cùng các dự án được phép công bố. Xem tại <a class="text-[#1A9900] font-medium hover:underline" href="/ve-huong-son/nang-luc/">Hồ sơ năng lực</a>.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Đơn vị cần chi thường xuyên thay vì chi đầu tư thì có phương án nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Phương án thuê thiết bị. Đây là chi phí dịch vụ, nghiệm thu theo khối lượng thực tế, phù hợp cho nhu cầu theo đợt hoặc khi chưa có kế hoạch đầu tư tài sản. Xem <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/cho-thue-thiet-bi/">giải pháp cho thuê thiết bị</a>.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Hương Sơn có nhận số hóa hồ sơ lưu trữ của cơ quan không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Quy trình gồm tiếp nhận và kiểm đếm, phân loại, scan tốc độ cao, kiểm soát chất lượng, OCR khi có yêu cầu, đặt tên và metadata, bàn giao dữ liệu kèm biên bản. Địa điểm thực hiện do đơn vị quyết định.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Báo giá của Hương Sơn có tách rõ các khoản không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Nguyên tắc của Hương Sơn là báo giá phải ghi rõ VAT, vận chuyển – lắp đặt, vật tư, kỹ thuật, thời gian và điều kiện phát sinh; không dùng một chữ trọn gói gây hiểu nhầm phạm vi.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="sol-co-quan-nha-nuoc-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="solution" />
          <input type="hidden" name="product_model" value="" />
          <input type="hidden" name="solution_slug" value="co-quan-nha-nuoc" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-sol-co-quan-nha-nuoc-hp">Bỏ trống ô này</label>
            <input type="text" id="f-sol-co-quan-nha-nuoc-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần phương án kỹ thuật và cơ cấu giá để đưa vào dự toán?</h2>
        <p class="text-gray-300 text-[15px] leading-relaxed">Hương Sơn khảo sát nhu cầu, đề xuất cấu hình thiết bị và cơ cấu giá tách rõ từng khoản, kèm hồ sơ năng lực theo yêu cầu của đơn vị.</p>
      </div>
