...
<head>
  ...
  <title>Giải pháp thiết bị, in ấn, số hóa theo ngành | Hương Sơn</title>
  <meta name="description" content="8 giải pháp Hương Sơn cho Giáo dục, Cơ quan Nhà nước, Ngân hàng, Doanh nghiệp: in đề thi, scan số hóa, cho thuê thiết bị, quản lý vận hành." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/giai-phap/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Giải pháp thiết bị, in ấn, số hóa theo ngành | Hương Sơn" />
  <meta property="og:description" content="8 giải pháp Hương Sơn cho Giáo dục, Cơ quan Nhà nước, Ngân hàng, Doanh nghiệp: in đề thi, scan số hóa, cho thuê thiết bị, quản lý vận hành." />
  <meta property="og:url" content="https://huongsonco.com.vn/giai-phap/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Giải pháp thiết bị, in ấn và số hóa theo ngành" class="w-full h-full object-cover object-center" loading="eager" />
