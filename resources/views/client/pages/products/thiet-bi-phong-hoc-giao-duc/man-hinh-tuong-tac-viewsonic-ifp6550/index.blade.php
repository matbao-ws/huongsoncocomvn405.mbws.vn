...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      <span class="font-handwriting text-2xl sm:text-3xl text-[#5eb74c] font-bold block mb-2">Education Equipment</span>
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Màn hình tương tác ViewSonic IFP6550 65 inch 4K — trung tâm của lớp học số hiện đại, hỗ trợ cảm ứng đa điểm mượt mà và phần mềm giáo dục myViewBoard bản quyền.</p>
      <nav class="mt-6 text-[13px] text-gray-300 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="text-gray-300 hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-400"></i> <a href="/san-pham/" class="text-gray-300 hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-400"></i> <a href="/san-pham/thiet-bi-phong-hoc-giao-duc/" class="text-gray-300 hover:text-white transition">Thiết bị phòng học – thiết bị dạy học</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-400"></i> <span class="text-[#5eb74c] font-semibold" aria-current="page">Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)</span>
      </nav>
    </div>
  </section>
