  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/thiet-bi-phong-hoc-giao-duc/"
      },
      {
        "@@type": "ListItem",
        "position": 4,
        "name": "Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)",
        "item": "https://huongsonco.com.vn/san-pham/thiet-bi-phong-hoc-giao-duc/man-hinh-tuong-tac-viewsonic-ifp6550/"
      }
    ]
  },
  {
    ...
    "additionalProperty": [
      {
        ...
        "value": "65 inch 4K Ultra HD (3840 x 2160)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ cảm ứng",
        "value": "Cảm ứng hồng ngoại siêu nhạy 20 điểm chạm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Âm thanh",
        "value": "Tích hợp loa Stereo 2x10W + Subwoofer 15W"
      },
      {
        "@@type": "PropertyValue",
        "name": "Hệ điều hành",
        "value": "Android 11 tích hợp khe cắm OPS Windows"
      },
      {
        "@@type": "PropertyValue",
        "name": "Model tương thích",
        "value": "IFP7550, IFP8650"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Nhập khẩu chính hãng ViewSonic."
      }
    ],
    "audience": [
      {
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Màn hình tương tác ViewSonic IFP6550 65 inch 4K — trung tâm của lớp học số hiện đại, hỗ trợ cảm ứng đa điểm mượt mà và phần mềm giáo dục myViewBoard bản quyền.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>ViewSonic ViewBoard IFP6550-5</strong> — sản xuất bởi ViewSonic (Hoa Kỳ)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường THPT, Trường Quốc tế, Trường Đại học</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">IFP7550, IFP8650</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/viewsonic-ifp6550.jpg" alt="Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">ViewSonic ViewBoard IFP6550-5</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">ViewSonic (Hoa Kỳ)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/thiet-bi-phong-hoc-giao-duc/" class="hover:text-[#1A9900]">Thiết bị phòng học thông minh</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Giảng dạy tương tác đa điểm, viết vẽ bài giảng sinh động</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Trình chiếu bài giảng điện tử E-learning, kết nối không dây với laptop/tablet học sinh</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Họp trực tuyến và đào tạo từ xa trong các trường học</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — ViewSonic ViewBoard IFP6550-5</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước màn hình</th>
              <td class="py-3 text-[14.5px] text-gray-600">65 inch 4K Ultra HD (3840 x 2160)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ cảm ứng</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng hồng ngoại siêu nhạy 20 điểm chạm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Âm thanh</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tích hợp loa Stereo 2x10W + Subwoofer 15W</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Hệ điều hành</th>
              <td class="py-3 text-[14.5px] text-gray-600">Android 11 tích hợp khe cắm OPS Windows</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Nhập khẩu chính hãng ViewSonic.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">IFP7550, IFP8650</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-man-hinh-tuong-tac-viewsonic-ifp6550-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="ViewSonic ViewBoard IFP6550-5" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-man-hinh-tuong-tac-viewsonic-ifp6550-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-man-hinh-tuong-tac-viewsonic-ifp6550-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Màn hình tương tác thông minh ViewSonic IFP6550 4K (65 inch)?</h2>
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/thiet-bi-phong-hoc-giao-duc/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem Thiết bị phòng học – thiết bị dạy học</a>
