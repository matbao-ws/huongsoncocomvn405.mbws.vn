...
@section('title', "Thiết bị phòng học, thiết bị dạy học cho trường học | Hương Sơn")
@section('meta_description', "Cung cấp thiết bị phòng học và thiết bị dạy học cho trường THPT, THCS và cơ sở giáo dục, đồng bộ với giải pháp in ấn, photocopy và số hóa của Hương Sơn.")
@section('canonical', url('/san-pham/thiet-bi-phong-hoc-giao-duc/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Có thể mua trọn gói thiết bị phòng học cùng máy photocopy không?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Được. Nhiều trường học kết hợp trang bị thiết bị phòng học cùng lúc với thuê máy photocopy để giảm số đầu mối làm việc."
      }
    }
  ]
}</script>
...
<head>
  ...
  <title>Thiết bị phòng học, thiết bị dạy học cho trường học | Hương Sơn</title>
  <meta name="description" content="Cung cấp thiết bị phòng học và thiết bị dạy học cho trường THPT, THCS và cơ sở giáo dục, đồng bộ với giải pháp in ấn, photocopy và số hóa của Hương Sơn." />
  <meta name="keywords" content="thiết bị trường học, thiết bị giáo dục, thiết bị dạy học, thiết bị phòng học, phòng học thông minh, màn hình tương tác, màn hình tương tác trường học, màn hình tương tác chính hãng, bục giảng điện tử, bục giảng điện tử chính hãng, camera vật thể, camera trình chiếu chính hãng, máy chiếu trường học, máy chiếu lớp học, thiết bị cho phòng hành chính trường học, thiết bị cho phòng giáo vụ" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/thiet-bi-phong-hoc-giao-duc/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Thiết bị phòng học, thiết bị dạy học cho trường học | Hương Sơn" />
  <meta property="og:description" content="Cung cấp thiết bị phòng học và thiết bị dạy học cho trường THPT, THCS và cơ sở giáo dục, đồng bộ với giải pháp in ấn, photocopy và số hóa của Hương Sơn." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/thiet-bi-phong-hoc-giao-duc/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Thiết bị phòng học – thiết bị dạy học" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Education Equipment</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Thiết bị phòng học – thiết bị dạy học</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Thiết bị phòng học và thiết bị dạy học cho trường THPT, THCS và cơ sở giáo dục — cung cấp đồng bộ cùng giải pháp in ấn, photocopy và số hóa của Hương Sơn.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Thiết bị phòng học – thiết bị dạy học</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Danh mục thiết bị phòng học và thiết bị dạy học mà Hương Sơn cung cấp cho khách hàng Giáo dục.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường THPT, THCS, Tiểu học và các cơ sở giáo dục có nhu cầu trang bị phòng học, phòng chức năng.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Một đầu mối cung cấp cả thiết bị phòng học lẫn giải pháp in ấn, photocopy, cho thuê và số hóa — không phải làm việc với nhiều nhà cung cấp riêng lẻ.</p>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Nhóm thiết bị phục vụ lớp học và phòng chức năng: màn hình tương tác, bục giảng điện tử, camera vật thể, máy chiếu và thiết bị trình chiếu — cung cấp đồng bộ cùng giải pháp in ấn, photocopy và số hóa của Hương Sơn.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhóm thiết bị phòng học gồm: màn hình tương tác, bục giảng điện tử, camera vật thể (camera trình chiếu), máy chiếu và màn hình hiển thị cho lớp học.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có thể mua trọn gói thiết bị phòng học cùng máy photocopy không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Được. Nhiều trường học kết hợp trang bị thiết bị phòng học cùng lúc với <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/cho-thue-may-truong-hoc/">thuê máy photocopy</a> để giảm số đầu mối làm việc.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="cat-thiet-bi-phong-hoc-giao-duc-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-cat-thiet-bi-phong-hoc-giao-duc-hp">Bỏ trống ô này</label>
            <input type="text" id="f-cat-thiet-bi-phong-hoc-giao-duc-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
