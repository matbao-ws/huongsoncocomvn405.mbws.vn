...
@section('title', "Mực In Laser & Photocopy FANSIPAN Toner Black – Fansipan Black Toner Chính Hãng | Báo Giá | Hương Sơn")
@section('meta_description', "Mực tương thích FANSIPAN độc quyền Hương Sơn cho Toshiba, Ricoh, HP: độ đen đậm nét, mịn màng, bảo vệ tối đa trống gạt. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/fansipan/muc-fansipan-toner-black/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/fansipan/muc-fansipan-toner-black/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/fansipan/muc-fansipan-toner-black/#product",
    "name": "Mực In Laser & Photocopy FANSIPAN Toner Black",
    "image": "https://huongsonco.com.vn/assets/images/products/84-muc-fansipan-tonner-black.jpg",
    "model": "Fansipan Black Toner",
    "sku": "FANSIPAN-BLACK",
    "category": "Mực in tương thích cao cấp",
    "description": "Mực tương thích FANSIPAN độc quyền Hương Sơn cho Toshiba, Ricoh, HP: độ đen đậm nét, mịn màng, bảo vệ tối đa trống gạt.",
    "itemCondition": "https://schema.org/NewCondition",
    "brand": {
      "@@type": "Brand",
      "name": "FANSIPAN (Độc quyền Hương Sơn)"
    },
    "manufacturer": {
      "@@type": "Organization",
      "name": "FANSIPAN (Độc quyền Hương Sơn)"
    },
    "url": "https://huongsonco.com.vn/san-pham/fansipan/muc-fansipan-toner-black/",
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Độ tương thích",
        "value": "Toshiba e-STUDIO, Ricoh Aficio, HP LaserJet"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ mịn hạt mực",
        "value": "Hạt mực micron hình cầu đều đặn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phủ bản in",
        "value": "5% tiêu chuẩn ISO/IEC 19752"
      },
      {
        "@@type": "PropertyValue",
        "name": "Đặc tính",
        "value": "Không sinh bụi rơi vãi, tiết kiệm chi phí 40%"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Thương hiệu độc quyền FANSIPAN thuộc Hương Sơn, sản xuất theo tiêu chuẩn chất lượng cao, hạt mực siêu mịn, tiết kiệm 50% chi phí."
      }
    ],
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Toàn bộ đơn vị sử dụng máy in/photocopy"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="flex items-center justify-start mb-4">
        <nav class="inline-flex items-center gap-1.5 sm:gap-2 bg-white/10 hover:bg-white/15 border border-white/20 px-3.5 sm:px-4 py-1.5 backdrop-blur-md text-xs text-white/90 transition shadow-sm flex-wrap" aria-label="Breadcrumb">
          <a href="/" class="hover:text-white flex items-center gap-1.5 transition">
            ...
            <span>Trang chủ</span>
          </a> <i class="fa-solid fa-angle-right text-[9px] text-gray-400"></i> <a href="/san-pham/" class="text-gray-200 hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] text-gray-400"></i> <a href="/san-pham/fansipan/" class="text-gray-200 hover:text-white transition">FANSIPAN – Mực và vật tư in ấn tương thích</a> <i class="fa-solid fa-angle-right text-[9px] text-gray-400"></i> <span class="text-[#84e372] font-semibold" aria-current="page">Mực In Laser &amp; Photocopy FANSIPAN Toner Black</span>
        </nav>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          <div class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#5eb74c] mb-2.5">
            ...
            Thương hiệu vật tư riêng của Hương Sơn
          </div>
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Mực In Laser &amp; Photocopy FANSIPAN Toner Black
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Mực tương thích FANSIPAN độc quyền Hương Sơn cho Toshiba, Ricoh, HP: độ đen đậm nét, mịn màng, bảo vệ tối đa trống gạt.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="absolute top-3 left-3 bg-[#1A9900] text-white text-[11px] font-bold px-3 py-1 shadow-md flex items-center gap-1.5 border border-white/20 z-20">
                ...
                <span>Thương hiệu FANSIPAN</span>
              </div>
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Mực In Laser &amp; Photocopy FANSIPAN Toner Black" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
              ...
              <div class="pt-3 border-t border-white/15 flex items-center justify-between text-xs text-gray-200">
                <div class="flex items-center gap-1.5 font-medium">
                  ...
                  <span>Mực in tương thích cao cấp FANSIPAN</span>
                </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Fansipan Black Toner</strong> — sản xuất bởi FANSIPAN (Độc quyền Hương Sơn)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Toàn bộ đơn vị sử dụng máy in/photocopy</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/84-muc-fansipan-tonner-black.jpg" alt="Mực In Laser &amp; Photocopy FANSIPAN Toner Black" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Mực In Laser &amp; Photocopy FANSIPAN Toner Black</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Fansipan Black Toner</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">FANSIPAN (Độc quyền Hương Sơn)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/fansipan/" class="hover:text-[#1A9900]">Mực in tương thích cao cấp</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Mực tương thích FANSIPAN độc quyền Hương Sơn cho Toshiba, Ricoh, HP: độ đen đậm nét, mịn màng, bảo vệ tối đa trống gạt.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Fansipan Black Toner</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ tương thích</th>
              <td class="py-3 text-[14.5px] text-gray-600">Toshiba e-STUDIO, Ricoh Aficio, HP LaserJet</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ mịn hạt mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">Hạt mực micron hình cầu đều đặn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phủ bản in</th>
              <td class="py-3 text-[14.5px] text-gray-600">5% tiêu chuẩn ISO/IEC 19752</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Đặc tính</th>
              <td class="py-3 text-[14.5px] text-gray-600">Không sinh bụi rơi vãi, tiết kiệm chi phí 40%</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Thương hiệu độc quyền FANSIPAN thuộc Hương Sơn, sản xuất theo tiêu chuẩn chất lượng cao, hạt mực siêu mịn, tiết kiệm 50% chi phí.</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-muc-fansipan-toner-black-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Fansipan Black Toner" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-muc-fansipan-toner-black-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-muc-fansipan-toner-black-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Mực In Laser & Photocopy FANSIPAN Toner Black?</h2>
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/fansipan/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem FANSIPAN – Mực và vật tư in ấn tương thích</a>
