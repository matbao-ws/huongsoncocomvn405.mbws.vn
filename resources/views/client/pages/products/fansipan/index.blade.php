...
@section('canonical', url('/san-pham/fansipan/'))
@section('jsonld')
...
<head>
  ...
  <title>Mực Fansipan chính hãng – toner, cartridge tương thích Toshiba, Ricoh, HP | Hương Sơn</title>
  <meta name="description" content="FANSIPAN là thương hiệu vật tư in ấn riêng của Hương Sơn: mực, toner, cụm mực tương thích nhiều dòng máy photocopy, máy in phổ biến. Giá tốt, nguồn gốc rõ ràng, có tư vấn theo đúng model máy." />
  <meta name="keywords" content="mực Fansipan, mực Fansipan chính hãng, toner Fansipan, mực Fansipan Toshiba, mực Fansipan Ricoh, mực Fansipan HP, mực Fansipan Konica Minolta, mực photocopy tương thích, mực refill Fansipan, toner refill Fansipan, mực photocopy giá tốt, mực photocopy tiết kiệm, vật tư Fansipan, tư vấn mực Fansipan, mực Fansipan theo model máy, so sánh mực tương thích và chính hãng" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/fansipan/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Mực Fansipan chính hãng – toner, cartridge tương thích Toshiba, Ricoh, HP | Hương Sơn" />
  <meta property="og:description" content="FANSIPAN là thương hiệu vật tư in ấn riêng của Hương Sơn: mực, toner, cụm mực tương thích nhiều dòng máy photocopy, máy in phổ biến. Giá tốt, nguồn gốc rõ ràng, có tư vấn theo đúng model máy." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/fansipan/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="FANSIPAN – Mực và vật tư in ấn tương thích" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Thương hiệu vật tư riêng của Hương Sơn</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">FANSIPAN – Mực và vật tư in ấn tương thích</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">FANSIPAN là thương hiệu vật tư in ấn riêng do Hương Sơn phát triển và phân phối: mực, toner, cụm mực tương thích nhiều dòng máy photocopy, máy in phổ biến trên thị trường — giá tốt hơn hàng chính hãng, có tư vấn đúng theo model máy đang sử dụng.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">FANSIPAN – Mực và vật tư in ấn tương thích</span>
      </nav>
    </div>
  </section>
