...
@section('title', "Cho thuê thiết bị khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS | Hương Sơn")
@section('meta_description', "Gói giải pháp cho thuê thiết bị trọn gói chuyên biệt cho khối Giáo dục: thuê máy in đề thi bí mật, thuê máy photocopy trường học, máy scan số hóa học bạ và thiết bị phòng học thông minh.")
@section('canonical', "https://huongsonco.com.vn/san-pham/cho-thue-thiet-bi-giao-duc/")
@section('jsonld')
...
[
  ...
  },
  {
    ...
    "mainEntity": [
      {
        "@@type": "Question",
        "name": "Gói HƯƠNG SƠN EDUCATION SOLUTIONS bao gồm những thiết bị gì?",
        "acceptedAnswer": {
          "@@type": "Answer",
          "text": "Gói giải pháp cung cấp đầy đủ: Máy in nhân bản siêu tốc Duplo in đề thi, Máy photocopy đa chức năng Toshiba/Konica cho văn phòng trường, Máy scan số hóa học bạ và thiết bị phòng học thông minh."
        }
      },
      {
        "@@type": "Question",
        "name": "Nhà trường có phải trả chi phí thay mực, trống hoặc sửa chữa khi máy hỏng không?",
        "acceptedAnswer": {
          "@@type": "Answer",
          "text": "Không. Giá thuê đã trọn gói 100% chi phí: mực in, master, cụm trống, linh kiện hao mòn và kỹ thuật bảo dưỡng định kỳ tận nơi."
        }
      },
      {
        "@@type": "Question",
        "name": "Thời gian hỗ trợ kỹ thuật trong các kỳ thi cao điểm như thế nào?",
        "acceptedAnswer": {
          "@@type": "Answer",
          "text": "Hương Sơn bố trí kỹ thuật viên chuyên trách trực 24/7 và đặt sẵn máy in dự phòng tại điểm thi để đảm bảo tiến độ tuyệt đối an toàn."
        }
      }
    ]
  }
...
<!-- PAGE HERO (SPLIT-HERO FOREGROUND SHOWCASE BANNER) -->
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Cho thuê thiết bị cho khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">HƯƠNG SƠN EDUCATION SOLUTIONS — Gói giải pháp chuyên biệt toàn diện dành riêng cho Sở GD&amp;ĐT, Phòng GD&amp;ĐT, các Trường Đại học, Cao đẳng, THPT, THCS và Tiểu học. Cung cấp dịch vụ cho thuê máy in nhân bản đề thi bảo mật, thuê máy photocopy tối ưu ngân sách nhà trường, giải pháp số hóa hồ sơ học bạ và thiết bị phòng học tương tác.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Cho thuê thiết bị cho khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Gói giải pháp cho thuê thiết bị chuyên biệt cho khối giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Sở GD&ĐT, Hội đồng thi, Ban Giám hiệu, Phòng Hành chính - Quản trị các trường ĐH, CĐ, THPT, THCS trên toàn miền Bắc.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Đáp ứng các đợt thi cử cao điểm và vận hành in ấn giảng dạy quanh năm mà không lo phát sinh chi phí bảo trì, kẹt giấy hay sự cố kỹ thuật.</p>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Giải pháp trọn gói cho ngành giáo dục: không cần vốn đầu tư ban đầu, miễn phí toàn bộ vật tư mực in &amp; linh kiện thay thế, trực kỹ thuật 24/7 trong mọi kỳ thi, kèm máy dự phòng 1-đổi-1 tại chỗ.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed"><strong>Thuê máy in nhân bản in sao đề thi</strong>: Tốc độ 130–150 trang/phút, bảo mật tuyệt đối, kỹ thuật viên trực 24/24 trong khu vực cách ly.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed"><strong>Thuê máy photocopy quản lý chi phí trường học</strong>: Cấp tài khoản/mã PIN phân quyền từng tổ bộ môn, định mức chi phí rõ ràng, không lo hỏng hóc.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed"><strong>Số hóa học bạ & hồ sơ học sinh</strong>: Máy scan 2 mặt tốc độ cao 60–100 trang/phút, nhận dạng OCR chuẩn hóa dữ liệu Đề án 06.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed"><strong>Thiết bị phòng học tương tác</strong>: Màn hình cảm ứng thông minh, máy chiếu, âm thanh trợ giảng giảng đường.</span>
        </li>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          ...
          <div class="p-6 flex flex-col flex-1">
            ...
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/cho-thue-thiet-bi-giao-duc/goi-thue-may-in-nhan-ban-de-thi-thpt/">Gói thuê máy in nhân bản in đề thi THPT &amp; Tuyển sinh</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Gói giải pháp chuyên biệt in sao đề thi THPT của Hương Sơn — được tin dùng bởi các Sở GD&amp;ĐT Vĩnh Phúc, Quảng Trị, Hà Nội... Đảm bảo tuyệt đối bảo mật,…</p>
            <a href="/san-pham/cho-thue-thiet-bi-giao-duc/goi-thue-may-in-nhan-ban-de-thi-thpt/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/toshiba-e-studio-2829a.jpg" alt="Gói thuê máy photocopy trường học định mức chi phí" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Hương Sơn Education Solutions</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/cho-thue-thiet-bi-giao-duc/goi-thue-may-photocopy-truong-hoc-toshiba/">Gói thuê máy photocopy trường học định mức chi phí</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Gói thuê máy photocopy trường học tối ưu ngân sách — 0 đồng đầu tư ban đầu, cấp mã định mức cho từng giáo viên và miễn phí 100% mực in &amp; bảo dưỡng.</p>
            <a href="/san-pham/cho-thue-thiet-bi-giao-duc/goi-thue-may-photocopy-truong-hoc-toshiba/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Gói HƯƠNG SƠN EDUCATION SOLUTIONS bao gồm những thiết bị gì?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Gói giải pháp cung cấp đầy đủ: Máy in nhân bản siêu tốc Duplo in đề thi, Máy photocopy đa chức năng Toshiba/Konica cho văn phòng trường, Máy scan số hóa học bạ và thiết bị phòng học thông minh.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Nhà trường có phải trả chi phí thay mực, trống hoặc sửa chữa khi máy hỏng không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Không. Giá thuê đã trọn gói 100% chi phí: mực in, master, cụm trống, linh kiện hao mòn và kỹ thuật bảo dưỡng định kỳ tận nơi.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Thời gian hỗ trợ kỹ thuật trong các kỳ thi cao điểm như thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Hương Sơn bố trí kỹ thuật viên chuyên trách trực 24/7 và đặt sẵn máy in dự phòng tại điểm thi để đảm bảo tiến độ tuyệt đối an toàn.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="cat-cho-thue-thiet-bi-giao-duc-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-cat-cho-thue-thiet-bi-giao-duc-hp">Bỏ trống ô này</label>
            <input type="text" id="f-cat-cho-thue-thiet-bi-giao-duc-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
