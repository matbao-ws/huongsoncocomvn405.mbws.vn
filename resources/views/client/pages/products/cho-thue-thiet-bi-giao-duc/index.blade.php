...
@section('canonical', url('/san-pham/cho-thue-thiet-bi-giao-duc/'))
@section('jsonld')
...
<head>
  ...
  <title>Cho thuê thiết bị khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS | Hương Sơn</title>
  <meta name="description" content="Gói giải pháp cho thuê thiết bị trọn gói chuyên biệt cho khối Giáo dục: thuê máy in đề thi bí mật, thuê máy photocopy trường học, máy scan số hóa học bạ và thiết bị phòng học thông minh." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/cho-thue-thiet-bi-giao-duc/" />

  <meta property="og:type" content="website" />
  <meta property="og:title" content="Cho thuê thiết bị khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS | Hương Sơn" />
  <meta property="og:description" content="Gói giải pháp cho thuê thiết bị trọn gói chuyên biệt cho khối Giáo dục: thuê máy in đề thi bí mật, thuê máy photocopy trường học, máy scan số hóa học bạ và thiết bị phòng học thông minh." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/cho-thue-thiet-bi-giao-duc/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Cho thuê thiết bị cho khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Education Solutions</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Cho thuê thiết bị cho khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">HƯƠNG SƠN EDUCATION SOLUTIONS — Gói giải pháp chuyên biệt toàn diện dành riêng cho Sở GD&amp;ĐT, Phòng GD&amp;ĐT, các Trường Đại học, Cao đẳng, THPT, THCS và Tiểu học. Cung cấp dịch vụ cho thuê máy in nhân bản đề thi bảo mật, thuê máy photocopy tối ưu ngân sách nhà trường, giải pháp số hóa hồ sơ học bạ và thiết bị phòng học tương tác.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Cho thuê thiết bị cho khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS</span>
      </nav>
    </div>
  </section>
