...
<!-- PAGE HERO (REDESIGNED BREADCRUMB BANNER) -->
  <section class="relative bg-[#0d1626] py-10 sm:py-14 overflow-hidden border-b border-white/10">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/banners/hero_edu_tech_1787899932385.jpg" alt="Cho thuê thiết bị cho khối Giáo dục – HƯƠNG SƠN EDUCATION SOLUTIONS" class="w-full h-full object-cover object-center opacity-40 scale-105 transform motion-safe:transition-transform motion-safe:duration-1000" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
      ...
      <p class="max-w-2xl mx-auto text-gray-200 text-[14.5px] sm:text-[15.5px] leading-relaxed mb-6 font-normal">
        HƯƠNG SƠN EDUCATION SOLUTIONS — Gói giải pháp chuyên biệt toàn diện dành riêng cho Sở GD&amp;ĐT, Phòng GD&amp;ĐT, các Trường Đại học, Cao đẳng, THPT, THCS và Tiểu học. Cung cấp dịch vụ cho thuê máy in nhân bản đề thi bảo mật, thuê máy photocopy tối ưu ngân sách nhà trường, giải pháp số hóa hồ sơ học bạ và thiết bị phòng học tương tác.
      </p>
