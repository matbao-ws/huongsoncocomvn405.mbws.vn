...
<!-- PAGE HERO (REDESIGNED BREADCRUMB BANNER) -->
  <section class="relative bg-[#0d1626] py-10 sm:py-14 overflow-hidden border-b border-white/10">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/banners/hero_edu_tech_1787899932385.jpg" alt="Gói thuê máy in nhân bản in đề thi THPT &amp; Tuyển sinh" class="w-full h-full object-cover object-center opacity-40 scale-105 transform motion-safe:transition-transform motion-safe:duration-1000" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
      ...
      <p class="max-w-2xl mx-auto text-gray-200 text-[14.5px] sm:text-[15.5px] leading-relaxed mb-6 font-normal">
        Gói giải pháp chuyên biệt in sao đề thi THPT của Hương Sơn — được tin dùng bởi các Sở GD&amp;ĐT Vĩnh Phúc, Quảng Trị, Hà Nội... Đảm bảo tuyệt đối bảo mật, đúng tiến độ và không gián đoạn.
      </p>
