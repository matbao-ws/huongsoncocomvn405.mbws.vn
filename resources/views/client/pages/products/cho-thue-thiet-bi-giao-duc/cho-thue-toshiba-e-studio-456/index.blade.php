...
@section('title', "Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Gói thuê máy photocopy 45 trang/phút giá rẻ trọn gói: miễn phí mực, linh kiện và kỹ thuật bảo trì định kỳ. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
@section('canonical', "https://huongsonco.com.vn/san-pham/cho-thue-thiet-bi-giao-duc/cho-thue-toshiba-e-studio-456/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/cho-thue-thiet-bi-giao-duc/cho-thue-toshiba-e-studio-456/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/cho-thue-thiet-bi-giao-duc/cho-thue-toshiba-e-studio-456/#product",
    "name": "Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456",
    "image": "https://huongsonco.com.vn/assets/images/products/98-cho-thue-toshiba-e-studio-456.jpg",
    "model": "e-STUDIO 456",
    "sku": "THUE-TOSH-456",
    "category": "Cho thuê thiết bị",
    "description": "Gói thuê máy photocopy 45 trang/phút giá rẻ trọn gói: miễn phí mực, linh kiện và kỹ thuật bảo trì định kỳ.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ thiết bị",
        "value": "45 trang/phút (A4)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Theo gói từ 5.000 đến 20.000 bản/tháng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Quyền lợi đi kèm",
        "value": "Miễn phí 100% mực in, linh kiện hao mòn, kỹ thuật xử lý sự cố trong 2h"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Văn phòng công ty"
      },
      {
        "@@type": "Audience",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Gói thuê máy photocopy 45 trang/phút giá rẻ trọn gói: miễn phí mực, linh kiện và kỹ thuật bảo trì định kỳ.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>e-STUDIO 456</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Văn phòng công ty, Trường học, Dự án công trình</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/98-cho-thue-toshiba-e-studio-456.jpg" alt="Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">e-STUDIO 456</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Gói thuê máy photocopy 45 trang/phút giá rẻ trọn gói: miễn phí mực, linh kiện và kỹ thuật bảo trì định kỳ.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — e-STUDIO 456</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ thiết bị</th>
              <td class="py-3 text-[14.5px] text-gray-600">45 trang/phút (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">A3 - A4 - A5</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định mức trang in</th>
              <td class="py-3 text-[14.5px] text-gray-600">Theo gói từ 5.000 đến 20.000 bản/tháng</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Quyền lợi đi kèm</th>
              <td class="py-3 text-[14.5px] text-gray-600">Miễn phí 100% mực in, linh kiện hao mòn, kỹ thuật xử lý sự cố trong 2h</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-cho-thue-toshiba-e-studio-456-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="e-STUDIO 456" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-cho-thue-toshiba-e-studio-456-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-cho-thue-toshiba-e-studio-456-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Gói Cho Thuê Máy Photocopy Toshiba e-STUDIO 456?</h2>
