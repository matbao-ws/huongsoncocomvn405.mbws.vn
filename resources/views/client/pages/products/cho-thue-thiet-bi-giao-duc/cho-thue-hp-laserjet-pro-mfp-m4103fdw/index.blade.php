...
@section('meta_description', "Dịch vụ cho thuê máy in laser đa chức năng A4 HP trọn gói mực và sửa chữa, chỉ từ 550.000 đ/tháng. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Dịch vụ cho thuê thiết bị trọn gói, miễn phí mực in và kỹ thuật bảo trì định kỳ từ Hương Sơn."
      }
    ],
    "audience": [
      {
