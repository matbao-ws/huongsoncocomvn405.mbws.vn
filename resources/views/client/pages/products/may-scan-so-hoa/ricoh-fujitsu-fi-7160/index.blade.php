...
@section('title', "Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm) Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Ricoh fi-7160 (tiền thân Fujitsu fi-7160) là dòng máy quét số hóa tài liệu bán chạy số 1 thế giới — tốc độ 60 trang/phút, nạp giấy siêu êm và... Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-scan-so-hoa/ricoh-fujitsu-fi-7160/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-scan-so-hoa/ricoh-fujitsu-fi-7160/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-scan-so-hoa/ricoh-fujitsu-fi-7160/#product",
    "name": "Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm)",
    "image": "https://huongsonco.com.vn/assets/images/products/ricoh-fujitsu-fi-7160.jpg",
    "model": "fi-7160",
    "sku": "RICOH-FI7160",
    "category": "Máy scan số hóa tài liệu",
    "description": "Ricoh fi-7160 (tiền thân Fujitsu fi-7160) là dòng máy quét số hóa tài liệu bán chạy số 1 thế giới — tốc độ 60 trang/phút, nạp giấy siêu êm và tích hợp phần mềm xử lý ảnh PaperStream IP chuyên nghiệp.",
    "itemCondition": "https://schema.org/NewCondition",
    "brand": {
      "@@type": "Brand",
      "name": "Ricoh / Fujitsu (Nhật Bản)"
    },
    "manufacturer": {
      "@@type": "Organization",
      "name": "Ricoh / Fujitsu (Nhật Bản)"
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ quét",
        "value": "60 trang/phút, 120 ảnh/phút (2 mặt tự động)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Cảm biến",
        "value": "Cảm biến sóng siêu âm chống kẹt giấy và cuốn giấy kép"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải quang học",
        "value": "600 dpi"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Chính hãng Ricoh / Fujitsu Nhật Bản."
      }
    ],
    "audience": [
      {
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm)
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Ricoh fi-7160 (tiền thân Fujitsu fi-7160) là dòng máy quét số hóa tài liệu bán chạy số 1 thế giới — tốc độ 60 trang/phút, nạp giấy siêu êm và tích hợp phần mềm xử lý ảnh PaperStream IP chuyên nghiệp.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/highspeed_scanner_1787905830483.jpg" alt="Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm)" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>fi-7160</strong> — sản xuất bởi Ricoh / Fujitsu (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Sở GD&amp;ĐT, Trường học, Ngân hàng, Cơ quan lưu trữ</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/ricoh-fujitsu-fi-7160.jpg" alt="Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm)" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">fi-7160</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">Ricoh / Fujitsu (Nhật Bản)</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Số hóa hồ sơ học bạ, văn bằng chứng chỉ cho trường học theo Đề án 06</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quét hồ sơ bệnh án, chứng từ kế toán, hồ sơ cán bộ công chức</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhận dạng ký tự quang học OCR xuất ra file PDF có thể tìm kiếm</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — fi-7160</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ quét</th>
              <td class="py-3 text-[14.5px] text-gray-600">60 trang/phút, 120 ảnh/phút (2 mặt tự động)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay nạp tự động (ADF)</th>
              <td class="py-3 text-[14.5px] text-gray-600">80 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Cảm biến</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm biến sóng siêu âm chống kẹt giấy và cuốn giấy kép</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải quang học</th>
              <td class="py-3 text-[14.5px] text-gray-600">600 dpi</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-ricoh-fujitsu-fi-7160-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="fi-7160" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-ricoh-fujitsu-fi-7160-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-ricoh-fujitsu-fi-7160-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy scan tài liệu tốc độ cao Ricoh fi-7160 (Model tiền nhiệm)?</h2>
