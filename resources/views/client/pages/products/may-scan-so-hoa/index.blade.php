...
@section('canonical', url('/san-pham/may-scan-so-hoa/'))
@section('jsonld')
...
<head>
  ...
  <title>Máy scan tốc độ cao A4/A3 – thiết bị số hóa tài liệu | Hương Sơn</title>
  <meta name="description" content="Máy scan tốc độ cao phục vụ số hóa hồ sơ, văn bằng, chứng chỉ cho Sở GD&ĐT, trường học và cơ quan Nhà nước. Tư vấn chọn máy theo khối lượng và loại tài liệu." />
  <meta name="keywords" content="máy scan tài liệu, máy scan tốc độ cao, máy scan tài liệu tốc độ cao, máy scan A3, máy scan A4, máy scan doanh nghiệp, máy scan hồ sơ, máy scan tài liệu số lượng lớn, máy quét hồ sơ, scanner tài liệu, báo giá máy scan, mua máy scan tài liệu" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-scan-so-hoa/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy scan tốc độ cao A4/A3 – thiết bị số hóa tài liệu | Hương Sơn" />
  <meta property="og:description" content="Máy scan tốc độ cao phục vụ số hóa hồ sơ, văn bằng, chứng chỉ cho Sở GD&ĐT, trường học và cơ quan Nhà nước. Tư vấn chọn máy theo khối lượng và loại tài liệu." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-scan-so-hoa/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Máy scan – thiết bị số hóa tài liệu" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy scan – thiết bị số hóa tài liệu</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Máy scan tốc độ cao phục vụ số hóa hồ sơ, văn bằng, chứng chỉ và tài liệu lưu trữ — chọn theo khối lượng trang mỗi ngày, khổ giấy, số mặt và tình trạng giấy.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy scan – thiết bị số hóa tài liệu</span>
      </nav>
    </div>
  </section>
