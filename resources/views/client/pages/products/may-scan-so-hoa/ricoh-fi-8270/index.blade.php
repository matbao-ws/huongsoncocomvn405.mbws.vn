...
<!-- PAGE HERO (REDESIGNED BREADCRUMB BANNER) -->
  <section class="relative bg-[#0d1626] py-10 sm:py-14 overflow-hidden border-b border-white/10">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/banners/highspeed_scanner_1787905830483.jpg" alt="Máy quét Ricoh fi-8270" class="w-full h-full object-cover object-center opacity-40 scale-105 transform motion-safe:transition-transform motion-safe:duration-1000" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
      ...
      <p class="max-w-2xl mx-auto text-gray-200 text-[14.5px] sm:text-[15.5px] leading-relaxed mb-6 font-normal">
        Máy quét 2 mặt tự động + Flatbed A4, tích hợp tính sổ dập ghim và hộ chiếu,  tốc độ 70ppm/140ipm (quét màu, 300 dpi), khay  giấy 100 tờ, công suất 10000 tờ/ngày. Kết nối USB 3.2/2.0/1.1 &amp; LAN 10BASE-T, 100BASE-TX, 1000BA...
      </p>
