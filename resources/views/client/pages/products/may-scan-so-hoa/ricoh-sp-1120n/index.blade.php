...
@section('title', "Máy quét Ricoh SP-1120N Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Máy quét 2 mặt kết nối mạng LAN,  Tốc độ 20ppm/40ipm (quét màu, 300dpi), Khay  giấy 50 tờ,  Công suất 3000 tờ/ngày.  Kết nối USB 3.2 & LAN.  Kèm... Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-scan-so-hoa/ricoh-sp-1120n/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-scan-so-hoa/ricoh-sp-1120n/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-scan-so-hoa/ricoh-sp-1120n/#product",
    "name": "Máy quét Ricoh SP-1120N",
    "image": "https://huongsonco.com.vn/assets/images/products/ricoh-sp-1120n.jpg",
    "model": "SP-1120N",
    "sku": "PA03811-B001",
    "category": "Máy scan số hóa tài liệu",
    "description": "Máy quét 2 mặt kết nối mạng LAN,  Tốc độ 20ppm/40ipm (quét màu, 300dpi), Khay  giấy 50 tờ,  Công suất 3000 tờ/ngày.  Kết nối USB 3.2 & LAN.  Kèm theo giải pháp số hóa bóc tách 20 trường dữ liệu tiếng Việt (tháng 3/2026 n...",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ quét",
        "value": "20ppm/40ipm (quét màu, 300dpi), Khay giấy 50 tờ,"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Tốc độ Scan: 20ppm/40ipm, chất lượng quét màu 300dpi - 24 bit"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Ricoh SP-1120N"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Chính hãng Ricoh. Xuất xứ: China. Bảo hành: 12 Tháng."
      }
    ],
    "audience": [
      {
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy quét Ricoh SP-1120N
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Máy quét 2 mặt kết nối mạng LAN,  Tốc độ 20ppm/40ipm (quét màu, 300dpi), Khay  giấy 50 tờ,  Công suất 3000 tờ/ngày.  Kết nối USB 3.2 &amp; LAN.  Kèm theo giải pháp số hóa bóc tách 20 trường dữ liệu tiếng Việt (tháng 3/2026 n...</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/highspeed_scanner_1787905830483.jpg" alt="Máy quét Ricoh SP-1120N" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>SP-1120N</strong> — sản xuất bởi Ricoh (China)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
          ...
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Ricoh SP-1120N</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/ricoh-sp-1120n.jpg" alt="Máy quét Ricoh SP-1120N" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy quét Ricoh SP-1120N</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">SP-1120N</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">Ricoh (China)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-scan-so-hoa/" class="hover:text-[#1A9900]">Máy scan số hóa tài liệu</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Số hóa hồ sơ học bạ, văn bằng chứng chỉ cho trường học và cơ sở giáo dục theo Đề án 06</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quét chứng từ kế toán, hồ sơ bệnh án bệnh viện, hồ sơ cán bộ công chức</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tự động nhận dạng tiếng Việt OCR xuất ra tệp PDF phục vụ tra cứu số</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">China</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Chính hãng Ricoh. Xuất xứ: China. Bảo hành: 12 Tháng.</td></tr>
            ...
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Ricoh SP-1120N</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-ricoh-sp-1120n-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="SP-1120N" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-ricoh-sp-1120n-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-ricoh-sp-1120n-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy quét Ricoh SP-1120N?</h2>
