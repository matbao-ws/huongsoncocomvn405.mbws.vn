...
@section('meta_description', "Cẩm nang tra cứu mã mực in và master cho tất cả các thế hệ máy in nhân bản siêu tốc Duplo từ trước đến nay. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/bang-tra-ma-muc-master-duplo/"
      }
    ]
  },
  {
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Mã mực DP-S",
        "value": "Mực Duplo CC Black, Blue, Red (1.000ml)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Mã mực DP-F/DP-X",
        "value": "Mực Duplo HD Black (1.000ml)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Mã Master DP-S",
        "value": "DR-S55, DR-S65, DR-S85"
      },
      {
        "@@type": "PropertyValue",
        "name": "Mã Master DP-F/DP-X",
        "value": "DR-F55, DR-F65, DR-F85, DR-X55, DR-X65"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Kỹ thuật viên"
      },
      {
        "@@type": "Audience",
        "audienceType": "Cán bộ quản lý thiết bị"
      },
      {
        "@@type": "Audience",
        "audienceType": "Văn thư"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Bảng Tra Mã Mực &amp; Master Máy In Duplo Đầy Đủ
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Cẩm nang tra cứu mã mực in và master cho tất cả các thế hệ máy in nhân bản siêu tốc Duplo từ trước đến nay.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Bảng Tra Mã Mực &amp; Master Máy In Duplo Đầy Đủ" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Duplo Supplies Catalog</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Kỹ thuật viên, Cán bộ quản lý thiết bị, Văn thư</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/95-bang-tra-ma-muc-master-may-in-duplo.jpg" alt="Bảng Tra Mã Mực &amp; Master Máy In Duplo Đầy Đủ" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Bảng Tra Mã Mực &amp; Master Máy In Duplo Đầy Đủ</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Duplo Supplies Catalog</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="hover:text-[#1A9900]">Cẩm nang vật tư</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Cẩm nang tra cứu mã mực in và master cho tất cả các thế hệ máy in nhân bản siêu tốc Duplo từ trước đến nay.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Duplo Supplies Catalog</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Mã mực DP-S</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực Duplo CC Black, Blue, Red (1.000ml)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Mã mực DP-F/DP-X</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực Duplo HD Black (1.000ml)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Mã Master DP-S</th>
              <td class="py-3 text-[14.5px] text-gray-600">DR-S55, DR-S65, DR-S85</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Mã Master DP-F/DP-X</th>
              <td class="py-3 text-[14.5px] text-gray-600">DR-F55, DR-F65, DR-F85, DR-X55, DR-X65</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-bang-tra-ma-muc-master-duplo-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Duplo Supplies Catalog" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-bang-tra-ma-muc-master-duplo-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-bang-tra-ma-muc-master-duplo-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Bảng Tra Mã Mực & Master Máy In Duplo Đầy Đủ?</h2>
