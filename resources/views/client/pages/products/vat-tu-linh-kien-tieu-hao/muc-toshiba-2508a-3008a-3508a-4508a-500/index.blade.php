...
@section('title', "Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Mực in Toshiba chính hãng cho dòng máy e-STUDIO 2508A, 3008A, 3508A, 4508A, 2528A, 3028A: định mức 43.900 trang chuẩn. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-toshiba-2508a-3008a-3508a-4508a-500/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-toshiba-2508a-3008a-3508a-4508a-500/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-toshiba-2508a-3008a-3508a-4508a-500/#product",
    "name": "Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng",
    "image": "https://huongsonco.com.vn/assets/images/products/59-muc-toshiba-2508a-3008a-3508a-4508a-500.jpg",
    "model": "T-3008P / T-5008P",
    "sku": "TOSH-INK-3008P",
    "category": "Mực photocopy chính hãng",
    "description": "Mực in Toshiba chính hãng cho dòng máy e-STUDIO 2508A, 3008A, 3508A, 4508A, 2528A, 3028A: định mức 43.900 trang chuẩn.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Mã mực",
        "value": "T-3008P / T-5008P"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định mức trang in",
        "value": "Khoảng 43.900 trang (độ phủ 5%)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Trọng lượng mực",
        "value": "700 g / chai"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tương thích",
        "value": "e-STUDIO 2008A / 2508A / 3008A / 3508A / 4508A / 2528A / 3028A / 3528A / 4528A"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Tất cả khách hàng sử dụng máy photocopy Toshiba"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Mực in Toshiba chính hãng cho dòng máy e-STUDIO 2508A, 3008A, 3508A, 4508A, 2528A, 3028A: định mức 43.900 trang chuẩn.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>T-3008P / T-5008P</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Tất cả khách hàng sử dụng máy photocopy Toshiba</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/59-muc-toshiba-2508a-3008a-3508a-4508a-500.jpg" alt="Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">T-3008P / T-5008P</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="hover:text-[#1A9900]">Mực photocopy chính hãng</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Mực in Toshiba chính hãng cho dòng máy e-STUDIO 2508A, 3008A, 3508A, 4508A, 2528A, 3028A: định mức 43.900 trang chuẩn.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — T-3008P / T-5008P</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Mã mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">T-3008P / T-5008P</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định mức trang in</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 43.900 trang (độ phủ 5%)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Trọng lượng mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">700 g / chai</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tương thích</th>
              <td class="py-3 text-[14.5px] text-gray-600">e-STUDIO 2008A / 2508A / 3008A / 3508A / 4508A / 2528A / 3028A / 3528A / 4528A</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-muc-toshiba-2508a-3008a-3508a-4508a-500-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="T-3008P / T-5008P" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-muc-toshiba-2508a-3008a-3508a-4508a-500-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-muc-toshiba-2508a-3008a-3508a-4508a-500-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng?</h2>
