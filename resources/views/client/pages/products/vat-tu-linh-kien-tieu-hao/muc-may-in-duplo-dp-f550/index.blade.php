...
@section('title', "Mực Máy In Duplo DP-F550 / DP-F850 (Đen & Màu) – Duplo DP-F550 Ink Chính Hãng | Báo Giá | Hương Sơn")
@section('meta_description', "Mực in chuyên dụng cho thế hệ máy Duplo DP-F và DP-X series, độ đậm quang học cao, khô nhanh trên mọi loại giấy bãi bằng. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-may-in-duplo-dp-f550/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-may-in-duplo-dp-f550/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-may-in-duplo-dp-f550/#product",
    "name": "Mực Máy In Duplo DP-F550 / DP-F850 (Đen & Màu)",
    "image": "https://huongsonco.com.vn/assets/images/products/46-muc-may-in-duplo-dp-f550.jpg",
    "model": "Duplo DP-F550 Ink",
    "sku": "DUPLO-INK-F550",
    "category": "Vật tư in siêu tốc",
    "description": "Mực in chuyên dụng cho thế hệ máy Duplo DP-F và DP-X series, độ đậm quang học cao, khô nhanh trên mọi loại giấy bãi bằng.",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Màu sắc",
        "value": "Đen (Black), Xanh (Blue), Đỏ (Red)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dòng máy sử dụng",
        "value": "Duplo DP-F550, DP-F850, DP-X550, DP-X650, DP-X850"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Mực Máy In Duplo DP-F550 / DP-F850 (Đen &amp; Màu)
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Mực in chuyên dụng cho thế hệ máy Duplo DP-F và DP-X series, độ đậm quang học cao, khô nhanh trên mọi loại giấy bãi bằng.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Mực Máy In Duplo DP-F550 / DP-F850 (Đen &amp; Màu)" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Duplo DP-F550 Ink</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Khối trường học, Nhà in</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/46-muc-may-in-duplo-dp-f550.jpg" alt="Mực Máy In Duplo DP-F550 / DP-F850 (Đen &amp; Màu)" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Mực Máy In Duplo DP-F550 / DP-F850 (Đen &amp; Màu)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Duplo DP-F550 Ink</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Mực in chuyên dụng cho thế hệ máy Duplo DP-F và DP-X series, độ đậm quang học cao, khô nhanh trên mọi loại giấy bãi bằng.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Duplo DP-F550 Ink</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung tích</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.000 ml / hộp</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màu sắc</th>
              <td class="py-3 text-[14.5px] text-gray-600">Đen (Black), Xanh (Blue), Đỏ (Red)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dòng máy sử dụng</th>
              <td class="py-3 text-[14.5px] text-gray-600">Duplo DP-F550, DP-F850, DP-X550, DP-X650, DP-X850</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-muc-may-in-duplo-dp-f550-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Duplo DP-F550 Ink" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-muc-may-in-duplo-dp-f550-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-muc-may-in-duplo-dp-f550-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Mực Máy In Duplo DP-F550 / DP-F850 (Đen & Màu)?</h2>
