...
@section('title', "Mực in và Master in chính hãng Duplo Nhật Bản – Duplo Ink & Master HD Chính Hãng | Báo Giá | Hương Sơn")
@section('meta_description', "Mực in và cuộn phim Master in chính hãng Duplo Nhật Bản — độ phân giải cao, bám giấy tốt, khô ngay lập tức, là yếu tố then chốt cho... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-in-master-duplo-chinh-hang/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-in-master-duplo-chinh-hang/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-in-master-duplo-chinh-hang/#product",
    "name": "Mực in và Master in chính hãng Duplo Nhật Bản",
    "image": "https://huongsonco.com.vn/assets/images/products/muc-in-master-duplo.jpg",
    "model": "Duplo Ink & Master HD",
    "sku": "DUPLO-INK-MAT",
    "category": "Vật tư in siêu tốc chính hãng",
    "description": "Mực in và cuộn phim Master in chính hãng Duplo Nhật Bản — độ phân giải cao, bám giấy tốt, khô ngay lập tức, là yếu tố then chốt cho bản in đề thi sắc nét.",
    ...
    "additionalProperty": [
      {
        ...
        "value": "Tuýp mực 1.000ml / Cuộn Master 200–220 tấm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màu mực",
        "value": "Mực đen tiêu chuẩn (Black) và các màu chuyên dụng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
      ...
      },
      {
        ...
        "value": "DP-X550, DP-X650, DP-F550, DP-G325"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Hương Sơn nhập khẩu và phân phối trực tiếp từ Duplo Nhật Bản."
      }
    ],
    "audience": [
      {
      ...
      {
        "@@type": "Audience",
        "audienceType": "In ấn chuyên nghiệp"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Mực in và Master in chính hãng Duplo Nhật Bản
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Mực in và cuộn phim Master in chính hãng Duplo Nhật Bản — độ phân giải cao, bám giấy tốt, khô ngay lập tức, là yếu tố then chốt cho bản in đề thi sắc nét.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Mực in và Master in chính hãng Duplo Nhật Bản" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Duplo Ink &amp; Master HD</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Giáo dục, In ấn chuyên nghiệp</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">DP-X550, DP-X650, DP-F550, DP-G325</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/muc-in-master-duplo.jpg" alt="Mực in và Master in chính hãng Duplo Nhật Bản" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Mực in và Master in chính hãng Duplo Nhật Bản</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Duplo Ink &amp; Master HD</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/vat-tu-linh-kien-tieu-hao/" class="hover:text-[#1A9900]">Vật tư in siêu tốc chính hãng</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Sử dụng đồng bộ cho các dòng máy in nhân bản siêu tốc Duplo</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đảm bảo độ bám mực tốt, khô nhanh, không nhòe và không mùi độc hại</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tối ưu tuổi thọ đầu ghi Master và trống từ máy in</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Duplo Ink &amp; Master HD</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Quy cách đóng gói</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tuýp mực 1.000ml / Cuộn Master 200–220 tấm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màu mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực đen tiêu chuẩn (Black) và các màu chuyên dụng</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Xuất xứ</th>
              <td class="py-3 text-[14.5px] text-gray-600">Made in Japan</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Hương Sơn nhập khẩu và phân phối trực tiếp từ Duplo Nhật Bản.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">DP-X550, DP-X650, DP-F550, DP-G325</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-muc-in-master-duplo-chinh-hang-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Duplo Ink &amp; Master HD" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-muc-in-master-duplo-chinh-hang-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-muc-in-master-duplo-chinh-hang-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Mực in và Master in chính hãng Duplo Nhật Bản?</h2>
