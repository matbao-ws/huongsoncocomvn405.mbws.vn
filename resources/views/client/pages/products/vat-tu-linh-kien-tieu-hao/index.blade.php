...
@section('canonical', url('/san-pham/vat-tu-linh-kien-tieu-hao/'))
@section('jsonld')
...
<head>
  ...
  <title>Mực Fansipan, vật tư Duplo, trống Drum, bột từ | Hương Sơn</title>
  <meta name="description" content="Cung cấp mực Fansipan, vật tư hao tài máy Duplo, trống Drum, bột từ và linh kiện cho máy photocopy, máy in. Vật tư tương thích nhiều dòng máy, có nguồn gốc rõ ràng." />
  <meta name="keywords" content="mực Fansipan, mực photocopy Fansipan, toner Fansipan, mua mực Fansipan, báo giá mực Fansipan, mực photocopy tương thích, mực toner đen Fansipan, mực laser Fansipan, mực Fansipan Toshiba, mực Fansipan Ricoh, mực Fansipan Konica Minolta, mực Fansipan Duplo, mực photocopy A3, mực photocopy A4, toner máy photocopy, mực Fansipan theo model máy" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Mực Fansipan, vật tư Duplo, trống Drum, bột từ | Hương Sơn" />
  <meta property="og:description" content="Cung cấp mực Fansipan, vật tư hao tài máy Duplo, trống Drum, bột từ và linh kiện cho máy photocopy, máy in. Vật tư tương thích nhiều dòng máy, có nguồn gốc rõ ràng." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Vật tư – linh kiện – tiêu hao cho máy photocopy, máy in" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Consumables &amp; FANSIPAN</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Vật tư – linh kiện – tiêu hao cho máy photocopy, máy in</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Hương Sơn cung cấp vật tư, linh kiện và hàng tiêu hao cho máy photocopy và máy in: mực mang thương hiệu riêng Fansipan tương thích nhiều dòng máy phổ biến, vật tư hao tài chính hãng Duplo, trống Drum và bột từ.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Vật tư – linh kiện – tiêu hao cho máy photocopy, máy in</span>
      </nav>
    </div>
  </section>
