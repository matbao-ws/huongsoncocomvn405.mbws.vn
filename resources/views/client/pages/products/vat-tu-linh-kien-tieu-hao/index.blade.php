    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Hương Sơn cung cấp vật tư, linh kiện và hàng tiêu hao cho máy photocopy và máy in: mực mang thương hiệu riêng Fansipan tương thích nhiều dòng máy phổ biến, vật tư hao tài chính hãng Duplo, trống Drum và bột từ.</p>
