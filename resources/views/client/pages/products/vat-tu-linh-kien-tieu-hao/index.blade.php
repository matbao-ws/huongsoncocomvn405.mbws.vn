    ...
    "itemListElement": [
      {
        ...
        "url": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-master-duplo-chinh-hang/"
      },
      {
        "@@type": "ListItem",
        "position": 2,
        "name": "Mực Máy In Duplo DP-F550 / DP-F850 (Đen & Màu)",
        "url": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-may-in-duplo-dp-f550/"
      },
      {
        "@@type": "ListItem",
        "position": 3,
        "name": "Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng",
        "url": "https://huongsonco.com.vn/san-pham/vat-tu-linh-kien-tieu-hao/muc-toshiba-2508a-3008a-3508a-4508a-500/"
      },
      {
        "@@type": "ListItem",
        "position": 4,
...
<!-- PAGE HERO (REDESIGNED BREADCRUMB BANNER) -->
  <section class="relative bg-[#0d1626] py-10 sm:py-14 overflow-hidden border-b border-white/10">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Vật tư – linh kiện – tiêu hao cho máy photocopy, máy in" class="w-full h-full object-cover object-center opacity-40 scale-105 transform motion-safe:transition-transform motion-safe:duration-1000" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3 leading-[1.38] tracking-normal drop-shadow-md max-w-4xl mx-auto">
        Vật tư – linh kiện – tiêu hao cho máy photocopy, máy in
      </h1>
      <p class="max-w-2xl mx-auto text-gray-200 text-[14.5px] sm:text-[15.5px] leading-relaxed mb-6 font-normal">
        Hương Sơn cung cấp vật tư, linh kiện và hàng tiêu hao cho máy photocopy và máy in: mực mang thương hiệu riêng Fansipan tương thích nhiều dòng máy phổ biến, vật tư hao tài chính hãng Duplo, trống Drum và bột từ.
      </p>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Nhóm vật tư tiêu hao phục vụ cả khách mua máy lẻ và các hợp đồng thuê máy, quản lý in ấn trọn gói — bao gồm thương hiệu vật tư riêng FANSIPAN.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/45-muc-nen-dung-cho-duplo.jpg" alt="Mực In &amp; Master Máy Nhân Bản DUPLO Chính Hãng" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            ...
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/vat-tu-linh-kien-tieu-hao/muc-master-duplo-chinh-hang/">Mực In &amp; Master Máy Nhân Bản DUPLO Chính Hãng</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Mực in gốc dầu đậu nành thân thiện môi trường và cuộn phim Master Duplo chính hãng, cho bản in sắc nét từng nét chữ đề thi.</p>
            <a href="/san-pham/vat-tu-linh-kien-tieu-hao/muc-master-duplo-chinh-hang/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/46-muc-may-in-duplo-dp-f550.jpg" alt="Mực Máy In Duplo DP-F550 / DP-F850 (Đen &amp; Màu)" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Duplo (Nhật Bản)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/vat-tu-linh-kien-tieu-hao/muc-may-in-duplo-dp-f550/">Mực Máy In Duplo DP-F550 / DP-F850 (Đen &amp; Màu)</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Mực in chuyên dụng cho thế hệ máy Duplo DP-F và DP-X series, độ đậm quang học cao, khô nhanh trên mọi loại giấy bãi bằng.</p>
            <a href="/san-pham/vat-tu-linh-kien-tieu-hao/muc-may-in-duplo-dp-f550/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/59-muc-toshiba-2508a-3008a-3508a-4508a-500.jpg" alt="Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Toshiba (Nhật Bản)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/vat-tu-linh-kien-tieu-hao/muc-toshiba-2508a-3008a-3508a-4508a-500/">Mực Photocopy Toshiba T-3008P / T-5008P Chính Hãng</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Mực in Toshiba chính hãng cho dòng máy e-STUDIO 2508A, 3008A, 3508A, 4508A, 2528A, 3028A: định mức 43.900 trang chuẩn.</p>
            <a href="/san-pham/vat-tu-linh-kien-tieu-hao/muc-toshiba-2508a-3008a-3508a-4508a-500/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/44-spare-drum.jpg" alt="Trống In Màu Dự Phòng Spare Drum Duplo" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Duplo (Nhật Bản)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/vat-tu-linh-kien-tieu-hao/spare-drum-duplo/">Trống In Màu Dự Phòng Spare Drum Duplo</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Trống in màu rời thay thế nhanh cho máy in nhân bản Duplo: hỗ trợ đổi màu in đỏ, xanh, vàng chỉ trong 10 giây.</p>
            <a href="/san-pham/vat-tu-linh-kien-tieu-hao/spare-drum-duplo/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/95-bang-tra-ma-muc-master-may-in-duplo.jpg" alt="Bảng Tra Mã Mực &amp; Master Máy In Duplo Đầy Đủ" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Duplo (Nhật Bản)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/vat-tu-linh-kien-tieu-hao/bang-tra-ma-muc-master-duplo/">Bảng Tra Mã Mực &amp; Master Máy In Duplo Đầy Đủ</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Cẩm nang tra cứu mã mực in và master cho tất cả các thế hệ máy in nhân bản siêu tốc Duplo từ trước đến nay.</p>
            <a href="/san-pham/vat-tu-linh-kien-tieu-hao/bang-tra-ma-muc-master-duplo/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        ...
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/ricoh-brake-roller-fi-8170.jpg" alt="Bảng Tra Mã Linh Kiện &amp; Vật Tư Tiêu Hao Máy Scan Ricoh Chính Hãng" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Ricoh (Nhật Bản)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/vat-tu-linh-kien-tieu-hao/bang-tra-ma-linh-kien-vat-tu-may-scan-ricoh/">Bảng Tra Mã Linh Kiện &amp; Vật Tư Tiêu Hao Máy Scan Ricoh Chính Hãng</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Bảng tra cứu mã vật tư tiêu hao chính hãng cho máy quét Ricoh: Lô cuộn kéo giấy, lô hãm, đệm tách giấy, mặt kính và bộ nguồn Adapter cho các dòng fi-s…</p>
            <a href="/san-pham/vat-tu-linh-kien-tieu-hao/bang-tra-ma-linh-kien-vat-tu-may-scan-ricoh/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
