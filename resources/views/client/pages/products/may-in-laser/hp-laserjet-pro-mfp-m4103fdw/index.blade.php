...
@section('canonical', url('/san-pham/may-in-laser/hp-laserjet-pro-mfp-m4103fdw/'))
@section('jsonld')
...
<head>
  ...
  <title>Máy in đa năng HP LaserJet Pro MFP M4103fdw – M4103fdw (2Z629A) | Hương Sơn</title>
  <meta name="description" content="HP LaserJet Pro MFP M4103fdw là máy in đa năng A4 cho văn phòng hiện đại, có thể mua hoặc thuê theo tháng." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-in-laser/hp-laserjet-pro-mfp-m4103fdw/" />
  <meta property="og:type" content="product" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy in đa năng HP LaserJet Pro MFP M4103fdw – M4103fdw (2Z629A) | Hương Sơn" />
  <meta property="og:description" content="HP LaserJet Pro MFP M4103fdw là máy in đa năng A4 cho văn phòng hiện đại, có thể mua hoặc thuê theo tháng." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-in-laser/hp-laserjet-pro-mfp-m4103fdw/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/products/hp-laserjet-pro-mfp-m4103fdw.jpg" alt="Máy in đa năng HP LaserJet Pro MFP M4103fdw" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy in đa năng HP LaserJet Pro MFP M4103fdw</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">HP LaserJet Pro MFP M4103fdw là máy in đa năng A4 cho văn phòng hiện đại, có thể mua hoặc thuê theo tháng.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/may-in-laser/" class="hover:text-white transition">Máy in Laser – thiết bị in văn phòng</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy in đa năng HP LaserJet Pro MFP M4103fdw</span>
      </nav>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/hp-laserjet-pro-mfp-m4103fdw.jpg" alt="Máy in đa năng HP LaserJet Pro MFP M4103fdw" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-hp-laserjet-pro-mfp-m4103fdw-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-hp-laserjet-pro-mfp-m4103fdw-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-hp-laserjet-pro-mfp-m4103fdw-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy in đa năng HP LaserJet Pro MFP M4103fdw?</h2>
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/may-in-laser/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem Máy in Laser – thiết bị in văn phòng</a>
