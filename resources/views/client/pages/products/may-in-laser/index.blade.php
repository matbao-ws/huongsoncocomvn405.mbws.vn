...
@section('title', "Máy in Laser A4 văn phòng – HP LaserJet Pro MFP | Hương Sơn")
@section('meta_description', "Máy in Laser đa chức năng A4 cho văn phòng, phòng giáo vụ và văn thư. Bán và cho thuê máy in HP LaserJet Pro MFP, có mực và dịch vụ kỹ thuật.")
@section('canonical', url('/san-pham/may-in-laser/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Máy in Laser A4 có thuê được không?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Có, kể cả ngắn hạn. Theo dữ liệu công bố, mức phí thuê tham khảo cho HP LaserJet Pro MFP 4103fdw là khoảng 550.000 đồng — mức phí thực tế phụ thuộc thời gian thuê và sản lượng, cần Hương Sơn báo giá cụ thể."
      }
    },
    {
      "@type": "Question",
      "name": "Nên chọn máy in A4 hay máy đa chức năng A3?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Máy A4 phù hợp cho phòng ban với nhu cầu in vừa phải; máy A3 đa chức năng phù hợp làm thiết bị trục chính có nhu cầu copy, in, scan khổ lớn. Xem máy photocopy đa chức năng."
      }
    }
  ]
}</script>
...
<head>
  ...
  <title>Máy in Laser A4 văn phòng – HP LaserJet Pro MFP | Hương Sơn</title>
  <meta name="description" content="Máy in Laser đa chức năng A4 cho văn phòng, phòng giáo vụ và văn thư. Bán và cho thuê máy in HP LaserJet Pro MFP, có mực và dịch vụ kỹ thuật." />
  <meta name="keywords" content="máy photocopy A4, máy photocopy in scan copy, máy photocopy có scan màu, máy photocopy có đảo mặt, máy photocopy có khay tự động, máy photocopy kết nối mạng, máy photocopy wifi, máy photocopy in hai mặt, máy photocopy scan hai mặt" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-in-laser/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy in Laser A4 văn phòng – HP LaserJet Pro MFP | Hương Sơn" />
  <meta property="og:description" content="Máy in Laser đa chức năng A4 cho văn phòng, phòng giáo vụ và văn thư. Bán và cho thuê máy in HP LaserJet Pro MFP, có mực và dịch vụ kỹ thuật." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-in-laser/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Máy in Laser – thiết bị in văn phòng" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy in Laser – thiết bị in văn phòng</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Máy in Laser đa chức năng A4 cho văn phòng, phòng giáo vụ, phòng đào tạo và văn thư — bán hoặc cho thuê theo tháng, kèm mực và dịch vụ kỹ thuật.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy in Laser – thiết bị in văn phòng</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Nhóm thiết bị in A4 phân tán theo phòng ban, bổ trợ cho máy photocopy A3 trục chính trong mô hình quản lý in ấn.</p>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/hp-laserjet-pro-mfp-m4103fdw.jpg" alt="Máy in đa năng HP LaserJet Pro MFP M4103fdw" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">HP</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/may-in-laser/hp-laserjet-pro-mfp-m4103fdw/">Máy in đa năng HP LaserJet Pro MFP M4103fdw</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">HP LaserJet Pro MFP M4103fdw là máy in đa năng A4 cho văn phòng hiện đại, có thể mua hoặc thuê theo tháng.</p>
            <a href="/san-pham/may-in-laser/hp-laserjet-pro-mfp-m4103fdw/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Máy in Laser A4 có thuê được không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có, kể cả ngắn hạn. Theo dữ liệu công bố, mức phí thuê tham khảo cho HP LaserJet Pro MFP 4103fdw là khoảng 550.000 đồng — mức phí thực tế phụ thuộc thời gian thuê và sản lượng, cần Hương Sơn báo giá cụ thể.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Nên chọn máy in A4 hay máy đa chức năng A3?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Máy A4 phù hợp cho phòng ban với nhu cầu in vừa phải; máy A3 đa chức năng phù hợp làm thiết bị trục chính có nhu cầu copy, in, scan khổ lớn. Xem <a class="text-[#1A9900] font-medium hover:underline" href="/san-pham/photocopy-may-da-chuc-nang/">máy photocopy đa chức năng</a>.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="cat-may-in-laser-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-cat-may-in-laser-hp">Bỏ trống ô này</label>
            <input type="text" id="f-cat-may-in-laser-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
