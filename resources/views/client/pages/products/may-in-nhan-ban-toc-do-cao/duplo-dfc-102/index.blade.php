...
@section('meta_description', "Hệ thống phối trang tài liệu tự động 10 khay, cảm biến phát hiện kẹt giấy và nạp đúp bằng quang học siêu nhạy. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "28 mm (khoảng 300 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Hệ thống phát hiện lỗi",
        "value": "Cảm biến nạp đôi, kẹt giấy, hết giấy tự động dừng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Hệ thống phối trang tài liệu tự động 10 khay, cảm biến phát hiện kẹt giấy và nạp đúp bằng quang học siêu nhạy.</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">10 khay</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ phối trang</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 4.200 bộ/giờ (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">A5 đến A3</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Sức chứa mỗi khay</th>
              <td class="py-3 text-[14.5px] text-gray-600">28 mm (khoảng 300 tờ)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Hệ thống phát hiện lỗi</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm biến nạp đôi, kẹt giấy, hết giấy tự động dừng</td>
            </tr>
          </tbody>
        </table>
      </div>
