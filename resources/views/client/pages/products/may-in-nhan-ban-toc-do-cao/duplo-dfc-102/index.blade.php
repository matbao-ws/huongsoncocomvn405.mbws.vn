...
@section('title', "Máy Phối Trang 10 Khay Duplo DFC-102 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Hệ thống phối trang tài liệu tự động 10 khay, cảm biến phát hiện kẹt giấy và nạp đúp bằng quang học siêu nhạy. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dfc-102/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dfc-102/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dfc-102/#product",
    "name": "Máy Phối Trang 10 Khay Duplo DFC-102",
    "image": "https://huongsonco.com.vn/assets/images/products/41-may-phoi-trang-duplo-dfc-100.jpg",
    "model": "DFC-102",
    "sku": "DUPLO-DFC-102",
    "category": "Máy phối trang tài liệu",
    "description": "Hệ thống phối trang tài liệu tự động 10 khay, cảm biến phát hiện kẹt giấy và nạp đúp bằng quang học siêu nhạy.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Số khay nạp giấy",
        "value": "10 khay nạp độc lập"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ phối trang",
        "value": "Lên đến 4.200 bộ/giờ (A4) / khoảng 70 bộ/phút"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy xử lý",
        "value": "Tối đa 320 x 450 mm (khổ SRA3), tối thiểu 140 x 160 mm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy hỗ trợ",
        "value": "50 – 200 g/m²"
      },
      {
        "@@type": "PropertyValue",
        "name": "Sức chứa mỗi khay",
        "value": "Chiều cao xấp giấy 28 mm (khoảng 350 tờ giấy 64 g/m²)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Cảm biến phát hiện lỗi",
        "value": "Cảm biến quang học kép phát hiện nạp đúp giấy, sót giấy, kẹt giấy, hết giấy từng khay"
      },
      {
        "@@type": "PropertyValue",
        "name": "Chế độ xếp giấy ra",
        "value": "Xếp so le (Criss-cross) hoặc xếp chồng thẳng (Straight stack)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khả năng ghép tầng",
        "value": "Kết nối đồng bộ 2 tháp tạo hệ thống phối trang 20 khay liên hoàn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối sau in",
        "value": "Tích hợp đồng bộ trực tiếp với bộ dập ghim gấp sách Duplo DFC-S II"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảng điều khiển",
        "value": "Màn hình LED kỹ thuật số phím bấm cảm ứng dễ thao tác"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "575 x 590 x 1.040 mm | Trọng lượng: 65 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ & Tiêu chuẩn",
        "value": "Chính hãng Duplo (Nhật Bản)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo hành & Hỗ trợ",
        "value": "12 tháng chính hãng, chuyển giao kỹ thuật tận nơi"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Nhập khẩu chính hãng, đầy đủ CO/CQ."
      }
    ],
    "audience": [
      {
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy Phối Trang 10 Khay Duplo DFC-102
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Hệ thống phối trang tài liệu tự động 10 khay, cảm biến phát hiện kẹt giấy và nạp đúp bằng quang học siêu nhạy.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy Phối Trang 10 Khay Duplo DFC-102" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DFC-102</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Hội đồng in sao đề thi, Nhà in tài liệu, Trường học</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/41-may-phoi-trang-duplo-dfc-100.jpg" alt="Máy Phối Trang 10 Khay Duplo DFC-102" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy Phối Trang 10 Khay Duplo DFC-102</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DFC-102</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Máy phối trang tài liệu</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Phối bộ tài liệu đề thi tốt nghiệp, đề kiểm tra nhiều trang cho các Sở GD&amp;ĐT và Hội đồng thi</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Sắp xếp kỷ yếu, giáo trình, tập bài giảng cho trường học và viện nghiên cứu</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tự động gom bộ tài liệu hội nghị, báo cáo tài chính thường niên cho cơ quan và ngân hàng</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DFC-102</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Số khay nạp giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">10 khay nạp độc lập</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ phối trang</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 4.200 bộ/giờ (A4) / khoảng 70 bộ/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy xử lý</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tối đa 320 x 450 mm (khổ SRA3), tối thiểu 140 x 160 mm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">50 – 200 g/m²</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Sức chứa mỗi khay</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chiều cao xấp giấy 28 mm (khoảng 350 tờ giấy 64 g/m²)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Cảm biến phát hiện lỗi</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm biến quang học kép phát hiện nạp đúp giấy, sót giấy, kẹt giấy, hết giấy từng khay</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chế độ xếp giấy ra</th>
              <td class="py-3 text-[14.5px] text-gray-600">Xếp so le (Criss-cross) hoặc xếp chồng thẳng (Straight stack)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khả năng ghép tầng</th>
              <td class="py-3 text-[14.5px] text-gray-600">Kết nối đồng bộ 2 tháp tạo hệ thống phối trang 20 khay liên hoàn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối sau in</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tích hợp đồng bộ trực tiếp với bộ dập ghim gấp sách Duplo DFC-S II</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảng điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Màn hình LED kỹ thuật số phím bấm cảm ứng dễ thao tác</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">575 x 590 x 1.040 mm | Trọng lượng: 65 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Xuất xứ &amp; Tiêu chuẩn</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chính hãng Duplo (Nhật Bản)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảo hành &amp; Hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">12 tháng chính hãng, chuyển giao kỹ thuật tận nơi</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Nhập khẩu chính hãng, đầy đủ CO/CQ.</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dfc-102-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DFC-102" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dfc-102-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dfc-102-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy Phối Trang 10 Khay Duplo DFC-102?</h2>
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem Máy in nhân bản tốc độ cao &amp; Thiết bị hoàn thiện sau in Duplo</a>
