...
@section('title', "Máy In Siêu Tốc Ricoh Priport DX 4450 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Ricoh Priport DX 4450 khổ A3 cao cấp, tốc độ 130 bản/phút, kết nối mạng LAN in trực tiếp từ máy tính. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-4450/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-4450/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-4450/#product",
    "name": "Máy In Siêu Tốc Ricoh Priport DX 4450",
    "image": "https://huongsonco.com.vn/assets/images/products/56-ricoh-dx4450.png",
    "model": "Priport DX 4450",
    "sku": "RICOH-DX4450",
    "category": "Máy in siêu tốc kỹ thuật số",
    "description": "Ricoh Priport DX 4450 khổ A3 cao cấp, tốc độ 130 bản/phút, kết nối mạng LAN in trực tiếp từ máy tính.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in",
        "value": "80 – 100 – 130 bản/phút (3 mức điều chỉnh)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "400 x 400 dpi chất lượng cao"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ bản gốc tối đa",
        "value": "297 x 432 mm (Mặt kính phẳng A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy in hỗ trợ",
        "value": "A3, B4, A4, B5, A5 (Tối đa 297 x 432 mm)"
      },
      {
        "@@type": "PropertyValue",
      ...
      {
        "@@type": "PropertyValue",
        "name": "Thời gian tạo Master",
        "value": "Khoảng 24 giây (A4) / 33 giây (A3)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "50% – 200% (bước nhảy 1%)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng cuộn Master",
        "value": "Khoảng 200 bản Master khổ A3 / cuộn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng hộp mực",
        "value": "Mực Ricoh Priport Black 1.000 ml"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối & Giao tiếp",
        "value": "USB 2.0 High-Speed, Card mạng Ethernet LAN"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.370 x 705 x 1.040 mm | Trọng lượng: 87 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
        "value": "Ricoh (Nhật Bản)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo hành",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Siêu Tốc Ricoh Priport DX 4450
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Ricoh Priport DX 4450 khổ A3 cao cấp, tốc độ 130 bản/phút, kết nối mạng LAN in trực tiếp từ máy tính.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Siêu Tốc Ricoh Priport DX 4450" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Priport DX 4450</strong> — sản xuất bởi Ricoh (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Sở GD&amp;ĐT, Trường Đại học, Ủy ban Nhân dân</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/56-ricoh-dx4450.png" alt="Máy In Siêu Tốc Ricoh Priport DX 4450" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Siêu Tốc Ricoh Priport DX 4450</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Priport DX 4450</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Máy in siêu tốc kỹ thuật số</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In sao đề thi tuyển sinh, đề thi tốt nghiệp khổ A3 gập đôi cho các Hội đồng thi</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In bản tin, báo cáo kế hoạch và văn bản chỉ đạo khổ lớn cho cơ quan Nhà nước</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In tài liệu học tập khổ lớn, bảng biểu thống kê cho trường đại học và bệnh viện</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Priport DX 4450</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">80 – 100 – 130 bản/phút (3 mức điều chỉnh)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">400 x 400 dpi chất lượng cao</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ bản gốc tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">297 x 432 mm (Mặt kính phẳng A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy in hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">A3, B4, A4, B5, A5 (Tối đa 297 x 432 mm)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy in</th>
              <td class="py-3 text-[14.5px] text-gray-600">47 – 209 g/m²</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Thời gian tạo Master</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 24 giây (A4) / 33 giây (A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Sức chứa khay nạp giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.000 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-ricoh-priport-dx-4450-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Priport DX 4450" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-ricoh-priport-dx-4450-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-ricoh-priport-dx-4450-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Siêu Tốc Ricoh Priport DX 4450?</h2>
