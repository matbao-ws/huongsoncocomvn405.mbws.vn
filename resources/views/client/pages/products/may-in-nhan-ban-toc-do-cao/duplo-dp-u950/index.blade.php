...
@section('title', "Máy In Siêu Tốc Duplo DP-U950 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Duplo DP-U950 khổ A3 công nghiệp, trống in trợ lực kép, xử lý hoàn hảo từ giấy mỏng 45g đến bìa dày 210g. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-u950/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-u950/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-u950/#product",
    "name": "Máy In Siêu Tốc Duplo DP-U950",
    "image": "https://huongsonco.com.vn/assets/images/products/24-dp-u950.jpg",
    "model": "DP-U950",
    "sku": "DUPLO-DP-U950",
    "category": "Máy in nhân bản siêu tốc",
    "description": "Duplo DP-U950 khổ A3 công nghiệp, trống in trợ lực kép, xử lý hoàn hảo từ giấy mỏng 45g đến bìa dày 210g.",
    ...
    "additionalProperty": [
      {
        ...
        "value": "60 – 150 trang/phút (điều chỉnh 3 cấp độ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
      ...
      {
        "@@type": "PropertyValue",
        "name": "Khay nạp và nhận giấy",
        "value": "Sức chứa 1.500 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ chế bản",
        "value": "Chế bản nhiệt kỹ thuật số"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình hiển thị",
        "value": "Màn hình LCD cảm ứng đồ họa thông minh"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
        "value": "USB 2.0, Card mạng LAN"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ & Bảo hành",
        "value": "Duplo Nhật Bản, bảo hành 12 - 24 tháng chính hãng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Siêu Tốc Duplo DP-U950
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Duplo DP-U950 khổ A3 công nghiệp, trống in trợ lực kép, xử lý hoàn hảo từ giấy mỏng 45g đến bìa dày 210g.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Siêu Tốc Duplo DP-U950" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DP-U950</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Sở GD&amp;ĐT, Trường Đại học, Xưởng in tư nhân</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/24-dp-u950.jpg" alt="Máy In Siêu Tốc Duplo DP-U950" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Siêu Tốc Duplo DP-U950</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DP-U950</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Duplo DP-U950 khổ A3 công nghiệp, trống in trợ lực kép, xử lý hoàn hảo từ giấy mỏng 45g đến bìa dày 210g.</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay nạp và nhận giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Sức chứa 1.500 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ chế bản</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chế bản nhiệt kỹ thuật số</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình hiển thị</th>
              <td class="py-3 text-[14.5px] text-gray-600">Màn hình LCD cảm ứng đồ họa thông minh</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối</th>
              <td class="py-3 text-[14.5px] text-gray-600">USB 2.0, Card mạng LAN</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Xuất xứ &amp; Bảo hành</th>
              <td class="py-3 text-[14.5px] text-gray-600">Duplo Nhật Bản, bảo hành 12 - 24 tháng chính hãng</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dp-u950-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DP-U950" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dp-u950-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dp-u950-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Siêu Tốc Duplo DP-U950?</h2>
