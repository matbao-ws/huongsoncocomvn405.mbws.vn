...
@section('meta_description', "Duplo DP-U950 khổ A3 công nghiệp, trống in trợ lực kép, xử lý hoàn hảo từ giấy mỏng 45g đến bìa dày 210g. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">150 trang/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">45 - 210 g/m2</td>
            </tr>
          </tbody>
        </table>
      </div>
