...
@section('title', "Máy in nhân bản tốc độ cao Duplo – DP-X550, DP-X650 | Hương Sơn")
@section('meta_description', "Máy in nhân bản siêu tốc Duplo tốc độ đến 200 bản/phút, dùng cho in đề thi, giáo trình, biểu mẫu số lượng lớn. Hương Sơn là đại lý ủy quyền phân phối Duplo tại miền Bắc.")
...
<head>
  ...
  <title>Máy in nhân bản tốc độ cao Duplo – DP-X550, DP-X650 | Hương Sơn</title>
  <meta name="description" content="Máy in nhân bản siêu tốc Duplo tốc độ đến 200 bản/phút, dùng cho in đề thi, giáo trình, biểu mẫu số lượng lớn. Hương Sơn là đại lý ủy quyền phân phối Duplo tại miền Bắc." />
  <meta name="keywords" content="máy in nhân bản siêu tốc, máy in nhân bản Duplo, máy in Duplo, máy in siêu tốc Ricoh, máy in siêu tốc Duplo, Duplo DP-X550, Duplo DP-X650, Duplo DP-X850, Duplo DP-U950, máy in đề thi, máy in đề thi siêu tốc, thuê máy in đề thi, cho thuê máy in đề thi" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy in nhân bản tốc độ cao Duplo – DP-X550, DP-X650 | Hương Sơn" />
  <meta property="og:description" content="Máy in nhân bản siêu tốc Duplo tốc độ đến 200 bản/phút, dùng cho in đề thi, giáo trình, biểu mẫu số lượng lớn. Hương Sơn là đại lý ủy quyền phân phối Duplo tại miền Bắc." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Máy in nhân bản tốc độ cao Duplo" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy in nhân bản tốc độ cao Duplo</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Máy in nhân bản siêu tốc Duplo — tốc độ đến 200 bản/phút, dùng để nhân bản một văn bản gốc ra số lượng lớn trong thời gian ngắn: in đề thi, giáo trình, biểu mẫu. Hương Sơn là đại lý ủy quyền phân phối chính thức Duplo (Nhật Bản) tại miền Bắc Việt Nam từ năm 2017.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy in nhân bản tốc độ cao Duplo</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Máy in nhân bản siêu tốc Duplo cho nhu cầu sản lượng lớn dồn vào thời gian ngắn — khách hàng thường xuyên gồm Sở Giáo dục, ngân hàng, trung tâm y tế, bệnh viện, trường đại học và văn phòng các Bộ.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Vật tư đi kèm (Master, mực) cũng nhập khẩu từ Nhật Bản.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đã cung cấp thiết bị phục vụ in đề thi THPT Quốc gia cho các Sở GD&ĐT nhiều tỉnh.</span>
        </li>
