  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Nhập khẩu mới 100% từ Duplo Nhật Bản. Hương Sơn là đại lý ủy quyền phân phối chính thức Duplo tại miền Bắc từ năm 2017."
      }
    ],
    "audience": [
      {
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Nhập khẩu mới 100% từ Duplo Nhật Bản. Hương Sơn là đại lý ủy quyền phân phối chính thức Duplo tại miền Bắc từ năm 2017.</td></tr>
