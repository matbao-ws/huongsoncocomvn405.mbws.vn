...
@section('canonical', url('/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x550/'))
@section('jsonld')
...
<head>
  ...
  <title>Máy nhân bản siêu tốc Duplo DP-X550 – DP-X550 | Hương Sơn</title>
  <meta name="description" content="Duplo DP-X550 đạt tốc độ đến 155 bản/phút với độ phân giải cao, tạo độ sắc nét cho khu vực hình ảnh khổ A3 — phù hợp cho nhu cầu nhân bản một văn bản gốc r" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x550/" />
  <meta property="og:type" content="product" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy nhân bản siêu tốc Duplo DP-X550 – DP-X550 | Hương Sơn" />
  <meta property="og:description" content="Duplo DP-X550 đạt tốc độ đến 155 bản/phút với độ phân giải cao, tạo độ sắc nét cho khu vực hình ảnh khổ A3 — phù hợp cho nhu cầu nhân bản một văn bản gốc r" />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x550/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <nav class="hidden xl:flex items-center space-x-6" aria-label="Điều hướng chính">
        <div class="relative has-dropdown group py-2">
          <a href="/san-pham/" class="nav-link text-[#1A9900] font-medium text-sm flex items-center space-x-1 group-hover:text-[#1A9900] transition">
            <span>SẢN PHẨM</span>
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X550" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Production Print</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy nhân bản siêu tốc Duplo DP-X550</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Duplo DP-X550 đạt tốc độ đến 155 bản/phút với độ phân giải cao, tạo độ sắc nét cho khu vực hình ảnh khổ A3 — phù hợp cho nhu cầu nhân bản một văn bản gốc ra số lượng lớn trong thời gian ngắn như in đề thi, giáo trình, biểu mẫu.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-white transition">Máy in nhân bản tốc độ cao Duplo</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy nhân bản siêu tốc Duplo DP-X550</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DP-X550</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Giáo dục, Ngân hàng, Y tế, Cơ quan Nhà nước</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Duplo DP-X520, Duplo DP-X650</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X550" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy nhân bản siêu tốc Duplo DP-X550</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DP-X550</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Máy in nhân bản tốc độ cao</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In sao đề thi tốt nghiệp THPT và các kỳ thi tuyển sinh cho Sở GD&amp;ĐT</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In giáo trình, tài liệu học tập số lượng lớn cho trường học</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In biểu mẫu, phiếu khám bệnh số lượng lớn cho bệnh viện, trung tâm y tế</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In văn bản hành chính số lượng lớn cho UBND, văn phòng các Bộ</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DP-X550</caption>
          <tbody class="px-5">
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Nhập khẩu mới 100% từ Duplo Nhật Bản, có đầy đủ chứng nhận xuất xứ (CO) và chứng nhận chất lượng (CQ). Hương Sơn là đại lý ủy quyền phân phối chính thức Duplo tại miền Bắc Việt Nam từ năm 2017.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Bảo hành</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Bảo hành đúng tiêu chuẩn nhà sản xuất, hoàn toàn miễn phí tại địa điểm lắp đặt của khách hàng; bảo trì, bảo dưỡng định kỳ miễn phí trong thời gian bảo hành.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Duplo DP-X520, Duplo DP-X650</td></tr>
          </tbody>
        </table>
      </div><div class="mt-6"><a href="https://www.duplo.com/eng/products/duplicators/dpx550.html" target="_blank" rel="noopener" class="inline-flex items-center space-x-2 border border-gray-300 hover:border-[#1A9900] hover:text-[#1A9900] px-5 py-3 text-[14px] font-bold transition mr-3 mb-3"><i class="fa-solid fa-file-arrow-down"></i><span>Trang sản phẩm chính hãng Duplo DP-X550</span></a></div>
    </div>
  </section>

  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><h2 class="text-2xl sm:text-[32px] font-bold text-[#181923] mb-6">So sánh với model liên quan</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] max-w-4xl">So với DP-X650 (thế hệ mới hơn, tốc độ đến 200 bản/phút), DP-X550 phù hợp với đơn vị đã quen thuộc dòng máy hiện tại hoặc có ngân sách vừa phải hơn.</p>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">DP-X550 phù hợp với đơn vị có quy mô in như thế nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Phù hợp với đơn vị có nhu cầu in sản lượng lớn dồn vào thời gian ngắn — điển hình là Sở GD&ĐT trong mùa thi, ngân hàng, bệnh viện và cơ quan hành chính có khối lượng văn bản lớn.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có thể thuê DP-X550 theo đợt không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có. Đây là mô hình phổ biến cho các kỳ thi — xem <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/in-de-thi/">giải pháp cho thuê máy in đề thi</a>.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Vật tư cho DP-X550 có sẵn không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có, Master và mực nhập khẩu chính hãng từ Nhật Bản, cung cấp kèm theo khi thuê hoặc mua máy.</div>
        </details>
      </div>
        </div>
        <div class="lg:col-span-5">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dp-x550-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DP-X550" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dp-x550-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dp-x550-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem Máy in nhân bản tốc độ cao Duplo</a>
