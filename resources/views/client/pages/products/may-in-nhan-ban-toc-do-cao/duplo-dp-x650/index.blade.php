...
@section('title', "Máy nhân bản siêu tốc Duplo DP-X650 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Duplo DP-X650 dòng máy in nhân bản siêu tốc A3 cao cấp nhất của Duplo — trang bị đầu ghi Master HD tiên tiến, tái hiện hoàn hảo chữ nhỏ và biểu... Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy nhân bản siêu tốc Duplo DP-X650
          </h1>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X650" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
