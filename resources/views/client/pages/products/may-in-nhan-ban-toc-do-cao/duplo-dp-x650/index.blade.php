...
@section('canonical', url('/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x650/'))
@section('jsonld')
...
<head>
  ...
  <title>Máy nhân bản siêu tốc Duplo DP-X650 – DP-X650 | Hương Sơn</title>
  <meta name="description" content="DP-X650 là thế hệ máy in nhân bản siêu tốc mới của Duplo, tốc độ đến 200 bản/phút, do Hương Sơn phân phối tại thị trường Việt Nam." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x650/" />
  <meta property="og:type" content="product" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy nhân bản siêu tốc Duplo DP-X650 – DP-X650 | Hương Sơn" />
  <meta property="og:description" content="DP-X650 là thế hệ máy in nhân bản siêu tốc mới của Duplo, tốc độ đến 200 bản/phút, do Hương Sơn phân phối tại thị trường Việt Nam." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x650/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/products/duplo-dp-x650.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X650" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy nhân bản siêu tốc Duplo DP-X650</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">DP-X650 là thế hệ máy in nhân bản siêu tốc mới của Duplo, tốc độ đến 200 bản/phút, do Hương Sơn phân phối tại thị trường Việt Nam.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-white transition">Máy in nhân bản tốc độ cao Duplo</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy nhân bản siêu tốc Duplo DP-X650</span>
      </nav>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/duplo-dp-x650.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X650" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy nhân bản siêu tốc Duplo DP-X650</dd></div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy nhân bản siêu tốc Duplo DP-X650?</h2>
