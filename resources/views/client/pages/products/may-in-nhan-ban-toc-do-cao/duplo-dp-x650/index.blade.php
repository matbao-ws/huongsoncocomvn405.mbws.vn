...
@section('title', "Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD) Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Duplo DP-X650 dòng máy in nhân bản siêu tốc A3 cao cấp nhất của Duplo — trang bị đầu ghi Master HD tiên tiến, tái hiện hoàn hảo chữ... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
...
[
  ...
  },
  {
    ...
    "name": "Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD)",
    "image": "https://huongsonco.com.vn/assets/images/products/duplo-dp-x650.jpg",
    "model": "DP-X650",
    "sku": "DUPLO-DPX650",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in",
        "value": "Lên đến 160 bản/phút (3 mức điều chỉnh: 60, 100, 160 bản/phút)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "600 x 600 dpi HD (Đầu ghi nhiệt độ nét cao High-Definition Master Maker)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ bản gốc tối đa",
        "value": "Mặt kính phẳng: A3 (297 x 432 mm)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "45 g/m² – 210 g/m² (Hỗ trợ giấy mỏng đề thi, giấy tái chế, giấy bìa)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ chế bản",
        "value": "Chế bản nhiệt kỹ thuật số HD thế hệ mới (Thermal Digital Master Maker HD)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Thời gian tạo bản Master",
        "value": "Khoảng 18 giây (khổ A4) / 20 giây (khổ A3)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "1.500 tờ (định lượng 64 g/m²)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "50% – 200% (bước nhảy 1%), 7 mức cài đặt sẵn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Chế độ xử lý hình ảnh",
        "value": "Chữ (Text), Ảnh (Photo), Chữ/Ảnh HD sắc nét cao, Bút chì (Pencil)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình bảng điều khiển",
        "value": "Cảm ứng màu LCD lớn thông minh thế hệ mới"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng cuộn Master",
        "value": "Cuộn Master DR-X65 HD (khoảng 220 bản A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng hộp mực",
        "value": "Hộp mực Duplo HD Black 1.000 ml"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối & Giao tiếp",
        "value": "USB 2.0 High Speed, Network LAN Card 10/100/1000 Base-T"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.405 x 688 x 1.080 mm | Trọng lượng: 104 kg"
      },
      {
        "@@type": "PropertyValue",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD)
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Duplo DP-X650 dòng máy in nhân bản siêu tốc A3 cao cấp nhất của Duplo — trang bị đầu ghi Master HD tiên tiến, tái hiện hoàn hảo chữ nhỏ và biểu đồ trong các đề thi quan trọng.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD)" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DP-X650</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/duplo-dp-x650.jpg" alt="Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD)" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DP-X650</dd></div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DP-X650</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 160 bản/phút (3 mức điều chỉnh: 60, 100, 160 bản/phút)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">600 x 600 dpi HD (Đầu ghi nhiệt độ nét cao High-Definition Master Maker)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ bản gốc tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mặt kính phẳng: A3 (297 x 432 mm)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">45 g/m² – 210 g/m² (Hỗ trợ giấy mỏng đề thi, giấy tái chế, giấy bìa)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ chế bản</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chế bản nhiệt kỹ thuật số HD thế hệ mới (Thermal Digital Master Maker HD)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Thời gian tạo bản Master</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 18 giây (khổ A4) / 20 giây (khổ A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">1.500 tờ (định lượng 64 g/m²)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dp-x650-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DP-X650" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dp-x650-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dp-x650-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy nhân bản siêu tốc Duplo DP-X650 (A3 HD)?</h2>
