...
@section('title', "Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Công nghệ in phun mực lạnh tốc độ cao Duplo DIJ-200: không nhiệt, không kẹt giấy, khô mực tức thì, tiết kiệm điện 80%. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dij-200/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dij-200/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dij-200/#product",
    "name": "Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200",
    "image": "https://huongsonco.com.vn/assets/images/products/34-dij-200.jpg",
    "model": "DIJ-200",
    "sku": "DUPLO-DIJ-200",
    "category": "Máy in phun tốc độ cao",
    "description": "Công nghệ in phun mực lạnh tốc độ cao Duplo DIJ-200: không nhiệt, không kẹt giấy, khô mực tức thì, tiết kiệm điện 80%.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in",
        "value": "200 trang/phút (A4 đơn sắc / đủ màu)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải in",
        "value": "600 x 1.200 dpi siêu mịn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ in",
        "value": "Đầu in phun màng nước áp điện công nghiệp Linehead Inkjet"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy in tối đa",
        "value": "320 x 432 mm (hỗ trợ A3 tràn lề)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy in",
        "value": "46 – 210 g/m² (giấy thường, giấy bãi bằng, ford, giấy tái chế)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay nạp giấy",
        "value": "Sức chứa 1.000 tờ (định lượng 64 g/m²)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay nhận giấy",
        "value": "Sức chứa 1.000 tờ có hệ thống chống tĩnh điện"
      },
      {
        "@@type": "PropertyValue",
        "name": "Loại mực in",
        "value": "Mực dầu sinh thái pigment khô nhanh, kháng nước, không nhòe khi gặp ẩm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Hộp mực màu",
        "value": "4 hộp màu độc lập CMYK dung tích 1.000 ml / bình"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình bảng điều khiển",
        "value": "Màn hình cảm ứng màu LCD 8.5 inch trực quan"
      },
      {
        "@@type": "PropertyValue",
        "name": "Giao tiếp & Kết nối",
        "value": "Gigabit Ethernet 1000Base-T, USB 2.0 High-Speed"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tính năng bảo mật",
        "value": "Khóa mã PIN người dùng, chế độ in bảo mật đề thi"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.250 x 680 x 1.020 mm | Trọng lượng: 115 kg"
      },
      {
        "@@type": "PropertyValue",
    ...
    "audience": [
      ...
      {
        "@@type": "Audience",
        "audienceType": "Văn phòng số"
      },
      {
        "@@type": "Audience",
        "audienceType": "Trung tâm bưu chính"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Công nghệ in phun mực lạnh tốc độ cao Duplo DIJ-200: không nhiệt, không kẹt giấy, khô mực tức thì, tiết kiệm điện 80%.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DIJ-200</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Ngân hàng, Văn phòng số, Trung tâm bưu chính</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/34-dij-200.jpg" alt="Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DIJ-200</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Máy in phun tốc độ cao</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In tài liệu biểu mẫu, đề cương, giáo trình in màu số lượng lớn cho trường đại học và trường phổ thông</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In báo cáo tài chính, tài liệu hội nghị cổ đông, biểu đồ phân tích cần màu sắc trực quan</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In hướng dẫn sử dụng, bản tin nội bộ và tài liệu đào tạo cho doanh nghiệp quy mô lớn</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DIJ-200</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">200 trang/phút (A4 đơn sắc / đủ màu)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải in</th>
              <td class="py-3 text-[14.5px] text-gray-600">600 x 1.200 dpi siêu mịn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">Đầu in phun màng nước áp điện công nghiệp Linehead Inkjet</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy in tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">320 x 432 mm (hỗ trợ A3 tràn lề)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy in</th>
              <td class="py-3 text-[14.5px] text-gray-600">46 – 210 g/m² (giấy thường, giấy bãi bằng, ford, giấy tái chế)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay nạp giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Sức chứa 1.000 tờ (định lượng 64 g/m²)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay nhận giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Sức chứa 1.000 tờ có hệ thống chống tĩnh điện</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Loại mực in</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực dầu sinh thái pigment khô nhanh, kháng nước, không nhòe khi gặp ẩm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Hộp mực màu</th>
              <td class="py-3 text-[14.5px] text-gray-600">4 hộp màu độc lập CMYK dung tích 1.000 ml / bình</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình bảng điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Màn hình cảm ứng màu LCD 8.5 inch trực quan</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Giao tiếp &amp; Kết nối</th>
              <td class="py-3 text-[14.5px] text-gray-600">Gigabit Ethernet 1000Base-T, USB 2.0 High-Speed</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tính năng bảo mật</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khóa mã PIN người dùng, chế độ in bảo mật đề thi</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.250 x 680 x 1.020 mm | Trọng lượng: 115 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dij-200-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DIJ-200" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dij-200-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dij-200-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Phun Kỹ Thuật Số Siêu Tốc Duplo DIJ-200?</h2>
