...
@section('meta_description', "Công nghệ in phun mực lạnh tốc độ cao Duplo DIJ-200: không nhiệt, không kẹt giấy, khô mực tức thì, tiết kiệm điện 80%. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ in",
        "value": "In phun mực nguội tốc độ cao (Cold Inkjet)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tiêu thụ điện năng",
        "value": "Thấp hơn 80% so với in laser"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Công nghệ in phun mực lạnh tốc độ cao Duplo DIJ-200: không nhiệt, không kẹt giấy, khô mực tức thì, tiết kiệm điện 80%.</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">200 trang/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">A4 / Letter</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">In phun mực nguội tốc độ cao (Cold Inkjet)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tiêu thụ điện năng</th>
              <td class="py-3 text-[14.5px] text-gray-600">Thấp hơn 80% so với in laser</td>
            </tr>
          </tbody>
        </table>
      </div>
