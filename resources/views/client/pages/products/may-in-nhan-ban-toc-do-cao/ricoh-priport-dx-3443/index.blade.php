...
@section('title', "Máy In Siêu Tốc Ricoh Priport DX 3443 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Ricoh Priport DX 3443 khổ B4 tốc độ 130 bản/phút, chế bản kỹ thuật số siêu nhanh chỉ trong 28 giây. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-3443/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-3443/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-3443/#product",
    "name": "Máy In Siêu Tốc Ricoh Priport DX 3443",
    "image": "https://huongsonco.com.vn/assets/images/products/57-ricoh-dx3443.jpg",
    "model": "Priport DX 3443",
    "sku": "RICOH-DX3443",
    "category": "Máy in siêu tốc kỹ thuật số",
    "description": "Ricoh Priport DX 3443 khổ B4 tốc độ 130 bản/phút, chế bản kỹ thuật số siêu nhanh chỉ trong 28 giây.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in",
        "value": "80 – 100 – 130 bản/phút (3 mức tốc độ tùy chọn)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
      ...
      },
      {
        ...
        "value": "297 x 432 mm (Mặt kính A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ in tối đa",
        "value": "250 x 355 mm (Khổ B4)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "1.000 tờ (định lượng 80 g/m²)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Khoảng 260 bản Master / cuộn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng hộp mực",
        "value": "Mực Ricoh Priport 600 ml / chai"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
        "value": "USB 2.0, Cổng mạng LAN 10/100Base-TX"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.244 x 681 x 670 mm | Trọng lượng: 69 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Siêu Tốc Ricoh Priport DX 3443
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Ricoh Priport DX 3443 khổ B4 tốc độ 130 bản/phút, chế bản kỹ thuật số siêu nhanh chỉ trong 28 giây.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Siêu Tốc Ricoh Priport DX 3443" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Priport DX 3443</strong> — sản xuất bởi Ricoh (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường THPT, Trường THCS, Phòng Giáo vụ</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/57-ricoh-dx3443.jpg" alt="Máy In Siêu Tốc Ricoh Priport DX 3443" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Siêu Tốc Ricoh Priport DX 3443</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Priport DX 3443</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In đề kiểm tra một tiết, đề thi học kỳ cho các trường trung học phổ thông</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In tài liệu giảng dạy, phiếu bài tập thực hành số lượng lớn</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In biểu mẫu thống kê, phiếu điều tra dân số tại các cơ quan ban ngành</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Priport DX 3443</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">80 – 100 – 130 bản/phút (3 mức tốc độ tùy chọn)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">300 x 400 dpi</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ bản gốc tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">297 x 432 mm (Mặt kính A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ in tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">250 x 355 mm (Khổ B4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 32 giây</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Sức chứa khay nạp giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.000 tờ (định lượng 80 g/m²)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-ricoh-priport-dx-3443-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Priport DX 3443" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-ricoh-priport-dx-3443-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-ricoh-priport-dx-3443-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Siêu Tốc Ricoh Priport DX 3443?</h2>
