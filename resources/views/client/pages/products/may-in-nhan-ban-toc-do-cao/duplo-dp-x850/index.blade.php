...
@section('title', "Máy In Nhân Bản Siêu Tốc DUPLO DP-X850 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Dòng máy in nhân bản khổ A3 đỉnh cao nhất của Duplo, tốc độ lên đến 200 bản/phút, độ nét 600x600 dpi chân thực. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x850/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x850/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-x850/#product",
    "name": "Máy In Nhân Bản Siêu Tốc DUPLO DP-X850",
    "image": "https://huongsonco.com.vn/assets/images/products/30-duplo-dp-x850.png",
    "model": "DP-X850",
    "sku": "DUPLO-DP-X850",
    "category": "Máy in nhân bản siêu tốc",
    "description": "Dòng máy in nhân bản khổ A3 đỉnh cao nhất của Duplo, tốc độ lên đến 200 bản/phút, độ nét 600x600 dpi chân thực.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in tối đa",
        "value": "200 trang/phút (Tốc độ in cao nhất phân khúc toàn cầu)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "600 x 600 dpi HD Master Maker"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ bản gốc tối đa",
        "value": "Mặt kính A3 phẳng (297 x 432 mm) + Tùy chọn khay nạp tự động ADF 100 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy in hỗ trợ",
        "value": "Tối đa 297 x 432 mm (A3), Tối thiểu 100 x 148 mm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy in",
        "value": "45 g/m² – 250 g/m² (Hỗ trợ từ giấy mỏng đề thi đến bìa dày, thiệp mời)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ chế bản",
        "value": "Chế bản nhiệt kỹ thuật số công suất công nghiệp (Industrial Thermal Master Maker)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Thời gian tạo bản Master",
        "value": "Khoảng 18 giây (khổ A4) / 19 giây (khổ A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Thời gian in bản đầu tiên",
        "value": "Khoảng 21 giây (khổ A4)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "50% – 200% (bước nhảy 1%), 7 mức cài sẵn tiêu chuẩn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình bảng điều khiển",
        "value": "Cảm ứng LCD màu lớn thông minh, hiển thị tiến độ và định mức vật tư"
      },
      {
        "@@type": "PropertyValue",
        "name": "Chế độ in màu rời",
        "value": "Hỗ trợ đổi hộp trống màu (Spare Color Drum) đỏ, xanh, vàng chỉ trong 10 giây"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng cuộn Master",
        "value": "Cuộn Master DR-X85 HD (khoảng 220 bản A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng hộp mực",
        "value": "Hộp mực Duplo HD Black / Color Ink 1.000 ml"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối & Giao tiếp",
        "value": "USB 2.0, Gigabit Ethernet 10/100/1000 Base-T, in trực tiếp từ máy tính"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.405 x 688 x 1.080 mm | Trọng lượng: 108 kg"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "12 – 24 tháng chính hãng, bảo dưỡng định kỳ miễn phí"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Hội đồng in đề thi Quốc gia"
      },
      {
        "@@type": "Audience",
        "audienceType": "Nhà in báo"
      },
      {
        "@@type": "Audience",
        "audienceType": "Bộ Giáo dục"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Nhân Bản Siêu Tốc DUPLO DP-X850
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Dòng máy in nhân bản khổ A3 đỉnh cao nhất của Duplo, tốc độ lên đến 200 bản/phút, độ nét 600x600 dpi chân thực.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Nhân Bản Siêu Tốc DUPLO DP-X850" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DP-X850</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Hội đồng in đề thi Quốc gia, Nhà in báo, Bộ Giáo dục</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/30-duplo-dp-x850.png" alt="Máy In Nhân Bản Siêu Tốc DUPLO DP-X850" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Nhân Bản Siêu Tốc DUPLO DP-X850</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DP-X850</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Máy in nhân bản siêu tốc</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Dòng máy in nhân bản khổ A3 đỉnh cao nhất của Duplo, tốc độ lên đến 200 bản/phút, độ nét 600x600 dpi chân thực.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DP-X850</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">200 trang/phút (Tốc độ in cao nhất phân khúc toàn cầu)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">600 x 600 dpi HD Master Maker</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ bản gốc tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mặt kính A3 phẳng (297 x 432 mm) + Tùy chọn khay nạp tự động ADF 100 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy in hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tối đa 297 x 432 mm (A3), Tối thiểu 100 x 148 mm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy in</th>
              <td class="py-3 text-[14.5px] text-gray-600">45 g/m² – 250 g/m² (Hỗ trợ từ giấy mỏng đề thi đến bìa dày, thiệp mời)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ chế bản</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chế bản nhiệt kỹ thuật số công suất công nghiệp (Industrial Thermal Master Maker)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Thời gian tạo bản Master</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 18 giây (khổ A4) / 19 giây (khổ A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Thời gian in bản đầu tiên</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 21 giây (khổ A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">50% – 200% (bước nhảy 1%), 7 mức cài sẵn tiêu chuẩn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình bảng điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng LCD màu lớn thông minh, hiển thị tiến độ và định mức vật tư</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chế độ in màu rời</th>
              <td class="py-3 text-[14.5px] text-gray-600">Hỗ trợ đổi hộp trống màu (Spare Color Drum) đỏ, xanh, vàng chỉ trong 10 giây</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng cuộn Master</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cuộn Master DR-X85 HD (khoảng 220 bản A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng hộp mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">Hộp mực Duplo HD Black / Color Ink 1.000 ml</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối &amp; Giao tiếp</th>
              <td class="py-3 text-[14.5px] text-gray-600">USB 2.0, Gigabit Ethernet 10/100/1000 Base-T, in trực tiếp từ máy tính</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.405 x 688 x 1.080 mm | Trọng lượng: 108 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">12 – 24 tháng chính hãng, bảo dưỡng định kỳ miễn phí</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dp-x850-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DP-X850" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dp-x850-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dp-x850-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Nhân Bản Siêu Tốc DUPLO DP-X850?</h2>
