...
@section('meta_description', "Dòng máy in nhân bản khổ A3 đỉnh cao nhất của Duplo, tốc độ lên đến 200 bản/phút, độ nét 600x600 dpi chân thực. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
    ...
    "additionalProperty": [
      {
        ...
        "value": "200 trang/phút (Cao nhất phân khúc)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Chế bản nhiệt kỹ thuật số (Thermal Digital)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Cảm ứng LCD màu lớn thông minh"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">200 trang/phút (Cao nhất phân khúc)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">A3 (297 x 420 mm)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Chế bản nhiệt kỹ thuật số (Thermal Digital)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng LCD màu lớn thông minh</td>
            </tr>
          </tbody>
        </table>
      </div>
