...
@section('title', "Máy In Siêu Tốc Ricoh Priport DX 2430 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Ricoh Priport DX 2430 khổ B4, tốc độ 90 trang/phút, độ bền cao, giải pháp in sao tài liệu kinh tế cho trường học. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-2430/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-2430/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/ricoh-priport-dx-2430/#product",
    "name": "Máy In Siêu Tốc Ricoh Priport DX 2430",
    "image": "https://huongsonco.com.vn/assets/images/products/58-ricoh-dx2430.jpg",
    "model": "Priport DX 2430",
    "sku": "RICOH-DX2430",
    "category": "Máy in siêu tốc kỹ thuật số",
    "description": "Ricoh Priport DX 2430 khổ B4, tốc độ 90 trang/phút, độ bền cao, giải pháp in sao tài liệu kinh tế cho trường học.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in",
        "value": "60 – 90 bản/phút (Điều chỉnh 2 mức tốc độ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "300 x 300 dpi sắc nét"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ bản gốc tối đa",
        "value": "257 x 364 mm (Khổ B4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy in hỗ trợ",
        "value": "Tối đa 275 x 395 mm, tối thiểu 90 x 140 mm"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Dưới 40 giây (khổ B4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Sức chứa khay nạp giấy",
        "value": "500 tờ (định lượng 80 g/m²)"
      },
      {
        "@@type": "PropertyValue",
      ...
      {
        "@@type": "PropertyValue",
        "name": "Tỷ lệ phóng thu (Zoom)",
        "value": "4 mức thu nhỏ (71%, 82%, 87%, 93%) và 3 mức phóng to (115%, 122%, 141%)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng cuộn Master",
        "value": "Khoảng 100 bản Master / cuộn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng hộp mực",
        "value": "Mực Ricoh Priport Black 500 ml"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
        "value": "Cổng USB 2.0 (tùy chọn Card giao tiếp máy tính)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.232 x 672 x 519 mm | Trọng lượng: 55 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Siêu Tốc Ricoh Priport DX 2430
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Ricoh Priport DX 2430 khổ B4, tốc độ 90 trang/phút, độ bền cao, giải pháp in sao tài liệu kinh tế cho trường học.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Siêu Tốc Ricoh Priport DX 2430" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Priport DX 2430</strong> — sản xuất bởi Ricoh (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường học, Cơ sở dạy nghề, Văn phòng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/58-ricoh-dx2430.jpg" alt="Máy In Siêu Tốc Ricoh Priport DX 2430" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Siêu Tốc Ricoh Priport DX 2430</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Priport DX 2430</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In bài kiểm tra, đề cương học tập hàng ngày cho trường phổ thông và trung tâm giáo dục</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In biểu mẫu, công văn hành chính tại UBND xã, phường và thị trấn</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In tài liệu sinh hoạt, phiếu thông tin cho hội đoàn và cơ quan cơ sở</span>
        </li>
      </ul>
        </div>
      </div>
      ...
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tỷ lệ phóng thu (Zoom)</th>
              <td class="py-3 text-[14.5px] text-gray-600">4 mức thu nhỏ (71%, 82%, 87%, 93%) và 3 mức phóng to (115%, 122%, 141%)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng cuộn Master</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 100 bản Master / cuộn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng hộp mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực Ricoh Priport Black 500 ml</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cổng USB 2.0 (tùy chọn Card giao tiếp máy tính)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.232 x 672 x 519 mm | Trọng lượng: 55 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-ricoh-priport-dx-2430-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Priport DX 2430" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-ricoh-priport-dx-2430-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-ricoh-priport-dx-2430-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Siêu Tốc Ricoh Priport DX 2430?</h2>
