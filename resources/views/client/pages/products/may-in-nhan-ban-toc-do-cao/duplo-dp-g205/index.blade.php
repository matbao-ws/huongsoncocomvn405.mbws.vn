...
@section('meta_description', "Dòng máy in nhân bản khổ B4 nhỏ gọn, dễ sử dụng, chi phí đầu tư ban đầu hợp lý cho trường tiểu học và trạm y tế. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">60 - 130 bản/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khổ B4</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
