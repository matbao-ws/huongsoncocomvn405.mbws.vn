...
@section('title', "Máy In Nhân Bản Siêu Tốc Duplo DP-G205 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Dòng máy in nhân bản khổ B4 nhỏ gọn, dễ sử dụng, chi phí đầu tư ban đầu hợp lý cho trường tiểu học và trạm y tế. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-g205/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-g205/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-g205/#product",
    "name": "Máy In Nhân Bản Siêu Tốc Duplo DP-G205",
    "image": "https://huongsonco.com.vn/assets/images/products/29-dp-g205.jpg",
    "model": "DP-G205",
    "sku": "DUPLO-DP-G205",
    "category": "Máy in nhân bản siêu tốc",
    "description": "Dòng máy in nhân bản khổ B4 nhỏ gọn, dễ sử dụng, chi phí đầu tư ban đầu hợp lý cho trường tiểu học và trạm y tế.",
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "45 g/m² – 140 g/m²"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ chế bản",
        "value": "Chế bản nhiệt kỹ thuật số tự động"
      },
      {
        "@@type": "PropertyValue",
        "name": "Thời gian tạo Master",
        "value": "Khoảng 21 giây (B4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Sức chứa khay giấy",
        "value": "1.000 tờ (khay nạp và nhận)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình điều khiển",
        "value": "Bảng điều khiển LED hiển thị số bản và trạng thái mực"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
      ...
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng vật tư",
        "value": "Master DR-G20 (250 bản) / Mực CC 1.000 ml"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ & Bảo hành",
        "value": "Chính hãng Duplo Nhật Bản, bảo hành 12 tháng chính hãng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      ...
      {
        "@@type": "Audience",
        "audienceType": "Trường Mầm non"
      },
      {
        "@@type": "Audience",
        "audienceType": "Bệnh viện - Y tế"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Nhân Bản Siêu Tốc Duplo DP-G205
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Dòng máy in nhân bản khổ B4 nhỏ gọn, dễ sử dụng, chi phí đầu tư ban đầu hợp lý cho trường tiểu học và trạm y tế.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Nhân Bản Siêu Tốc Duplo DP-G205" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DP-G205</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường Tiểu học, Trường Mầm non, Bệnh viện - Y tế</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/29-dp-g205.jpg" alt="Máy In Nhân Bản Siêu Tốc Duplo DP-G205" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Nhân Bản Siêu Tốc Duplo DP-G205</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DP-G205</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Dòng máy in nhân bản khổ B4 nhỏ gọn, dễ sử dụng, chi phí đầu tư ban đầu hợp lý cho trường tiểu học và trạm y tế.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DP-G205</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">60 – 130 trang/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">B4 (257 x 364 mm)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">45 g/m² – 140 g/m²</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ chế bản</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chế bản nhiệt kỹ thuật số tự động</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Thời gian tạo Master</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 21 giây (B4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Sức chứa khay giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.000 tờ (khay nạp và nhận)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Bảng điều khiển LED hiển thị số bản và trạng thái mực</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối</th>
              <td class="py-3 text-[14.5px] text-gray-600">USB 2.0 High Speed</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng vật tư</th>
              <td class="py-3 text-[14.5px] text-gray-600">Master DR-G20 (250 bản) / Mực CC 1.000 ml</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Xuất xứ &amp; Bảo hành</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chính hãng Duplo Nhật Bản, bảo hành 12 tháng chính hãng</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dp-g205-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DP-G205" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dp-g205-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dp-g205-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Nhân Bản Siêu Tốc Duplo DP-G205?</h2>
