    ...
    "additionalProperty": [
      {
        ...
        "value": "Hút chân không bằng luồng khí đa tầng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Số lượng khay",
        "value": "10 khay (có thể ghép nối nhiều tháp lên 60 khay)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ phối",
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Tháp phối trang hút chân không (Suction Collator) công nghiệp 10 khay, xử lý mọi chất liệu giấy mỹ thuật, giấy bóng mờ.</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Hút chân không bằng luồng khí đa tầng</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Số lượng khay</th>
              <td class="py-3 text-[14.5px] text-gray-600">10 khay (có thể ghép nối nhiều tháp lên 60 khay)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ phối</th>
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">52 - 300 g/m2</td>
            </tr>
          </tbody>
        </table>
      </div>
