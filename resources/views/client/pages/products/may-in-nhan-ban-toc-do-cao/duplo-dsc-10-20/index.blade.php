...
@section('meta_description', "Tháp phối trang hút chân không (Suction Collator) công nghiệp 10 khay, xử lý mọi chất liệu giấy mỹ thuật, giấy bóng mờ. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dsc-10-20/"
      }
    ]
  },
  {
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Số khay nạp",
        "value": "10 khay nạp giác hút chân không độc lập"
      },
      {
        "@@type": "PropertyValue",
        "name": "Cơ chế nạp giấy",
        "value": "Giác hút khí chân không (Air Suction) không để lại vệt xước"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ phối trang",
        "value": "Lên đến 7.200 bộ/giờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy nạp",
        "value": "Tối đa 320 x 450 mm, tối thiểu 120 x 210 mm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy",
        "value": "40 – 300 g/m² (xử lý tốt giấy mỏng lẫn bìa cứng)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Sức chứa khay nạp",
        "value": "Chiều cao 35 mm / khay (khoảng 400 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Cảm biến kiểm soát",
        "value": "Cảm biến siêu âm (Ultrasonic Sensor) phát hiện đúp giấy chuẩn 100%"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khả năng mở rộng",
        "value": "Ghép nối liên hoàn lên đến 6 tháp (hệ thống 60 khay nạp)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảng điều khiển",
        "value": "Màn hình màu LCD đồ họa hiển thị trạng thái từng khay"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "840 x 750 x 1.700 mm | Trọng lượng: 135 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Nhà máy in ấn xuất bản"
      },
      {
        "@@type": "Audience",
        "audienceType": "Trung tâm in đề thi trọng điểm"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Hệ Thống Phối Trang Hút Chân Không Duplo DSC-10/20
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Tháp phối trang hút chân không (Suction Collator) công nghiệp 10 khay, xử lý mọi chất liệu giấy mỹ thuật, giấy bóng mờ.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Hệ Thống Phối Trang Hút Chân Không Duplo DSC-10/20" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DSC-10/20</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Nhà máy in ấn xuất bản, Trung tâm in đề thi trọng điểm</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/38-dsc-10-20.jpg" alt="Hệ Thống Phối Trang Hút Chân Không Duplo DSC-10/20" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Hệ Thống Phối Trang Hút Chân Không Duplo DSC-10/20</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DSC-10/20</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Hệ thống phối trang công nghiệp</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Xử lý phối trang tài liệu in offset và in kỹ thuật số đòi hỏi chất lượng mỹ thuật cao</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gom bộ tài liệu hội thảo cao cấp, báo cáo bạch, catalogue nhiều trang</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Phối bộ tài liệu đề thi và văn bản bảo mật cao không để lại tì vết</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DSC-10/20</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Số khay nạp</th>
              <td class="py-3 text-[14.5px] text-gray-600">10 khay nạp giác hút chân không độc lập</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Cơ chế nạp giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Giác hút khí chân không (Air Suction) không để lại vệt xước</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ phối trang</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 7.200 bộ/giờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy nạp</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tối đa 320 x 450 mm, tối thiểu 120 x 210 mm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">40 – 300 g/m² (xử lý tốt giấy mỏng lẫn bìa cứng)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Sức chứa khay nạp</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chiều cao 35 mm / khay (khoảng 400 tờ)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Cảm biến kiểm soát</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm biến siêu âm (Ultrasonic Sensor) phát hiện đúp giấy chuẩn 100%</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khả năng mở rộng</th>
              <td class="py-3 text-[14.5px] text-gray-600">Ghép nối liên hoàn lên đến 6 tháp (hệ thống 60 khay nạp)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảng điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Màn hình màu LCD đồ họa hiển thị trạng thái từng khay</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">840 x 750 x 1.700 mm | Trọng lượng: 135 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dsc-10-20-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DSC-10/20" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dsc-10-20-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dsc-10-20-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Hệ Thống Phối Trang Hút Chân Không Duplo DSC-10/20?</h2>
