...
@section('meta_description', "Máy in nhân bản khổ B4 tốc độ 130 bản/phút, thân thiện môi trường, vận hành êm ái, tối ưu cho trường phổ thông. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
        "value": "USB 2.0, LAN Card (chọn thêm)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">USB 2.0, LAN Card (chọn thêm)</td>
            </tr>
          </tbody>
        </table>
      </div>
