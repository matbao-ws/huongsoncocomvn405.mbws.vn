...
@section('title', "Máy In Nhân Bản Siêu Tốc Duplo DP-G325 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Máy in nhân bản khổ B4 tốc độ 130 bản/phút, thân thiện môi trường, vận hành êm ái, tối ưu cho trường phổ thông. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-g325/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-g325/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dp-g325/#product",
    "name": "Máy In Nhân Bản Siêu Tốc Duplo DP-G325",
    "image": "https://huongsonco.com.vn/assets/images/products/20-may-in-nhan-ban-sieu-toc-duplo-dp-g325.jpg",
    "model": "DP-G325",
    "sku": "DUPLO-DP-G325",
    "category": "Máy in nhân bản siêu tốc",
    "description": "Máy in nhân bản khổ B4 tốc độ 130 bản/phút, thân thiện môi trường, vận hành êm ái, tối ưu cho trường phổ thông.",
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in",
        "value": "60 – 130 trang/phút (3 mức điều chỉnh tốc độ linh hoạt)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
      ...
      },
      {
        ...
        "value": "B4 (257 x 364 mm), Tối thiểu khổ A5 (100 x 148 mm)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ bản gốc tối đa",
        "value": "B4 (257 x 364 mm) trên mặt kính phẳng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy in",
        "value": "45 g/m² – 210 g/m²"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ chế bản",
        "value": "Chế bản nhiệt kỹ thuật số tự động hoàn toàn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Thời gian tạo bản Master",
        "value": "Khoảng 21 giây (khổ B4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Sức chứa khay chứa giấy",
        "value": "1.000 tờ (khay nạp) / 1.000 tờ (khay nhận)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Thu phóng hình ảnh",
        "value": "3 mức thu nhỏ, 3 mức phóng to (70%, 81%, 86%, 115%, 122%, 141%)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình điều khiển",
        "value": "Màn hình LCD và phím bấm chức năng trực quan, đèn LED báo trạng thái"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
        "value": "USB 2.0 High Speed, tùy chọn cổng mạng LAN Card"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng cuộn Master",
        "value": "Cuộn Master DR-G32 (khoảng 250 bản B4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng hộp mực",
        "value": "Hộp mực Duplo CC Black 1.000 ml"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.360 x 688 x 1.080 mm | Trọng lượng: 90 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ & Chứng nhận",
        "value": "Chính hãng Duplo (Nhật Bản), đầy đủ CO/CQ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo hành & Hỗ trợ",
        "value": "12 – 24 tháng chính hãng tại Hương Sơn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy In Nhân Bản Siêu Tốc Duplo DP-G325
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Máy in nhân bản khổ B4 tốc độ 130 bản/phút, thân thiện môi trường, vận hành êm ái, tối ưu cho trường phổ thông.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy In Nhân Bản Siêu Tốc Duplo DP-G325" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DP-G325</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường THPT, Trường THCS, UBND Xã / Phường</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/20-may-in-nhan-ban-sieu-toc-duplo-dp-g325.jpg" alt="Máy In Nhân Bản Siêu Tốc Duplo DP-G325" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy In Nhân Bản Siêu Tốc Duplo DP-G325</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DP-G325</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Máy in nhân bản khổ B4 tốc độ 130 bản/phút, thân thiện môi trường, vận hành êm ái, tối ưu cho trường phổ thông.</span>
        </li>
      </ul>
        </div>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dp-g325-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DP-G325" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dp-g325-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dp-g325-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy In Nhân Bản Siêu Tốc Duplo DP-G325?</h2>
