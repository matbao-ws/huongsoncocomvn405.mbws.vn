...
@section('title', "Máy Giập Ghim Tài Liệu Duplo DFC-SII Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Bộ phận giập ghim tự động kết nối trực tiếp với máy phối trang DFC-100, DFC-102, DFC-120 và DFC-122. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dfc-sii/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dfc-sii/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/may-in-nhan-ban-toc-do-cao/duplo-dfc-sii/#product",
    "name": "Máy Giập Ghim Tài Liệu Duplo DFC-SII",
    "image": "https://huongsonco.com.vn/assets/images/products/39-dfc-sii.jpg",
    "model": "DFC-SII",
    "sku": "DUPLO-DFC-SII",
    "category": "Máy giập ghim sau in",
    "description": "Bộ phận giập ghim tự động kết nối trực tiếp với máy phối trang DFC-100, DFC-102, DFC-120 và DFC-122.",
    ...
    "additionalProperty": [
      {
        ...
        "value": "Tự động dập ghim giữa & gấp đôi thành cuốn sách hoàn chỉnh"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ hoàn thiện",
        "value": "Lên đến 2.400 cuốn sách/giờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy xử lý",
        "value": "Tối đa 320 x 450 mm, tối thiểu 200 x 270 mm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ dày tập sách",
        "value": "Lên đến 20 tờ (tập sách 80 trang định lượng 64 g/m²)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Đầu dập ghim",
        "value": "2 đầu dập ghim tiêu chuẩn, điều chỉnh khoảng cách linh hoạt"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kiểu dập ghim",
        "value": "Dập ghim gáy giữa (Saddle), dập ghim cạnh (Side), dập ghim góc (Corner)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng đạn ghim",
        "value": "Băng cuộn 5.000 ghim chuyên dụng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tương thích thiết bị",
        "value": "Kết nối trực tiếp liên hoàn với Duplo DFC-102 và DFC-122"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "1.150 x 500 x 580 mm | Trọng lượng: 80 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
    ...
    "audience": [
      ...
      {
        "@@type": "Audience",
        "audienceType": "In đề thi tốt nghiệp"
      },
      {
        "@@type": "Audience",
        "audienceType": "Văn thư sở ngành"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy Giập Ghim Tài Liệu Duplo DFC-SII
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Bộ phận giập ghim tự động kết nối trực tiếp với máy phối trang DFC-100, DFC-102, DFC-120 và DFC-122.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/products/duplo-dp-x550.jpg" alt="Máy Giập Ghim Tài Liệu Duplo DFC-SII" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>DFC-SII</strong> — sản xuất bởi Duplo (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Phòng khảo thí, In đề thi tốt nghiệp, Văn thư sở ngành</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/39-dfc-sii.jpg" alt="Máy Giập Ghim Tài Liệu Duplo DFC-SII" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy Giập Ghim Tài Liệu Duplo DFC-SII</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">DFC-SII</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-in-nhan-ban-toc-do-cao/" class="hover:text-[#1A9900]">Máy giập ghim sau in</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Đóng cuốn đề thi tự luận, trắc nghiệm nhiều trang cho các kỳ thi quy mô lớn</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Đóng sổ tay hội nghị, tài liệu tập huấn và cẩm nang đào tạo</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Sản xuất tập bài kiểm tra, giáo trình mỏng cho học sinh, sinh viên</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — DFC-SII</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chức năng chính</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tự động dập ghim giữa &amp; gấp đôi thành cuốn sách hoàn chỉnh</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ hoàn thiện</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 2.400 cuốn sách/giờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy xử lý</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tối đa 320 x 450 mm, tối thiểu 200 x 270 mm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ dày tập sách</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 20 tờ (tập sách 80 trang định lượng 64 g/m²)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Đầu dập ghim</th>
              <td class="py-3 text-[14.5px] text-gray-600">2 đầu dập ghim tiêu chuẩn, điều chỉnh khoảng cách linh hoạt</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kiểu dập ghim</th>
              <td class="py-3 text-[14.5px] text-gray-600">Dập ghim gáy giữa (Saddle), dập ghim cạnh (Side), dập ghim góc (Corner)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng đạn ghim</th>
              <td class="py-3 text-[14.5px] text-gray-600">Băng cuộn 5.000 ghim chuyên dụng</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tương thích thiết bị</th>
              <td class="py-3 text-[14.5px] text-gray-600">Kết nối trực tiếp liên hoàn với Duplo DFC-102 và DFC-122</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.150 x 500 x 580 mm | Trọng lượng: 80 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">12 tháng chính hãng</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-duplo-dfc-sii-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="DFC-SII" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-duplo-dfc-sii-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-duplo-dfc-sii-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy Giập Ghim Tài Liệu Duplo DFC-SII?</h2>
