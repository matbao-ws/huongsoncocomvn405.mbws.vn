...
@section('meta_description', "Bộ phận giập ghim tự động kết nối trực tiếp với máy phối trang DFC-100, DFC-102, DFC-120 và DFC-122. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
...
[
  ...
  },
  {
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Khả năng đóng ghim",
        "value": "Ghim góc, ghim cạnh bên"
      },
      {
        "@@type": "PropertyValue",
        "name": "Số tờ giập tối đa",
        "value": "Lên đến 40 tờ (giấy 80g)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tương thích",
        "value": "Kết nối Online đồng bộ với chuỗi máy phối trang Duplo DFC series"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ giập",
        "value": "Khớp 100% với tốc độ nạp của tháp phối trang"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Bộ phận giập ghim tự động kết nối trực tiếp với máy phối trang DFC-100, DFC-102, DFC-120 và DFC-122.</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khả năng đóng ghim</th>
              <td class="py-3 text-[14.5px] text-gray-600">Ghim góc, ghim cạnh bên</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Số tờ giập tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 40 tờ (giấy 80g)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tương thích</th>
              <td class="py-3 text-[14.5px] text-gray-600">Kết nối Online đồng bộ với chuỗi máy phối trang Duplo DFC series</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ giập</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khớp 100% với tốc độ nạp của tháp phối trang</td>
            </tr>
          </tbody>
        </table>
      </div>
