...
@section('meta_description', "Logitech Group là hệ thống họp trực tuyến chuyên nghiệp chuẩn Full HD — âm thanh khử vọng trong trẻo, camera PTZ zoom 10x mượt mà, cắm... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/he-thong-hoi-nghi-logitech-group/"
      }
    ]
  },
  {
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Camera",
        "value": "PTZ xoay ngang 90 độ, nghiêng 130 độ, Zoom 10x Full HD 1080p"
      },
      {
        "@@type": "PropertyValue",
        "name": "Loa ngoài & Micro",
        "value": "Full-duplex khử tiếng vọng và lọc tạp âm, 4 micro đa hướng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Phạm vi thu âm",
        "value": "Bán kính 6m (mở rộng lên 8.5m với micro kéo dài)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Model tương thích",
        "value": "Logitech Rally, Logitech MeetUp"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Chính hãng Logitech."
      }
    ],
    "audience": [
      {
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Hệ thống hội nghị truyền hình trực tuyến Logitech Group
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Logitech Group là hệ thống họp trực tuyến chuyên nghiệp chuẩn Full HD — âm thanh khử vọng trong trẻo, camera PTZ zoom 10x mượt mà, cắm là chạy qua USB.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Hệ thống hội nghị truyền hình trực tuyến Logitech Group" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>Logitech GROUP ConferenceCam</strong> — sản xuất bởi Logitech (Thụy Sĩ)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Doanh nghiệp, Cơ quan Nhà nước, Ngân hàng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Logitech Rally, Logitech MeetUp</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/logitech-group.jpg" alt="Hệ thống hội nghị truyền hình trực tuyến Logitech Group" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Hệ thống hội nghị truyền hình trực tuyến Logitech Group</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">Logitech GROUP ConferenceCam</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">Logitech (Thụy Sĩ)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="hover:text-[#1A9900]">Thiết bị họp trực tuyến</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Họp trực tuyến qua Zoom, MS Teams, Google Meet cho phòng họp 14–20 người</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Kết nối đa điểm giữa các chi nhánh ngân hàng, trường học, cơ quan</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Thu âm khử ồn, khử tiếng vọng đa hướng 360 độ</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — Logitech GROUP ConferenceCam</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Camera</th>
              <td class="py-3 text-[14.5px] text-gray-600">PTZ xoay ngang 90 độ, nghiêng 130 độ, Zoom 10x Full HD 1080p</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Loa ngoài &amp; Micro</th>
              <td class="py-3 text-[14.5px] text-gray-600">Full-duplex khử tiếng vọng và lọc tạp âm, 4 micro đa hướng</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Phạm vi thu âm</th>
              <td class="py-3 text-[14.5px] text-gray-600">Bán kính 6m (mở rộng lên 8.5m với micro kéo dài)</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Chính hãng Logitech.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Logitech Rally, Logitech MeetUp</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-he-thong-hoi-nghi-logitech-group-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="Logitech GROUP ConferenceCam" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-he-thong-hoi-nghi-logitech-group-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-he-thong-hoi-nghi-logitech-group-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Hệ thống hội nghị truyền hình trực tuyến Logitech Group?</h2>
