...
@section('meta_description', "Máy đếm tiền phát hiện tiền giả, tiền lẫn loại và polyme giả thế hệ mới nhất, đạt chuẩn dùng cho hệ thống ngân hàng. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/may-dem-tien-xinda-bc28f/"
      }
    ]
  },
  {
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ đếm",
        "value": "1.000 - 1.200 tờ/phút"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ phát hiện tiền giả",
        "value": "Cảm ứng hồng ngoại, tia cực tím, từ tính siêu nhạy"
      },
      {
        "@@type": "PropertyValue",
        "name": "Phân biệt mệnh giá",
        "value": "Tự động nhận dạng và dừng khi có tiền khác mệnh giá"
      },
      {
        "@@type": "PropertyValue",
        "name": "Cổng nâng cấp",
        "value": "USB / RS232 cập nhật phần mềm tiền mới"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      ...
      {
        "@@type": "Audience",
        "audienceType": "Kho bạc"
      },
      {
        "@@type": "Audience",
        "audienceType": "Phòng Kế toán - Tài vụ"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy Đếm Tiền Cao Cấp XINDA BC-28F
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Máy đếm tiền phát hiện tiền giả, tiền lẫn loại và polyme giả thế hệ mới nhất, đạt chuẩn dùng cho hệ thống ngân hàng.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy Đếm Tiền Cao Cấp XINDA BC-28F" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>BC-28F</strong> — sản xuất bởi Xinda (Đài Loan)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Ngân hàng, Kho bạc, Phòng Kế toán - Tài vụ</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/102-may-dem-tien-xinda-bc28f.jpg" alt="Máy Đếm Tiền Cao Cấp XINDA BC-28F" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy Đếm Tiền Cao Cấp XINDA BC-28F</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">BC-28F</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">Xinda (Đài Loan)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="hover:text-[#1A9900]">Thiết bị văn phòng</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Máy đếm tiền phát hiện tiền giả, tiền lẫn loại và polyme giả thế hệ mới nhất, đạt chuẩn dùng cho hệ thống ngân hàng.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — BC-28F</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ đếm</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.000 - 1.200 tờ/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ phát hiện tiền giả</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng hồng ngoại, tia cực tím, từ tính siêu nhạy</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Phân biệt mệnh giá</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tự động nhận dạng và dừng khi có tiền khác mệnh giá</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Cổng nâng cấp</th>
              <td class="py-3 text-[14.5px] text-gray-600">USB / RS232 cập nhật phần mềm tiền mới</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-may-dem-tien-xinda-bc28f-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="BC-28F" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-may-dem-tien-xinda-bc28f-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-may-dem-tien-xinda-bc28f-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy Đếm Tiền Cao Cấp XINDA BC-28F?</h2>
