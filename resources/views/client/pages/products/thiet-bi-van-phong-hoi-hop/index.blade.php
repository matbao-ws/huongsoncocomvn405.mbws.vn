...
@section('canonical', url('/san-pham/thiet-bi-van-phong-hoi-hop/'))
@section('jsonld')
...
<head>
  ...
  <title>Thiết bị văn phòng, hội họp và văn phòng phẩm | Hương Sơn</title>
  <meta name="description" content="Cung cấp thiết bị văn phòng, hội họp và văn phòng phẩm: kệ hồ sơ, file, giấy các loại, sổ sách và đồ dùng văn phòng — qua Cửa hàng thiết bị văn phòng Hương Sơn." />
  <meta name="keywords" content="thiết bị văn phòng, văn phòng phẩm, kệ file hồ sơ, giấy văn phòng, đồ dùng văn phòng" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Thiết bị văn phòng, hội họp và văn phòng phẩm | Hương Sơn" />
  <meta property="og:description" content="Cung cấp thiết bị văn phòng, hội họp và văn phòng phẩm: kệ hồ sơ, file, giấy các loại, sổ sách và đồ dùng văn phòng — qua Cửa hàng thiết bị văn phòng Hương Sơn." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Thiết bị văn phòng – hội họp và văn phòng phẩm" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Thiết bị văn phòng – hội họp và văn phòng phẩm</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Ngoài thiết bị in ấn, Hương Sơn còn cung cấp thiết bị văn phòng, hội họp và văn phòng phẩm qua Cửa hàng thiết bị văn phòng &amp; văn phòng phẩm Hương Sơn tại Đức Giang, Long Biên, Hà Nội.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Thiết bị văn phòng – hội họp và văn phòng phẩm</span>
      </nav>
    </div>
  </section>
