...
@section('title', "Thiết bị văn phòng, hội họp và văn phòng phẩm | Hương Sơn")
@section('meta_description', "Cung cấp thiết bị văn phòng, hội họp và văn phòng phẩm: kệ hồ sơ, file, giấy các loại, sổ sách và đồ dùng văn phòng — qua Cửa hàng thiết bị văn phòng Hương Sơn.")
@section('canonical', "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/")
@section('jsonld')
...
[
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/"
      }
    ]
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        "@@type": "ListItem",
        "position": 2,
        "name": "Máy chiếu hội trường văn phòng Panasonic PT-VZ580",
        "url": "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/may-chieu-hoi-truong-panasonic-pt-vz580/"
      },
      {
        "@@type": "ListItem",
        "position": 3,
  ...
  },
  {
    ...
    "mainEntity": [
      {
        "@@type": "Question",
        "name": "Mua văn phòng phẩm liên hệ ở đâu?",
        "acceptedAnswer": {
          "@@type": "Answer",
          "text": "Cửa hàng thiết bị văn phòng & văn phòng phẩm Hương Sơn tại số 2 ngõ 67 phố Đức Giang, phường Việt Hưng, quận Long Biên, Hà Nội — phụ trách Mrs. Nguyễn Thị Hương, di động 0916533383, email vpphuongson@@gmail.com."
        }
      },
      {
        "@@type": "Question",
        "name": "Có giao hàng thiết bị văn phòng cùng lúc với máy photocopy không?",
        "acceptedAnswer": {
          "@@type": "Answer",
          "text": "Với đơn hàng lớn hoặc theo dự án, Hương Sơn sắp xếp giao hàng đồng bộ; vui lòng nêu rõ nhu cầu khi liên hệ để được sắp xếp phù hợp."
        }
      }
    ]
  }
...
<!-- PAGE HERO (SPLIT-HERO FOREGROUND SHOWCASE BANNER) -->
      ...
      <div class="flex items-center justify-start mb-4">
        <nav class="inline-flex items-center gap-1.5 sm:gap-2 bg-white/10 hover:bg-white/15 border border-white/20 px-3.5 sm:px-4 py-1.5 backdrop-blur-md text-xs text-white/90 transition shadow-sm flex-wrap" aria-label="Breadcrumb">
          <a href="/" class="hover:text-white flex items-center gap-1.5 transition">
            ...
            <span>Trang chủ</span>
          </a> <i class="fa-solid fa-angle-right text-[9px] text-gray-400"></i> <a href="/san-pham/" class="text-gray-200 hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] text-gray-400"></i> <span class="text-[#84e372] font-semibold" aria-current="page">Thiết bị văn phòng – hội họp và văn phòng phẩm</span>
        </nav>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Thiết bị văn phòng – hội họp và văn phòng phẩm
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Ngoài thiết bị in ấn, Hương Sơn còn cung cấp thiết bị văn phòng, hội họp và văn phòng phẩm qua Cửa hàng thiết bị văn phòng &amp; văn phòng phẩm Hương Sơn tại Đức Giang, Long Biên, Hà Nội.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Thiết bị văn phòng – hội họp và văn phòng phẩm" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Danh mục thiết bị văn phòng, hội họp và văn phòng phẩm mà Hương Sơn cung cấp.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Văn phòng, trường học và cá nhân có nhu cầu mua thiết bị văn phòng và văn phòng phẩm.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Một điểm mua sắm thiết bị văn phòng và văn phòng phẩm bên cạnh nhu cầu thiết bị in ấn chính.</p>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Nhóm sản phẩm hỗ trợ công việc văn phòng hằng ngày: kệ hồ sơ, file, giấy các loại, sổ sách và đồ dùng văn phòng khác.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Nhóm này được phục vụ qua Cửa hàng thiết bị văn phòng & văn phòng phẩm Hương Sơn (phụ trách: Mrs. Nguyễn Thị Hương) tại số 2 ngõ 67 phố Đức Giang, phường Việt Hưng, quận Long Biên, Hà Nội.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Gồm: kệ file hồ sơ, đồ dùng học sinh, file hồ sơ các mẫu, giấy các loại, kệ đựng hồ sơ, sổ các loại và văn phòng phẩm khác.</span>
        </li>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/102-may-dem-tien-xinda-bc28f.jpg" alt="Máy Đếm Tiền Cao Cấp XINDA BC-28F" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Xinda (Đài Loan)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/thiet-bi-van-phong-hoi-hop/may-dem-tien-xinda-bc28f/">Máy Đếm Tiền Cao Cấp XINDA BC-28F</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Máy đếm tiền phát hiện tiền giả, tiền lẫn loại và polyme giả thế hệ mới nhất, đạt chuẩn dùng cho hệ thống ngân hàng.</p>
            <a href="/san-pham/thiet-bi-van-phong-hoi-hop/may-dem-tien-xinda-bc28f/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/panasonic-pt-vz580.jpg" alt="Máy chiếu hội trường văn phòng Panasonic PT-VZ580" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Panasonic (Nhật Bản)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/thiet-bi-van-phong-hoi-hop/may-chieu-hoi-truong-panasonic-pt-vz580/">Máy chiếu hội trường văn phòng Panasonic PT-VZ580</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Panasonic PT-VZ580 máy chiếu hội trường 5.000 Ansi Lumens độ phân giải WUXGA — độ sáng vượt trội giúp trình chiếu sắc nét rõ ràng ngay cả trong phòng …</p>
            <a href="/san-pham/thiet-bi-van-phong-hoi-hop/may-chieu-hoi-truong-panasonic-pt-vz580/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          <div class="h-52 overflow-hidden"><img src="/assets/images/products/logitech-group.jpg" alt="Hệ thống hội nghị truyền hình trực tuyến Logitech Group" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition duration-300" /></div>
          <div class="p-6 flex flex-col flex-1">
            <span class="inline-block text-[10.5px] font-bold uppercase tracking-[0.15em] text-[#1A9900] mb-2">Logitech (Thụy Sĩ)</span>
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/thiet-bi-van-phong-hoi-hop/he-thong-hoi-nghi-logitech-group/">Hệ thống hội nghị truyền hình trực tuyến Logitech Group</a>
            </h3>
            <p class="text-gray-500 text-[14.5px] leading-relaxed mb-4 flex-1">Logitech Group là hệ thống họp trực tuyến chuyên nghiệp chuẩn Full HD — âm thanh khử vọng trong trẻo, camera PTZ zoom 10x mượt mà, cắm là chạy qua USB…</p>
            <a href="/san-pham/thiet-bi-van-phong-hoi-hop/he-thong-hoi-nghi-logitech-group/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
              <span>Xem thông số kỹ thuật</span> <i class="fa-solid fa-arrow-right text-[10px]"></i>
            </a>
          </div>
        </article>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Mua văn phòng phẩm liên hệ ở đâu?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Cửa hàng thiết bị văn phòng & văn phòng phẩm Hương Sơn tại số 2 ngõ 67 phố Đức Giang, phường Việt Hưng, quận Long Biên, Hà Nội — phụ trách Mrs. Nguyễn Thị Hương, di động 0916533383, email vpphuongson@@gmail.com.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có giao hàng thiết bị văn phòng cùng lúc với máy photocopy không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Với đơn hàng lớn hoặc theo dự án, Hương Sơn sắp xếp giao hàng đồng bộ; vui lòng nêu rõ nhu cầu khi liên hệ để được sắp xếp phù hợp.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="cat-thiet-bi-van-phong-hoi-hop-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-cat-thiet-bi-van-phong-hoi-hop-hp">Bỏ trống ô này</label>
            <input type="text" id="f-cat-thiet-bi-van-phong-hoi-hop-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
