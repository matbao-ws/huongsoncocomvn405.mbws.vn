...
@section('meta_description', "Panasonic PT-VZ580 máy chiếu hội trường 5.000 Ansi Lumens độ phân giải WUXGA — độ sáng vượt trội giúp trình chiếu sắc nét rõ ràng ngay... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Panasonic PT-VZ580 máy chiếu hội trường 5.000 Ansi Lumens độ phân giải WUXGA — độ sáng vượt trội giúp trình chiếu sắc nét rõ ràng ngay cả trong phòng họp bật đầy đủ ánh sáng.</p>
