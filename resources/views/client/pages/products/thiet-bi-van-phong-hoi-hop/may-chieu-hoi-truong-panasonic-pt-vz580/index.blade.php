...
@section('title', "Máy chiếu hội trường văn phòng Panasonic PT-VZ580 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Panasonic PT-VZ580 máy chiếu hội trường 5.000 Ansi Lumens độ phân giải WUXGA — độ sáng vượt trội giúp trình chiếu sắc nét rõ ràng ngay cả trong... Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
@section('canonical', "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/may-chieu-hoi-truong-panasonic-pt-vz580/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/may-chieu-hoi-truong-panasonic-pt-vz580/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/thiet-bi-van-phong-hoi-hop/may-chieu-hoi-truong-panasonic-pt-vz580/#product",
    "name": "Máy chiếu hội trường văn phòng Panasonic PT-VZ580",
    "image": "https://huongsonco.com.vn/assets/images/products/panasonic-pt-vz580.jpg",
    "model": "PT-VZ580",
    "sku": "PANA-VZ580",
    "category": "Thiết bị trình chiếu hội nghị",
    "description": "Panasonic PT-VZ580 máy chiếu hội trường 5.000 Ansi Lumens độ phân giải WUXGA — độ sáng vượt trội giúp trình chiếu sắc nét rõ ràng ngay cả trong phòng họp bật đầy đủ ánh sáng.",
    "itemCondition": "https://schema.org/NewCondition",
    "brand": {
      "@@type": "Brand",
      "name": "Panasonic (Nhật Bản)"
    },
    "manufacturer": {
      "@@type": "Organization",
      "name": "Panasonic (Nhật Bản)"
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Độ sáng",
        "value": "5.000 ANSI Lumens"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "WUXGA (1920 x 1200) cao hơn Full HD"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ tương phản",
      ...
      {
        "@@type": "PropertyValue",
        "name": "Tuổi thọ bóng đèn",
        "value": "Lên đến 7.000 giờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Model tương thích",
        "value": "PT-VZ585N, PT-VMZ51"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Chính hãng Panasonic Nhật Bản."
      }
    ],
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Hội trường cơ quan"
      },
      {
        "@@type": "Audience",
        "audienceType": "Phòng họp tập đoàn"
      },
      {
        "@@type": "Audience",
        "audienceType": "Giảng đường lớn"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy chiếu hội trường văn phòng Panasonic PT-VZ580" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy chiếu hội trường văn phòng Panasonic PT-VZ580</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Panasonic PT-VZ580 máy chiếu hội trường 5.000 Ansi Lumens độ phân giải WUXGA — độ sáng vượt trội giúp trình chiếu sắc nét rõ ràng ngay cả trong phòng họp bật đầy đủ ánh sáng.</p>
      <nav class="mt-6 text-[13px] text-gray-300 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="text-gray-300 hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-400"></i> <a href="/san-pham/" class="text-gray-300 hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-400"></i> <a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="text-gray-300 hover:text-white transition">Thiết bị văn phòng – hội họp và văn phòng phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-400"></i> <span class="text-[#5eb74c] font-semibold" aria-current="page">Máy chiếu hội trường văn phòng Panasonic PT-VZ580</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>PT-VZ580</strong> — sản xuất bởi Panasonic (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Hội trường cơ quan, Phòng họp tập đoàn, Giảng đường lớn</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">PT-VZ585N, PT-VMZ51</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/panasonic-pt-vz580.jpg" alt="Máy chiếu hội trường văn phòng Panasonic PT-VZ580" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy chiếu hội trường văn phòng Panasonic PT-VZ580</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">PT-VZ580</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Hãng sản xuất</dt><dd class="text-[15px] font-semibold text-[#181923]">Panasonic (Nhật Bản)</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="hover:text-[#1A9900]">Thiết bị trình chiếu hội nghị</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Trình chiếu hội trường, phòng họp lớn không cần tắt bớt đèn</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Hội nghị tổng kết, hội thảo chuyên đề cơ quan và doanh nghiệp</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Chiếu hình ảnh bản vẽ kỹ thuật, đồ thị độ nét cao WUXGA</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — PT-VZ580</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ sáng</th>
              <td class="py-3 text-[14.5px] text-gray-600">5.000 ANSI Lumens</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">WUXGA (1920 x 1200) cao hơn Full HD</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ tương phản</th>
              <td class="py-3 text-[14.5px] text-gray-600">16.000:1</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tuổi thọ bóng đèn</th>
              <td class="py-3 text-[14.5px] text-gray-600">Lên đến 7.000 giờ</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Chính hãng Panasonic Nhật Bản.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">PT-VZ585N, PT-VMZ51</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-may-chieu-hoi-truong-panasonic-pt-vz580-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="PT-VZ580" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-may-chieu-hoi-truong-panasonic-pt-vz580-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-may-chieu-hoi-truong-panasonic-pt-vz580-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy chiếu hội trường văn phòng Panasonic PT-VZ580?</h2>
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/thiet-bi-van-phong-hoi-hop/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem Thiết bị văn phòng – hội họp và văn phòng phẩm</a>
