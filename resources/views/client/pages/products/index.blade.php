...
<!-- PAGE HERO -->
  ...
  <section class="py-16 bg-[#f8fafc] border-t border-gray-200/80">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto mb-12">
        <span class="text-[#1A9900] font-bold text-xs uppercase tracking-[0.2em] block mb-3">Thương hiệu ủy quyền &amp; Phân phối</span>
        <h2 class="text-2xl sm:text-[34px] font-bold text-[#181923] leading-tight">Đối tác thương hiệu chính hãng</h2>
        <p class="text-gray-500 text-[15px] mt-3">Hương Sơn là đại lý ủy quyền và đối tác phân phối chính thức của các thương hiệu hàng đầu thế giới về thiết bị in ấn, sao chụp và số hóa.</p>
      </div>

      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        @if(isset($brands) && $brands->isNotEmpty())
          @foreach($brands as $brand)
            <div class="bg-white border border-gray-200/80 p-6 rounded-lg flex flex-col items-center text-center hover:shadow-md hover:border-[#1A9900]/40 transition group">
              <div class="h-16 w-full flex items-center justify-center mb-4 bg-gray-50 rounded p-2">
                @if($brand->image_url)
                  <img src="{{ $brand->image_url }}" alt="{{ $brand->name }}" class="max-h-12 max-w-[160px] object-contain group-hover:scale-105 transition" onerror="this.onerror=null;this.src='/assets/images/brand/HUONG_SON_logo.svg';" />
                @else
                  <span class="font-bold text-lg text-[#10203C]">{{ $brand->name }}</span>
                @endif
              </div>
              <h3 class="font-bold text-[16px] text-[#181923] mb-1.5 group-hover:text-[#1A9900] transition">
                {{ $brand->name }}
              </h3>
              <p class="text-xs text-gray-500 leading-relaxed mb-4 flex-1 line-clamp-2">
                {{ $brand->description ?: 'Thương hiệu thiết bị in ấn và số hóa văn phòng chính hãng.' }}
              </p>
              <div class="pt-3 border-t border-gray-100 w-full flex items-center justify-between text-xs">
                <span class="text-gray-400">Thiết bị:</span>
                <span class="font-bold text-[#1A9900] bg-green-50 px-2.5 py-0.5 rounded">
          ...
          @endforeach
        @else
          <div class="bg-white border border-gray-200/80 p-6 rounded-lg flex flex-col items-center text-center">
            <div class="h-16 w-full flex items-center justify-center mb-4 bg-gray-50 rounded p-2">
              <img src="/assets/images/brands/duplo.svg" alt="DUPLO" class="max-h-12 max-w-[160px] object-contain" />
            </div>
            <h3 class="font-bold text-[16px] text-[#181923] mb-1">DUPLO (Nhật Bản)</h3>
            <p class="text-xs text-gray-500 leading-relaxed">Đại lý ủy quyền độc quyền máy in nhân bản miền Bắc từ 2017.</p>
          </div>
          <div class="bg-white border border-gray-200/80 p-6 rounded-lg flex flex-col items-center text-center">
            <div class="h-16 w-full flex items-center justify-center mb-4 bg-gray-50 rounded p-2">
              <img src="/assets/images/brands/toshiba.svg" alt="TOSHIBA" class="max-h-12 max-w-[160px] object-contain" />
            </div>
            <h3 class="font-bold text-[16px] text-[#181923] mb-1">TOSHIBA (Nhật Bản)</h3>
            <p class="text-xs text-gray-500 leading-relaxed">Đại lý ủy quyền phân phối máy photocopy A3/A4.</p>
          </div>
          <div class="bg-white border border-gray-200/80 p-6 rounded-lg flex flex-col items-center text-center">
            <div class="h-16 w-full flex items-center justify-center mb-4 bg-gray-50 rounded p-2">
              <img src="/assets/images/brands/fansipan.svg" alt="FANSIPAN" class="max-h-12 max-w-[160px] object-contain" />
            </div>
            <h3 class="font-bold text-[16px] text-[#181923] mb-1">FANSIPAN</h3>
            <p class="text-xs text-gray-500 leading-relaxed">Thương hiệu vật tư mực &amp; linh kiện tương thích độc quyền của Hương Sơn.</p>
          </div>
          <div class="bg-white border border-gray-200/80 p-6 rounded-lg flex flex-col items-center text-center">
            <div class="h-16 w-full flex items-center justify-center mb-4 bg-gray-50 rounded p-2">
              <img src="/assets/images/brands/ricoh.svg" alt="RICOH" class="max-h-12 max-w-[160px] object-contain" />
            </div>
            <h3 class="font-bold text-[16px] text-[#181923] mb-1">RICOH (Nhật Bản)</h3>
            <p class="text-xs text-gray-500 leading-relaxed">Máy in siêu tốc Priport &amp; máy scan tài liệu tốc độ cao.</p>
          </div>
        @endif
      </div>
    </div>
