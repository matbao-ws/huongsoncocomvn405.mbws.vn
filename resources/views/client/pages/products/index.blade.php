...
<head>
  ...
  <title>Sản phẩm – Thiết bị văn phòng, in ấn, số hóa | Hương Sơn</title>
  <meta name="description" content="9 nhóm sản phẩm Hương Sơn cung cấp: photocopy, máy in nhân bản, scan, phối trang, in laser, thiết bị phòng học, vật tư, thiết bị văn phòng và FANSIPAN." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Sản phẩm – Thiết bị văn phòng, in ấn, số hóa | Hương Sơn" />
  <meta property="og:description" content="9 nhóm sản phẩm Hương Sơn cung cấp: photocopy, máy in nhân bản, scan, phối trang, in laser, thiết bị phòng học, vật tư, thiết bị văn phòng và FANSIPAN." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Sản phẩm thiết bị văn phòng, in ấn và số hóa" class="w-full h-full object-cover object-center" loading="eager" />
