...
@section('meta_description', "Toshiba e-STUDIO 3528A công suất trung bình cao 35 trang/phút, xử lý khối lượng tài liệu lớn ổn định, tiết kiệm mực. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "1.200 tờ (tối đa 3.200 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tính năng",
        "value": "Copy, In mạng, Scan màu mạng, Đảo 2 mặt tự động"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy Toshiba e-STUDIO 3528A" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy Toshiba e-STUDIO 3528A</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Toshiba e-STUDIO 3528A công suất trung bình cao 35 trang/phút, xử lý khối lượng tài liệu lớn ổn định, tiết kiệm mực.</p>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">35 trang/phút (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng màu 10.1 inch</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">1.200 tờ (tối đa 3.200 tờ)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tính năng</th>
              <td class="py-3 text-[14.5px] text-gray-600">Copy, In mạng, Scan màu mạng, Đảo 2 mặt tự động</td>
            </tr>
          </tbody>
        </table>
      </div>
