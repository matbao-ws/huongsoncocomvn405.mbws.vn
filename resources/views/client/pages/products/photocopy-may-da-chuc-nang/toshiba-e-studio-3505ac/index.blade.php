...
@section('meta_description', "Toshiba e-STUDIO 3505AC công suất in màu tốc độ cao 35 trang/phút, hỗ trợ in giấy dày lên đến 280 g/m2. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in/copy",
        "value": "35 trang/phút (Màu & Đen trắng)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy tối đa",
        "value": "A3 / SRA3 / Giấy Banner dài 1.2m"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ RAM / Ổ cứng",
        "value": "4 GB RAM + 320 GB HDD SED"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay nạp bản gốc",
        "value": "DSDF quét 2 mặt 1 lần siêu tốc"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy Màu Toshiba e-STUDIO 3505AC" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy Màu Toshiba e-STUDIO 3505AC</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Toshiba e-STUDIO 3505AC công suất in màu tốc độ cao 35 trang/phút, hỗ trợ in giấy dày lên đến 280 g/m2.</p>
