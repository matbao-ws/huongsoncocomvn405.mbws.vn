...
@section('meta_description', "Toshiba e-STUDIO 3028A thuộc thế hệ máy đa chức năng e-BRIDGE Next tiên tiến — sở hữu màn hình cảm ứng 10.1 inch, bảo mật cấp doanh nghiệp và... Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in/copy",
        "value": "30 trang/phút (A4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình điều khiển",
        "value": "Cảm ứng màu 10.1 inch tùy biến giao diện"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ xử lý",
        "value": "Intel Atom 1.33 GHz lõi kép, RAM 4 GB, SSD 128 GB tự mã hóa"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo mật",
        "value": "Chuẩn SED tự mã hóa dữ liệu FIPS 140-2"
      },
      {
        "@@type": "PropertyValue",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy Toshiba e-STUDIO 3028A" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy Toshiba e-STUDIO 3028A</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Toshiba e-STUDIO 3028A thuộc thế hệ máy đa chức năng e-BRIDGE Next tiên tiến — sở hữu màn hình cảm ứng 10.1 inch, bảo mật cấp doanh nghiệp và khả năng kết nối đám mây linh hoạt.</p>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">30 trang/phút (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng màu 10.1 inch tùy biến giao diện</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ xử lý</th>
              <td class="py-3 text-[14.5px] text-gray-600">Intel Atom 1.33 GHz lõi kép, RAM 4 GB, SSD 128 GB tự mã hóa</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảo mật</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chuẩn SED tự mã hóa dữ liệu FIPS 140-2</td>
            </tr>
          </tbody>
        </table>
      </div>
