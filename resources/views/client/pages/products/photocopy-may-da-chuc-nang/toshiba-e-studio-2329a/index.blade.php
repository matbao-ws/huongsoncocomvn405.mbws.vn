...
@section('canonical', url('/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2329a/'))
@section('jsonld')
...
<head>
  ...
  <title>Máy photocopy Toshiba e-STUDIO 2329A – e-STUDIO 2329A | Hương Sơn</title>
  <meta name="description" content="Toshiba e-STUDIO 2329A là dòng máy photocopy đen trắng đa chức năng khổ A3, thiết kế nhỏ gọn, dễ sử dụng với chức năng Template và dễ quản lý bằng TopAcces" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2329a/" />
  <meta property="og:type" content="product" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy photocopy Toshiba e-STUDIO 2329A – e-STUDIO 2329A | Hương Sơn" />
  <meta property="og:description" content="Toshiba e-STUDIO 2329A là dòng máy photocopy đen trắng đa chức năng khổ A3, thiết kế nhỏ gọn, dễ sử dụng với chức năng Template và dễ quản lý bằng TopAcces" />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2329a/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/products/toshiba-e-studio-2329a.jpg" alt="Máy photocopy Toshiba e-STUDIO 2329A" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy photocopy Toshiba e-STUDIO 2329A</h1>
