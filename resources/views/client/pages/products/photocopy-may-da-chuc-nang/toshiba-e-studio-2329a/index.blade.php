...
@section('title', "Máy photocopy Toshiba e-STUDIO 2329A Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Toshiba e-STUDIO 2329A là dòng máy photocopy đa chức năng A3 nhỏ gọn, hiệu quả và bền bỉ — tích hợp sẵn tính năng Copy, In mạng và... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2329a/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2329a/#product",
    "name": "Máy photocopy Toshiba e-STUDIO 2329A",
    "image": "https://huongsonco.com.vn/assets/images/products/toshiba-e-studio-2329a.jpg",
    ...
    "additionalProperty": [
      {
        ...
        "value": "Copy + In mạng (Network Print) + Scan màu mạng (Color Scan) + Tự động đảo mặt (Duplex)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in / sao chụp",
        "value": "23 trang/phút (A4), 14 trang/phút (A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
      ...
      },
      {
        ...
        "value": "Tùy chọn RADF MR-3032 nạp và đảo bản gốc tự động 50 tờ"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "1 khay x 250 tờ + Khay tay 100 tờ (Mở rộng tối đa 1.700 tờ với khay tùy chọn)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ vi xử lý & Bộ nhớ",
        "value": "Cortex A8 500 MHz, RAM 512 MB"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "GDI, PCL6 (tùy chọn), TWAIN / WIA Scan"
      },
      {
        "@@type": "PropertyValue",
        "name": "Chuẩn kết nối giao tiếp",
        "value": "USB 2.0 High Speed, 10/100 Base-T Ethernet (in và scan qua mạng)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tính năng bảo mật & Quản lý",
        "value": "Mã số quản lý 100 phòng ban/người dùng (Department Code), lọc địa chỉ IP/MAC"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định mức mực (Toner Yield)",
        "value": "Hộp mực T-2329P dung lượng khoảng 17.500 trang (độ phủ 5% A4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "575 x 540 x 402 mm | Trọng lượng: 27 kg (nhỏ gọn tối ưu bàn làm việc)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "12 – 24 tháng hoặc 80.000 bản chụp theo tiêu chuẩn hãng"
      },
      {
        "@@type": "PropertyValue",
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Toshiba e-STUDIO 2329A là dòng máy photocopy đa chức năng A3 nhỏ gọn, hiệu quả và bền bỉ — tích hợp sẵn tính năng Copy, In mạng và Scan màu, tối ưu chi phí vận hành cho văn phòng vừa và nhỏ.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy photocopy Toshiba e-STUDIO 2329A" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/toshiba-e-studio-2329a.jpg" alt="Máy photocopy Toshiba e-STUDIO 2329A" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Copy + In mạng (Network Print) + Scan màu mạng (Color Scan) + Tự động đảo mặt (Duplex)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in / sao chụp</th>
              <td class="py-3 text-[14.5px] text-gray-600">23 trang/phút (A4), 14 trang/phút (A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Tùy chọn RADF MR-3032 nạp và đảo bản gốc tự động 50 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">1 khay x 250 tờ + Khay tay 100 tờ (Mở rộng tối đa 1.700 tờ với khay tùy chọn)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ vi xử lý &amp; Bộ nhớ</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cortex A8 500 MHz, RAM 512 MB</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">GDI, PCL6 (tùy chọn), TWAIN / WIA Scan</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chuẩn kết nối giao tiếp</th>
              <td class="py-3 text-[14.5px] text-gray-600">USB 2.0 High Speed, 10/100 Base-T Ethernet (in và scan qua mạng)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tính năng bảo mật &amp; Quản lý</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mã số quản lý 100 phòng ban/người dùng (Department Code), lọc địa chỉ IP/MAC</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định mức mực (Toner Yield)</th>
              <td class="py-3 text-[14.5px] text-gray-600">Hộp mực T-2329P dung lượng khoảng 17.500 trang (độ phủ 5% A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">575 x 540 x 402 mm | Trọng lượng: 27 kg (nhỏ gọn tối ưu bàn làm việc)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">12 – 24 tháng hoặc 80.000 bản chụp theo tiêu chuẩn hãng</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-toshiba-e-studio-2329a-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="e-STUDIO 2329A" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-toshiba-e-studio-2329a-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-toshiba-e-studio-2329a-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy photocopy Toshiba e-STUDIO 2329A?</h2>
