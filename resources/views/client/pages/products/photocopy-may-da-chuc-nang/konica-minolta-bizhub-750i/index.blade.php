...
@section('title', "Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Konica Minolta bizhub 750i tốc độ 75 trang/phút, tích hợp bảo vệ dữ liệu chống mã độc Bitdefender cao cấp. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/konica-minolta-bizhub-750i/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/konica-minolta-bizhub-750i/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/konica-minolta-bizhub-750i/#product",
    "name": "Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i",
    "image": "https://huongsonco.com.vn/assets/images/products/119-may-photocopy-don-sac-da-chuc-nang-bizhub-750i.jpg",
    "model": "bizhub 750i",
    "sku": "KM-BIZHUB-750I",
    "category": "Máy photocopy đa chức năng",
    "description": "Konica Minolta bizhub 750i tốc độ 75 trang/phút, tích hợp bảo vệ dữ liệu chống mã độc Bitdefender cao cấp.",
    ...
    "additionalProperty": [
      {
        ...
        "value": "Copy + In mạng siêu tốc + Scan màu 2 mặt một lượt + Duplex"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in / sao chụp",
        "value": "75 trang/phút (khổ A4), 37 trang/phút (khổ A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "1.800 x 600 dpi; 1.200 x 1.200 dpi chân thực"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Màn hình cảm ứng màu 10.1 inch giao diện i-Series thông minh"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nạp & đảo bản gốc",
        "value": "Bộ nạp tài liệu tự động quét 1 lần 2 mặt Dual Scan dung lượng 300 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ scan",
        "value": "140 ipm (1 mặt) / 280 ipm (2 mặt)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy",
        "value": "Khay 1: 500 tờ, Khay 2: 500 tờ, Khay tay: 150 tờ (Mở rộng đến 6.650 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Cấu hình phần cứng",
        "value": "CPU Quad Core 1.8 GHz | RAM 8 GB | SSD 256 GB (chọn thêm 1 TB)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Ngôn ngữ in",
        "value": "PCL 6, PCL 5e/c, PostScript 3, XPS"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối",
        "value": "Ethernet 10/100/1000Base-T, USB 2.0 / 3.0"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo mật hàng đầu",
        "value": "Tích hợp công nghệ bảo mật Bitdefender, mã hóa SSD, xóa dữ liệu tự động"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định mức hộp mực",
        "value": "Mực TN-628 khoảng 40.000 trang A4 chuẩn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "615 x 688 x 961 mm | Trọng lượng: 100 kg"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Cơ quan chính phủ"
      },
      {
        "@@type": "Audience",
      ...
      {
        "@@type": "Audience",
        "audienceType": "Trung tâm dịch vụ in"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Konica Minolta bizhub 750i tốc độ 75 trang/phút, tích hợp bảo vệ dữ liệu chống mã độc Bitdefender cao cấp.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>bizhub 750i</strong> — sản xuất bởi Konica Minolta (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Cơ quan chính phủ, Ngân hàng, Trung tâm dịch vụ in</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/119-may-photocopy-don-sac-da-chuc-nang-bizhub-750i.jpg" alt="Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">bizhub 750i</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In ấn tài liệu phục vụ kỳ thi quốc gia, in đề thi và biểu mẫu bảo mật số lượng lớn</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Trung tâm xử lý tài liệu hành chính công tập trung cho các cơ quan đầu não</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In sao giáo trình, đề tài nghiên cứu cho trường đại học quy mô trên 10.000 sinh viên</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — bizhub 750i</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chức năng chuẩn</th>
              <td class="py-3 text-[14.5px] text-gray-600">Copy + In mạng siêu tốc + Scan màu 2 mặt một lượt + Duplex</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in / sao chụp</th>
              <td class="py-3 text-[14.5px] text-gray-600">75 trang/phút (khổ A4), 37 trang/phút (khổ A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.800 x 600 dpi; 1.200 x 1.200 dpi chân thực</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Màn hình cảm ứng màu 10.1 inch giao diện i-Series thông minh</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nạp &amp; đảo bản gốc</th>
              <td class="py-3 text-[14.5px] text-gray-600">Bộ nạp tài liệu tự động quét 1 lần 2 mặt Dual Scan dung lượng 300 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ scan</th>
              <td class="py-3 text-[14.5px] text-gray-600">140 ipm (1 mặt) / 280 ipm (2 mặt)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay chứa giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khay 1: 500 tờ, Khay 2: 500 tờ, Khay tay: 150 tờ (Mở rộng đến 6.650 tờ)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Cấu hình phần cứng</th>
              <td class="py-3 text-[14.5px] text-gray-600">CPU Quad Core 1.8 GHz | RAM 8 GB | SSD 256 GB (chọn thêm 1 TB)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Ngôn ngữ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">PCL 6, PCL 5e/c, PostScript 3, XPS</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối</th>
              <td class="py-3 text-[14.5px] text-gray-600">Ethernet 10/100/1000Base-T, USB 2.0 / 3.0</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảo mật hàng đầu</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tích hợp công nghệ bảo mật Bitdefender, mã hóa SSD, xóa dữ liệu tự động</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định mức hộp mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực TN-628 khoảng 40.000 trang A4 chuẩn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">615 x 688 x 961 mm | Trọng lượng: 100 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-konica-minolta-bizhub-750i-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="bizhub 750i" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-konica-minolta-bizhub-750i-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-konica-minolta-bizhub-750i-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i?</h2>
