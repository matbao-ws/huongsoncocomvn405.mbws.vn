...
@section('meta_description', "Konica Minolta bizhub 750i tốc độ 75 trang/phút, tích hợp bảo vệ dữ liệu chống mã độc Bitdefender cao cấp. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in/copy",
        "value": "75 trang/phút (A4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "1.200 x 1.200 dpi"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo mật",
        "value": "Tích hợp sẵn phần mềm quét mã độc Bitdefender Antivirus"
      },
      {
        "@@type": "PropertyValue",
        "name": "Dung lượng giấy tối đa",
        "value": "6.650 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ xử lý",
        "value": "Quad Core 1.6 GHz"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy Photocopy Đa Chức Năng Konica Minolta bizhub 750i</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Konica Minolta bizhub 750i tốc độ 75 trang/phút, tích hợp bảo vệ dữ liệu chống mã độc Bitdefender cao cấp.</p>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Konica Minolta bizhub 750i tốc độ 75 trang/phút, tích hợp bảo vệ dữ liệu chống mã độc Bitdefender cao cấp.</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">75 trang/phút (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.200 x 1.200 dpi</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảo mật</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tích hợp sẵn phần mềm quét mã độc Bitdefender Antivirus</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng giấy tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">6.650 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ xử lý</th>
              <td class="py-3 text-[14.5px] text-gray-600">Quad Core 1.6 GHz</td>
            </tr>
          </tbody>
        </table>
      </div>
