...
@section('meta_description', "Dòng máy photocopy đa chức năng màu cao cấp, tốc độ 30 trang/phút màu và đen trắng, bản in rực rỡ, chân thực. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in/copy",
        "value": "30 trang/phút (Màu & Đen trắng)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Cảm ứng 9 inch sắc nét"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ RAM / HDD",
        "value": "4 GB RAM + 320 GB HDD"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">30 trang/phút (Màu &amp; Đen trắng)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">A3 / SRA3</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng 9 inch sắc nét</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nhớ RAM / HDD</th>
              <td class="py-3 text-[14.5px] text-gray-600">4 GB RAM + 320 GB HDD</td>
            </tr>
          </tbody>
        </table>
      </div>
