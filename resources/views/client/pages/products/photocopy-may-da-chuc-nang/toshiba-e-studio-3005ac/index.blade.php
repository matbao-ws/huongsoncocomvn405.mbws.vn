...
@section('title', "Máy photocopy Màu Toshiba e-STUDIO 3005AC Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Dòng máy photocopy đa chức năng màu cao cấp, tốc độ 30 trang/phút màu và đen trắng, bản in rực rỡ, chân thực. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-3005ac/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-3005ac/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-3005ac/#product",
    "name": "Máy photocopy Màu Toshiba e-STUDIO 3005AC",
    "image": "https://huongsonco.com.vn/assets/images/products/72-e-studio3005ac.jpg",
    "model": "e-STUDIO 3005AC",
    "sku": "TOSHIBA-3005AC",
    "category": "Máy photocopy đa chức năng màu",
    "description": "Dòng máy photocopy đa chức năng màu cao cấp, tốc độ 30 trang/phút màu và đen trắng, bản in rực rỡ, chân thực.",
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "30 trang/phút Màu & Đen trắng (A4), 16 trang/phút (A3)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "600 x 600 dpi, 1.200 x 1.200 dpi (PS3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy hỗ trợ",
        "value": "A5-R đến A3, giấy Banner 1.200 mm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy",
        "value": "Khay chuẩn: 60 – 256 g/m²; Khay tay: 52 – 280 g/m²"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "RAM 4 GB + Ổ cứng 320 GB SED tự mã hóa"
      },
      {
        "@@type": "PropertyValue",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Phòng thiết kế"
      },
      {
        "@@type": "Audience",
        "audienceType": "Ban truyền thông"
      },
      {
        "@@type": "Audience",
        "audienceType": "Văn phòng tổng công ty"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy photocopy Màu Toshiba e-STUDIO 3005AC
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Dòng máy photocopy đa chức năng màu cao cấp, tốc độ 30 trang/phút màu và đen trắng, bản in rực rỡ, chân thực.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy photocopy Màu Toshiba e-STUDIO 3005AC" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>e-STUDIO 3005AC</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Phòng thiết kế, Ban truyền thông, Văn phòng tổng công ty</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/72-e-studio3005ac.jpg" alt="Máy photocopy Màu Toshiba e-STUDIO 3005AC" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy photocopy Màu Toshiba e-STUDIO 3005AC</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">e-STUDIO 3005AC</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="hover:text-[#1A9900]">Máy photocopy đa chức năng màu</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Dòng máy photocopy đa chức năng màu cao cấp, tốc độ 30 trang/phút màu và đen trắng, bản in rực rỡ, chân thực.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — e-STUDIO 3005AC</caption>
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">30 trang/phút Màu &amp; Đen trắng (A4), 16 trang/phút (A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">600 x 600 dpi, 1.200 x 1.200 dpi (PS3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">A5-R đến A3, giấy Banner 1.200 mm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khay chuẩn: 60 – 256 g/m²; Khay tay: 52 – 280 g/m²</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">RAM 4 GB + Ổ cứng 320 GB SED tự mã hóa</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-toshiba-e-studio-3005ac-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="e-STUDIO 3005AC" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-toshiba-e-studio-3005ac-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-toshiba-e-studio-3005ac-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy photocopy Màu Toshiba e-STUDIO 3005AC?</h2>
