...
@section('meta_description', "Konica Minolta bizhub 360i dòng máy đa chức năng cao cấp chuẩn Nhật Bản — thiết kế tinh tế, màn hình tablet mượt mà và khả năng vận... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/konica-minolta-bizhub-360i/"
      }
    ]
  },
  {
    ...
    "additionalProperty": [
      {
        ...
        "value": "Copy + In mạng + Scan mạng + Đảo mặt tự động Duplex"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in / sao chụp",
        "value": "36 trang/phút (khổ A4), 18 trang/phút (khổ A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "1.800 (tương đương) x 600 dpi; 1.200 x 1.200 dpi"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy hỗ trợ",
        "value": "A6 – A3, khổ tùy chỉnh (tối đa 297 x 432 mm)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy",
        "value": "52 – 300 g/m² (hỗ trợ giấy dày và bìa cứng)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình bảng điều khiển",
        "value": "Cảm ứng màu điện dung 10.1 inch xoay góc linh hoạt"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nạp & đảo bản gốc",
        "value": "Bộ nạp quét 2 mặt tự động DF-632 / Dual Scan DF-714 (tùy chọn)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Chức năng Duplex",
        "value": "Tích hợp sẵn tự động đảo hai mặt"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy tiêu chuẩn",
        "value": "2 khay x 500 tờ + Khay tay đa năng 150 tờ (Tổng 1.150 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ vi xử lý & Bộ nhớ",
        "value": "CPU Quad Core 1.8 GHz | RAM 8 GB | Ổ cứng SSD 256 GB"
      },
      {
        "@@type": "PropertyValue",
        "name": "Ngôn ngữ in",
        "value": "PCL 6 (XL3.0), PCL 5c, PostScript 3, XPS"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kết nối giao tiếp",
        "value": "10/100/1000Base-T Ethernet, USB 2.0, Wi-Fi 802.11 b/g/n (tùy chọn)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bảo mật cao cấp",
        "value": "Mã hóa dữ liệu SSD, lọc IP/MAC, xác thực người dùng, chuẩn ISO 15408"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định mức hộp mực",
        "value": "Mực TN-328K khoảng 28.000 trang (độ phủ 5%)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Kích thước & Trọng lượng",
        "value": "615 x 688 x 779 mm | Trọng lượng: 76 kg"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "bizhub 300i, bizhub 450i"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Phân phối chính thức bởi Hương Sơn."
      }
    ],
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Doanh nghiệp FDI"
      },
      {
        "@@type": "Audience",
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Konica Minolta bizhub 360i dòng máy đa chức năng cao cấp chuẩn Nhật Bản — thiết kế tinh tế, màn hình tablet mượt mà và khả năng vận hành siêu ổn định.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy photocopy Konica Minolta bizhub 360i" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>bizhub 360i</strong> — sản xuất bởi Konica Minolta (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Doanh nghiệp FDI, Tập đoàn, Ngân hàng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">bizhub 300i, bizhub 450i</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/konica-minolta-bizhub-360i.jpg" alt="Máy photocopy Konica Minolta bizhub 360i" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy photocopy Konica Minolta bizhub 360i</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">bizhub 360i</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Sao chụp và in ấn tài liệu quản trị văn phòng, hợp đồng kinh tế và hồ sơ dự án</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Số hóa tài liệu tốc độ cao với bộ nạp đảo hai mặt tự động một lượt quét</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quản lý in ấn bảo mật qua thẻ từ và mã PIN cho doanh nghiệp và ngân hàng</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — bizhub 360i</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chức năng chuẩn</th>
              <td class="py-3 text-[14.5px] text-gray-600">Copy + In mạng + Scan mạng + Đảo mặt tự động Duplex</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in / sao chụp</th>
              <td class="py-3 text-[14.5px] text-gray-600">36 trang/phút (khổ A4), 18 trang/phút (khổ A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.800 (tương đương) x 600 dpi; 1.200 x 1.200 dpi</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">A6 – A3, khổ tùy chỉnh (tối đa 297 x 432 mm)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">52 – 300 g/m² (hỗ trợ giấy dày và bìa cứng)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình bảng điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng màu điện dung 10.1 inch xoay góc linh hoạt</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nạp &amp; đảo bản gốc</th>
              <td class="py-3 text-[14.5px] text-gray-600">Bộ nạp quét 2 mặt tự động DF-632 / Dual Scan DF-714 (tùy chọn)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chức năng Duplex</th>
              <td class="py-3 text-[14.5px] text-gray-600">Tích hợp sẵn tự động đảo hai mặt</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay chứa giấy tiêu chuẩn</th>
              <td class="py-3 text-[14.5px] text-gray-600">2 khay x 500 tờ + Khay tay đa năng 150 tờ (Tổng 1.150 tờ)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ vi xử lý &amp; Bộ nhớ</th>
              <td class="py-3 text-[14.5px] text-gray-600">CPU Quad Core 1.8 GHz | RAM 8 GB | Ổ cứng SSD 256 GB</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Ngôn ngữ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">PCL 6 (XL3.0), PCL 5c, PostScript 3, XPS</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kết nối giao tiếp</th>
              <td class="py-3 text-[14.5px] text-gray-600">10/100/1000Base-T Ethernet, USB 2.0, Wi-Fi 802.11 b/g/n (tùy chọn)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bảo mật cao cấp</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mã hóa dữ liệu SSD, lọc IP/MAC, xác thực người dùng, chuẩn ISO 15408</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định mức hộp mực</th>
              <td class="py-3 text-[14.5px] text-gray-600">Mực TN-328K khoảng 28.000 trang (độ phủ 5%)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Kích thước &amp; Trọng lượng</th>
              <td class="py-3 text-[14.5px] text-gray-600">615 x 688 x 779 mm | Trọng lượng: 76 kg</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Xuất xứ / Nguồn</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Phân phối chính thức bởi Hương Sơn.</td></tr>
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">bizhub 300i, bizhub 450i</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-konica-minolta-bizhub-360i-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="bizhub 360i" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-konica-minolta-bizhub-360i-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-konica-minolta-bizhub-360i-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy photocopy Konica Minolta bizhub 360i?</h2>
