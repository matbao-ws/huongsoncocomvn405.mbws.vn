    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ",
        "value": "36 trang/phút (A4)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình",
        "value": "Cảm ứng 10.1 inch đa điểm dạng tablet"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ",
        "value": "RAM 8 GB, SSD 256 GB"
      },
      {
        "@@type": "PropertyValue",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy Konica Minolta bizhub 360i" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy Konica Minolta bizhub 360i</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Konica Minolta bizhub 360i dòng máy đa chức năng cao cấp chuẩn Nhật Bản — thiết kế tinh tế, màn hình tablet mượt mà và khả năng vận hành siêu ổn định.</p>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Môi trường làm việc thông minh (Smart Workplace) với khả năng di động cao</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Sao chụp khối lượng lớn tốc độ 36 bản/phút</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Tích hợp giải pháp quét diệt virus Bitdefender trên máy</span>
        </li>
      </ul>
        </div>
      </div>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">36 trang/phút (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng 10.1 inch đa điểm dạng tablet</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nhớ</th>
              <td class="py-3 text-[14.5px] text-gray-600">RAM 8 GB, SSD 256 GB</td>
            </tr>
          </tbody>
        </table>
      </div>
