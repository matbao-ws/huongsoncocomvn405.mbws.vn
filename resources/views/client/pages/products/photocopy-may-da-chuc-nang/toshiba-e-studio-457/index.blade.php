...
@section('meta_description', "Dòng máy photocopy kinh điển của Toshiba, tốc độ 45 trang/phút, độ bền nồi đồng cối đá, chi phí bản in cực rẻ. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ RAM / HDD",
        "value": "2 GB RAM + 320 GB HDD"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay nạp đảo bản gốc tự động",
        "value": "ARDF tích hợp sẵn"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy Toshiba e-STUDIO 457" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy Toshiba e-STUDIO 457</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Dòng máy photocopy kinh điển của Toshiba, tốc độ 45 trang/phút, độ bền nồi đồng cối đá, chi phí bản in cực rẻ.</p>
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">2 GB RAM + 320 GB HDD</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay nạp đảo bản gốc tự động</th>
              <td class="py-3 text-[14.5px] text-gray-600">ARDF tích hợp sẵn</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
