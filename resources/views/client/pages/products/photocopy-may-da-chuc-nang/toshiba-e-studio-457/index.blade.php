...
@section('title', "Máy photocopy Toshiba e-STUDIO 457 Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Dòng máy photocopy kinh điển của Toshiba, tốc độ 45 trang/phút, độ bền nồi đồng cối đá, chi phí bản in cực rẻ. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-457/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-457/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-457/#product",
    "name": "Máy photocopy Toshiba e-STUDIO 457",
    "image": "https://huongsonco.com.vn/assets/images/products/96-toshiba-e-studio-457.jpg",
    "model": "e-STUDIO 457",
    "sku": "TOSHIBA-457",
    "category": "Máy photocopy đa chức năng",
    "description": "Dòng máy photocopy kinh điển của Toshiba, tốc độ 45 trang/phút, độ bền nồi đồng cối đá, chi phí bản in cực rẻ.",
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "45 trang/phút (A4), 25 trang/phút (A3)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Màn hình bảng điều khiển",
        "value": "Cảm ứng LCD 9 inch sắc nét"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
      ...
      },
      {
        ...
        "value": "RADF 100 tờ nạp và đảo tự động"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy",
        "value": "2 khay x 550 tờ + Khay tay 100 tờ (Tổng 1.200 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ RAM / Ổ cứng",
        "value": "RAM 2 GB + Ổ cứng 320 GB Toshiba Secure HDD (SED tự mã hóa)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Ngôn ngữ in",
        "value": "PCL5e, PCL6, PostScript 3"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định mức mực",
        "value": "Hộp mực T-5070P (~36.600 trang A4)"
      },
      {
        "@@type": "PropertyValue",
    ...
    "audience": [
      ...
      {
        "@@type": "Audience",
        "audienceType": "Văn phòng hành chính"
      },
      {
        "@@type": "Audience",
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Dòng máy photocopy kinh điển của Toshiba, tốc độ 45 trang/phút, độ bền nồi đồng cối đá, chi phí bản in cực rẻ.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy photocopy Toshiba e-STUDIO 457" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>e-STUDIO 457</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Trường học, Văn phòng hành chính, Doanh nghiệp</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/96-toshiba-e-studio-457.jpg" alt="Máy photocopy Toshiba e-STUDIO 457" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy photocopy Toshiba e-STUDIO 457</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">e-STUDIO 457</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Dòng máy photocopy kinh điển của Toshiba, tốc độ 45 trang/phút, độ bền nồi đồng cối đá, chi phí bản in cực rẻ.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — e-STUDIO 457</caption>
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">45 trang/phút (A4), 25 trang/phút (A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Màn hình bảng điều khiển</th>
              <td class="py-3 text-[14.5px] text-gray-600">Cảm ứng LCD 9 inch sắc nét</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-toshiba-e-studio-457-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="e-STUDIO 457" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-toshiba-e-studio-457-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-toshiba-e-studio-457-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy photocopy Toshiba e-STUDIO 457?</h2>
