...
@section('meta_description', "Toshiba e-STUDIO 2829A đạt tốc độ 28 trang/phút, bền bỉ, tiết kiệm điện năng và mực in — dòng máy trục chính được tin dùng tại hàng trăm trường học và chi")
...
[
  ...
  },
  {
    ...
    "description": "Toshiba e-STUDIO 2829A đạt tốc độ 28 trang/phút, bền bỉ, tiết kiệm điện năng và mực in — dòng máy trục chính được tin dùng tại hàng trăm trường học và chi nhánh Vietcombank.",
    "brand": {
      "@@type": "Brand",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        "value": "Nhập khẩu chính hãng Toshiba Tec, phân phối ủy quyền tại miền Bắc bởi Hương Sơn."
      }
    ],
    "audience": [
      {
      ...
      {
        "@@type": "Audience",
        "audienceType": "Doanh nghiệp lớn"
      },
      {
        "@@type": "Audience",
        "audienceType": "Trường THPT/Đại học"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Toshiba e-STUDIO 2829A đạt tốc độ 28 trang/phút, bền bỉ, tiết kiệm điện năng và mực in — dòng máy trục chính được tin dùng tại hàng trăm trường học và chi nhánh Vietcombank.</p>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>e-STUDIO 2829A</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Ngân hàng, Cơ quan Nhà nước, Doanh nghiệp lớn, Trường THPT/Đại học</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Đáp ứng sản lượng in ấn 5.000–15.000 bản/tháng cho các phòng ban đông nhân sự</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Sao in tài liệu hội họp, báo cáo tài chính và hồ sơ đấu thầu</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Trang bị đồng bộ cho hệ thống chi nhánh ngân hàng (lô 127 máy trúng thầu Vietcombank)</span>
        </li>
      </ul>
        </div>
      </div>
