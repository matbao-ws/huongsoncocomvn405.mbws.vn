...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy – Máy đa chức năng A3/A4" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy – Máy đa chức năng A3/A4</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Máy photocopy đa chức năng A3/A4 từ các hãng Toshiba, Konica Minolta và Ricoh — copy, in, scan trong một thiết bị. Hương Sơn là đại lý ủy quyền phân phối chính thức Toshiba tại miền Bắc từ năm 2017 và đại lý Konica Minolta từ năm 2021.</p>
