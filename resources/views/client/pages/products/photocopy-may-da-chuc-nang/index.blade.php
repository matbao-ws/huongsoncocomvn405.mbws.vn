...
@section('canonical', url('/san-pham/photocopy-may-da-chuc-nang/'))
@section('jsonld')
...
<head>
  ...
  <title>Máy photocopy đa chức năng A3/A4 – Toshiba, Konica Minolta, Ricoh | Hương Sơn</title>
  <meta name="description" content="Máy photocopy đa chức năng A3/A4 các hãng Toshiba, Konica Minolta, Ricoh – copy, in, scan trong một thiết bị. Bán, cho thuê và bảo trì, có phụ tùng chính hãng." />
  <meta name="keywords" content="máy photocopy, máy photocopy văn phòng, máy photocopy đa chức năng, máy photocopy A3, máy photocopy Toshiba, máy photocopy Ricoh, máy photocopy Konica Minolta, báo giá máy photocopy, tư vấn chọn máy photocopy, máy photocopy nào tốt, thuê máy photocopy, thuê máy photocopy Hà Nội" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy photocopy đa chức năng A3/A4 – Toshiba, Konica Minolta, Ricoh | Hương Sơn" />
  <meta property="og:description" content="Máy photocopy đa chức năng A3/A4 các hãng Toshiba, Konica Minolta, Ricoh – copy, in, scan trong một thiết bị. Bán, cho thuê và bảo trì, có phụ tùng chính hãng." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Máy photocopy – Máy đa chức năng A3/A4" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Office Equipment</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy photocopy – Máy đa chức năng A3/A4</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Máy photocopy đa chức năng A3/A4 từ các hãng Toshiba, Konica Minolta và Ricoh — copy, in, scan trong một thiết bị. Hương Sơn là đại lý ủy quyền phân phối chính thức Toshiba tại miền Bắc từ năm 2017 và đại lý Konica Minolta từ năm 2021.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy photocopy – Máy đa chức năng A3/A4</span>
      </nav>
    </div>
  </section>
