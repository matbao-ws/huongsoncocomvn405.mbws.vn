...
@section('meta_description', "Toshiba e-STUDIO 2500AC là giải pháp in màu đa chức năng khổ A3 hoàn hảo cho các doanh nghiệp cần tài liệu màu chuyên nghiệp với chi phí vận... Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
    ...
    "additionalProperty": [
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ",
        "value": "25 trang/phút (cả Màu và Đen trắng)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Công nghệ màu",
        "value": "e-BRIDGE Color thế hệ mới cho màu sắc chân thực"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy",
        "value": "A5-R đến A3, hỗ trợ banner dài 1.2m"
      },
      {
        "@@type": "PropertyValue",
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ</th>
              <td class="py-3 text-[14.5px] text-gray-600">25 trang/phút (cả Màu và Đen trắng)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công nghệ màu</th>
              <td class="py-3 text-[14.5px] text-gray-600">e-BRIDGE Color thế hệ mới cho màu sắc chân thực</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">A5-R đến A3, hỗ trợ banner dài 1.2m</td>
            </tr>
          </tbody>
        </table>
      </div>
