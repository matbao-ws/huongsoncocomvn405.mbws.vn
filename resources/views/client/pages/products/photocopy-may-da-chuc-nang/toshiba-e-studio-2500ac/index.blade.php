...
@section('title', "Máy photocopy Màu Toshiba e-STUDIO 2500AC Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Toshiba e-STUDIO 2500AC là giải pháp in màu đa chức năng khổ A3 hoàn hảo cho các doanh nghiệp cần tài liệu màu chuyên nghiệp với chi... Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2500ac/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2500ac/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-2500ac/#product",
    "name": "Máy photocopy Màu Toshiba e-STUDIO 2500AC",
    "image": "https://huongsonco.com.vn/assets/images/products/toshiba-e-studio-2500ac.jpg",
    "model": "e-STUDIO 2500AC",
    "sku": "TOSHIBA-2500AC",
    "category": "Máy photocopy Màu đa chức năng",
    "description": "Toshiba e-STUDIO 2500AC là giải pháp in màu đa chức năng khổ A3 hoàn hảo cho các doanh nghiệp cần tài liệu màu chuyên nghiệp với chi phí vận hành tối ưu.",
    ...
    "additionalProperty": [
      {
        ...
        "value": "Copy Màu + In Màu mạng + Scan Màu mạng + Đảo mặt tự động"
      },
      {
        "@@type": "PropertyValue",
        "name": "Tốc độ in / sao chụp",
        "value": "25 trang/phút Màu & Đen trắng (A4), 15 trang/phút (A3)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "600 x 600 dpi, 1.200 x 1.200 dpi (PS3), 3.600 x 1.200 dpi (với Smoothing)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khổ giấy hỗ trợ",
        "value": "A5-R đến A3, hỗ trợ giấy Banner dài 1.200 mm"
      },
      {
        "@@type": "PropertyValue",
        "name": "Định lượng giấy",
        "value": "Khay chuẩn: 60 – 163 g/m²; Khay tay (Bypass): 60 – 209 g/m²"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nạp & đảo bản gốc",
        "value": "RADF 100 tờ hoặc DSDF 300 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy",
        "value": "1 khay x 250 tờ + Khay tay 100 tờ (Mở rộng tới 2.900 tờ)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ RAM / Ổ cứng",
        "value": "RAM 4 GB + Ổ cứng 320 GB Toshiba Secure HDD (SED tự mã hóa)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Ngôn ngữ in",
        "value": "PCL5c, PCL6, PostScript 3, PDF, XPS"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ & Bảo hành",
        "value": "Chính hãng Toshiba Tec Nhật Bản, bảo hành 12 - 24 tháng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Model tương thích",
        "value": "Toshiba e-STUDIO 3005AC, Toshiba e-STUDIO 3505AC"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    "audience": [
      {
        "@@type": "Audience",
        "audienceType": "Công ty thiết kế"
      },
      {
        "@@type": "Audience",
        "audienceType": "Truyền thông"
      },
      {
        "@@type": "Audience",
        "audienceType": "Văn phòng hiện đại"
      },
      {
        "@@type": "Audience",
        "audienceType": "Trường quốc tế"
      }
    ],
    "seller": {
      "@@id": "https://huongsonco.com.vn/#organization"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <h1 class="text-2xl sm:text-[34px] lg:text-[40px] font-extrabold text-white mb-3.5 leading-[1.35] tracking-normal drop-shadow-md">
            Máy photocopy Màu Toshiba e-STUDIO 2500AC
          </h1>
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Toshiba e-STUDIO 2500AC là giải pháp in màu đa chức năng khổ A3 hoàn hảo cho các doanh nghiệp cần tài liệu màu chuyên nghiệp với chi phí vận hành tối ưu.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy photocopy Màu Toshiba e-STUDIO 2500AC" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>e-STUDIO 2500AC</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Công ty thiết kế, Truyền thông, Văn phòng hiện đại, Trường quốc tế</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Model tương thích</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Toshiba e-STUDIO 3005AC, Toshiba e-STUDIO 3505AC</p>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/toshiba-e-studio-2500ac.jpg" alt="Máy photocopy Màu Toshiba e-STUDIO 2500AC" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy photocopy Màu Toshiba e-STUDIO 2500AC</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">e-STUDIO 2500AC</dd></div>
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/photocopy-may-da-chuc-nang/" class="hover:text-[#1A9900]">Máy photocopy Màu đa chức năng</a></dd></div>
          </dl>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">In ấn phẩm catalogue, brochure, tài liệu thuyết trình màu chất lượng cao</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">In bản vẽ thiết kế, phối cảnh kiến trúc và tài liệu marketing khổ A3</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Quản lý định mức in màu/đen trắng riêng biệt theo phòng ban</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — e-STUDIO 2500AC</caption>
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chức năng chuẩn</th>
              <td class="py-3 text-[14.5px] text-gray-600">Copy Màu + In Màu mạng + Scan Màu mạng + Đảo mặt tự động</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Tốc độ in / sao chụp</th>
              <td class="py-3 text-[14.5px] text-gray-600">25 trang/phút Màu &amp; Đen trắng (A4), 15 trang/phút (A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">600 x 600 dpi, 1.200 x 1.200 dpi (PS3), 3.600 x 1.200 dpi (với Smoothing)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khổ giấy hỗ trợ</th>
              <td class="py-3 text-[14.5px] text-gray-600">A5-R đến A3, hỗ trợ giấy Banner dài 1.200 mm</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Định lượng giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khay chuẩn: 60 – 163 g/m²; Khay tay (Bypass): 60 – 209 g/m²</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nạp &amp; đảo bản gốc</th>
              <td class="py-3 text-[14.5px] text-gray-600">RADF 100 tờ hoặc DSDF 300 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay chứa giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">1 khay x 250 tờ + Khay tay 100 tờ (Mở rộng tới 2.900 tờ)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nhớ RAM / Ổ cứng</th>
              <td class="py-3 text-[14.5px] text-gray-600">RAM 4 GB + Ổ cứng 320 GB Toshiba Secure HDD (SED tự mã hóa)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Ngôn ngữ in</th>
              <td class="py-3 text-[14.5px] text-gray-600">PCL5c, PCL6, PostScript 3, PDF, XPS</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Xuất xứ &amp; Bảo hành</th>
              <td class="py-3 text-[14.5px] text-gray-600">Chính hãng Toshiba Tec Nhật Bản, bảo hành 12 - 24 tháng</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full min-w-[640px] border border-gray-200 bg-white">
          ...
          <tbody>
            ...
            <tr class="border-b border-gray-200 last:border-0 hover:bg-gray-50"><th scope="row" class="text-left px-5 py-3.5 text-[14px] font-semibold text-[#181923] align-top">Model tương thích</th><td class="px-5 py-3.5 text-[14.5px] text-gray-600 align-top">Toshiba e-STUDIO 3005AC, Toshiba e-STUDIO 3505AC</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-toshiba-e-studio-2500ac-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="e-STUDIO 2500AC" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-toshiba-e-studio-2500ac-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-toshiba-e-studio-2500ac-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy photocopy Màu Toshiba e-STUDIO 2500AC?</h2>
