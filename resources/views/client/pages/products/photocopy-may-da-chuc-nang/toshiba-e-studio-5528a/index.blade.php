...
[
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy chuẩn",
        "value": "1.200 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Độ phân giải",
        "value": "3.600 x 1.200 dpi"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
        ...
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">55 trang/phút (A4)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Công suất tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">100.000 bản/tháng</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nhớ RAM</th>
              <td class="py-3 text-[14.5px] text-gray-600">4 GB RAM</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay chứa giấy chuẩn</th>
              <td class="py-3 text-[14.5px] text-gray-600">1.200 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Độ phân giải</th>
              <td class="py-3 text-[14.5px] text-gray-600">3.600 x 1.200 dpi</td>
            </tr>
          </tbody>
        </table>
      </div>
