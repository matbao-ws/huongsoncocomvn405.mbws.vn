...
@section('title', "Máy photocopy Toshiba e-STUDIO 4528A Chính Hãng | Thông Số & Báo Giá | Hương Sơn")
@section('meta_description', "Toshiba e-STUDIO 4528A tốc độ 45 trang/phút, chuyên dụng cho văn phòng nhiều người dùng và khối in ấn cường độ cao. Cung cấp bởi Hương Sơn, cam kết chất lượng tiêu chuẩn, bảo hành và hỗ trợ kỹ thuật tận nơi.")
@section('canonical', "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-4528a/")
@section('jsonld')
  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-4528a/"
      }
    ]
  },
  {
    "@@context": "https://schema.org",
    "@@type": "Product",
    "@@id": "https://huongsonco.com.vn/san-pham/photocopy-may-da-chuc-nang/toshiba-e-studio-4528a/#product",
    "name": "Máy photocopy Toshiba e-STUDIO 4528A",
    "image": "https://huongsonco.com.vn/assets/images/products/61-may-photocopy-toshiba-e-studio-4518a.jpg",
    "model": "e-STUDIO 4528A",
    "sku": "TOSHIBA-4528A",
    "category": "Máy photocopy đa chức năng",
    "description": "Toshiba e-STUDIO 4528A tốc độ 45 trang/phút, chuyên dụng cho văn phòng nhiều người dùng và khối in ấn cường độ cao.",
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "45 trang/phút (A4), 22 trang/phút (A3)"
      },
      {
        "@@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Khoảng 16 giây / Khoảng 3.6 giây"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nạp & đảo bản gốc tự động",
        "value": "DSDF 300 tờ (Dual Scan quét 2 mặt đồng thời 240 ảnh/phút)"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy",
      ...
      },
      {
        ...
        "value": "Chính hãng Toshiba Tec Nhật Bản, bảo hành 12 - 24 tháng / 180.000 bản chụp"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-left">
          ...
          <p class="text-gray-200 text-[14.5px] sm:text-base leading-relaxed mb-6 font-normal max-w-2xl">Toshiba e-STUDIO 4528A tốc độ 45 trang/phút, chuyên dụng cho văn phòng nhiều người dùng và khối in ấn cường độ cao.</p>
          ...
          <div class="relative mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div class="relative bg-gradient-to-b from-white/[0.12] to-white/[0.04] border border-white/20 p-5 sm:p-6 backdrop-blur-xl shadow-2xl overflow-hidden group">
              ...
              <div class="pt-6 pb-2 px-2 flex items-center justify-center min-h-[200px] sm:min-h-[230px]">
                <img src="/assets/images/banners/toshiba_mfp_product_1787905812744.jpg" alt="Máy photocopy Toshiba e-STUDIO 4528A" class="max-h-[190px] sm:max-h-[220px] w-auto object-contain mx-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] transform group-hover:scale-105 transition-transform duration-500" loading="eager" />
              </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed"><strong>e-STUDIO 4528A</strong> — sản xuất bởi Toshiba (Nhật Bản)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dùng cho</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Tổng công ty, Viện nghiên cứu, Ngân hàng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div class="lg:col-span-5">
          <div class="border border-gray-200 bg-white p-4">
            <img src="/assets/images/products/61-may-photocopy-toshiba-e-studio-4518a.jpg" alt="Máy photocopy Toshiba e-STUDIO 4528A" loading="lazy" class="w-full h-auto object-contain" />
          </div>
        </div>
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Tên chuẩn</dt><dd class="text-[15px] font-semibold text-[#181923]">Máy photocopy Toshiba e-STUDIO 4528A</dd></div>
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Model</dt><dd class="text-[15px] font-semibold text-[#181923]">e-STUDIO 4528A</dd></div>
        ...
        <li class="flex items-start space-x-3">
          ...
          <span class="text-[15px] text-gray-600 leading-relaxed">Toshiba e-STUDIO 4528A tốc độ 45 trang/phút, chuyên dụng cho văn phòng nhiều người dùng và khối in ấn cường độ cao.</span>
        </li>
      </ul>
        </div>
      </div>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          <caption class="text-left px-5 py-4 bg-[#181924] text-white text-sm font-bold uppercase tracking-wider">Thông số kỹ thuật — e-STUDIO 4528A</caption>
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">45 trang/phút (A4), 22 trang/phút (A3)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 16 giây / Khoảng 3.6 giây</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nạp &amp; đảo bản gốc tự động</th>
              <td class="py-3 text-[14.5px] text-gray-600">DSDF 300 tờ (Dual Scan quét 2 mặt đồng thời 240 ảnh/phút)</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              ...
              <td class="py-3 text-[14.5px] text-gray-600">Chính hãng Toshiba Tec Nhật Bản, bảo hành 12 - 24 tháng / 180.000 bản chụp</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="model-toshiba-e-studio-4528a-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="product_model" />
          <input type="hidden" name="product_model" value="e-STUDIO 4528A" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-model-toshiba-e-studio-4528a-hp">Bỏ trống ô này</label>
            <input type="text" id="f-model-toshiba-e-studio-4528a-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/banners/hero_office_solutions_1787899910391.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="max-w-2xl text-center lg:text-left">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">Cần báo giá cho Máy photocopy Toshiba e-STUDIO 4528A?</h2>
