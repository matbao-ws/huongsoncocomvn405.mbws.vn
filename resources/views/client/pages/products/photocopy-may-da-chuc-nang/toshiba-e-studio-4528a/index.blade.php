...
@section('meta_description', "Toshiba e-STUDIO 4528A tốc độ 45 trang/phút, chuyên dụng cho văn phòng nhiều người dùng và khối in ấn cường độ cao. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ vi xử lý",
        "value": "Intel Atom 1.33 GHz lõi kép"
      },
      {
        "@@type": "PropertyValue",
        "name": "Bộ nhớ RAM / Ổ cứng",
        "value": "4 GB RAM + 128 GB SSD"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay nạp bản gốc",
        "value": "DSDF quét 2 mặt cùng lúc 240 ảnh/phút"
      },
      {
        "@@type": "PropertyValue",
        "name": "Khay chứa giấy",
        "value": "2 khay x 550 tờ + khay tay 100 tờ"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
...
<!-- PAGE HERO -->
  <section class="relative min-h-[320px] sm:min-h-[380px] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #10203C 0%, #193877 60%, #204DA4 100%);">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/hero-office.jpg" alt="Máy photocopy Toshiba e-STUDIO 4528A" class="w-full h-full object-cover object-center opacity-25" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 w-full text-center">
      ...
      <h1 class="text-2xl sm:text-[38px] lg:text-[42px] font-bold text-white mb-4 leading-tight tracking-tight drop-shadow-sm">Máy photocopy Toshiba e-STUDIO 4528A</h1>
      <p class="max-w-3xl mx-auto text-gray-200 text-[15px] sm:text-[16px] leading-relaxed">Toshiba e-STUDIO 4528A tốc độ 45 trang/phút, chuyên dụng cho văn phòng nhiều người dùng và khối in ấn cường độ cao.</p>
      ...
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ vi xử lý</th>
              <td class="py-3 text-[14.5px] text-gray-600">Intel Atom 1.33 GHz lõi kép</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Bộ nhớ RAM / Ổ cứng</th>
              <td class="py-3 text-[14.5px] text-gray-600">4 GB RAM + 128 GB SSD</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay nạp bản gốc</th>
              <td class="py-3 text-[14.5px] text-gray-600">DSDF quét 2 mặt cùng lúc 240 ảnh/phút</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Khay chứa giấy</th>
              <td class="py-3 text-[14.5px] text-gray-600">2 khay x 550 tờ + khay tay 100 tờ</td>
            </tr>
          </tbody>
        </table>
      </div>
