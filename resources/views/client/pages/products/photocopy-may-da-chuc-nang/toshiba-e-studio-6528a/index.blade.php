...
@section('meta_description', "Toshiba e-STUDIO 6528A tốc độ 65 trang/phút, đỉnh cao hiệu năng in ấn công nghiệp nhẹ cho văn phòng và trung tâm dữ liệu. Phân phối chính hãng bởi Hương Sơn, đầy đủ CO/CQ và bảo hành.")
...
[
  ...
  },
  {
    ...
    "additionalProperty": [
      ...
      {
        "@@type": "PropertyValue",
        "name": "Chu kỳ hoạt động",
        "value": "120.000 bản/tháng"
      },
      {
        "@@type": "PropertyValue",
        "name": "Xuất xứ / Nguồn",
      ...
      <div class="overflow-x-auto border border-gray-200">
        <table class="w-full min-w-[520px] bg-white">
          ...
          <tbody class="px-5">
            ...
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Thời gian khởi động</th>
              <td class="py-3 text-[14.5px] text-gray-600">Khoảng 15 giây</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Dung lượng giấy tối đa</th>
              <td class="py-3 text-[14.5px] text-gray-600">5.200 tờ</td>
            </tr>
            <tr class="border-b border-gray-200 last:border-0">
              <th scope="row" class="text-left align-top py-3 pr-6 w-[42%] text-[14px] font-semibold text-[#181923]">Chu kỳ hoạt động</th>
              <td class="py-3 text-[14.5px] text-gray-600">120.000 bản/tháng</td>
            </tr>
          </tbody>
        </table>
      </div>
