...
@section('title', "Máy phối trang Duplo DFC – thiết bị hoàn thiện sau in | Hương Sơn")
@section('meta_description', "Máy phối trang, đóng ghim Duplo DFC dùng để sắp xếp tài liệu, phối đề thi tự động, thay cho phối thủ công. Hương Sơn là đại lý phân phối Duplo tại miền Bắc.")
@section('canonical', url('/san-pham/may-phoi-trang-hoan-thien-sau-in/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/"
    }
  ]
}</script>
<script type="application/ld+json">{
  ...
  "itemListElement": [
    {
      ...
      "url": "https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/"
    }
  ]
}</script>
<script type="application/ld+json">{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Máy phối trang dùng khi nào?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Khi cần ghép nhiều trang đã in rời thành một bộ hoàn chỉnh theo đúng thứ tự và số lượng — điển hình là phối đề thi hoặc đóng bộ tài liệu, giáo trình số lượng lớn."
      }
    },
    {
      "@type": "Question",
      "name": "Có thể kết hợp với máy in nhân bản Duplo không?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Có, đây là mô hình phổ biến: máy in nhân bản in ra các trang rời, sau đó máy phối trang ghép thành bộ."
      }
    }
  ]
}</script>
...
<head>
  ...
  <title>Máy phối trang Duplo DFC – thiết bị hoàn thiện sau in | Hương Sơn</title>
  <meta name="description" content="Máy phối trang, đóng ghim Duplo DFC dùng để sắp xếp tài liệu, phối đề thi tự động, thay cho phối thủ công. Hương Sơn là đại lý phân phối Duplo tại miền Bắc." />
  <meta name="keywords" content="máy phối trang, máy sắp xếp tài liệu, máy đóng ghim tài liệu, máy gấp giấy, thiết bị sau in, finishing thiết bị in, giải pháp finishing tài liệu, máy đóng sách tài liệu" />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy phối trang Duplo DFC – thiết bị hoàn thiện sau in | Hương Sơn" />
  <meta property="og:description" content="Máy phối trang, đóng ghim Duplo DFC dùng để sắp xếp tài liệu, phối đề thi tự động, thay cho phối thủ công. Hương Sơn là đại lý phân phối Duplo tại miền Bắc." />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Máy phối trang – thiết bị hoàn thiện sau in" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy phối trang – thiết bị hoàn thiện sau in</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Máy phối trang Duplo DFC dùng để tự động sắp xếp và ghép các trang tài liệu đã in thành bộ theo đúng thứ tự, thay cho việc phối thủ công — dùng nhiều cho phối đề thi và đóng bộ tài liệu số lượng lớn.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy phối trang – thiết bị hoàn thiện sau in</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Danh mục máy phối trang và thiết bị hoàn thiện sau in Duplo mà Hương Sơn phân phối.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Đơn vị có nhu cầu phối đề thi, đóng bộ tài liệu hoặc hoàn thiện ấn phẩm số lượng lớn.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Giải quyết vấn đề gì</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Thay thế công đoạn phối trang thủ công vốn chậm và dễ sai sót bằng thiết bị tự động.</p>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Thiết bị hoàn thiện sau in giúp giảm thời gian và sai sót khi phối trang, đóng ghim tài liệu số lượng lớn.</p><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        ...
        <article class="border border-gray-200/80 group flex flex-col" style="background-color: rgb(247, 243, 238);">
          ...
          <div class="p-6 flex flex-col flex-1">
            ...
            <h3 class="text-[17px] font-bold text-[#181923] mb-2.5 group-hover:text-[#1A9900] transition leading-snug">
              <a href="/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/">Máy phối trang (sắp xếp tài liệu) Duplo DFC-122</a>
            </h3>
            ...
            <a href="/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/" class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider hover:underline">
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-3">
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Máy phối trang dùng khi nào?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Khi cần ghép nhiều trang đã in rời thành một bộ hoàn chỉnh theo đúng thứ tự và số lượng — điển hình là phối đề thi hoặc đóng bộ tài liệu, giáo trình số lượng lớn.</div>
        </details>
        <details class="group border border-gray-200 bg-white">
          <summary class="flex items-start justify-between gap-4 cursor-pointer px-5 py-4 list-none">
            <span class="text-[15.5px] font-bold text-[#181923] group-open:text-[#1A9900] transition">Có thể kết hợp với máy in nhân bản Duplo không?</span>
            <i class="fa-solid fa-plus text-[#1A9900] text-xs mt-1.5 flex-shrink-0 group-open:rotate-45 transition-transform"></i>
          </summary>
          <div class="px-5 pb-5 text-[14.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-4">Có, đây là mô hình phổ biến: <a class="text-[#1A9900] font-medium hover:underline" href="/san-pham/may-in-nhan-ban-toc-do-cao/">máy in nhân bản</a> in ra các trang rời, sau đó máy phối trang ghép thành bộ.</div>
        </details>
      </div>
        </div>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="cat-may-phoi-trang-hoan-thien-sau-in-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-cat-may-phoi-trang-hoan-thien-sau-in-hp">Bỏ trống ô này</label>
            <input type="text" id="f-cat-may-phoi-trang-hoan-thien-sau-in-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
