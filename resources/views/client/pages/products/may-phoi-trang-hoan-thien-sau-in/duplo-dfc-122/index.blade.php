...
@section('canonical', url('/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/"
    }
  ]
}</script>
<script type="application/ld+json">{
  "@context": "https://schema.org",
  "@type": "Product",
  "@id": "https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/#product",
  "name": "Máy phối trang (sắp xếp tài liệu) Duplo DFC-122",
  "model": "DFC-122",
  "sku": "DUPLO-DFC122",
...
<head>
  ...
  <title>Máy phối trang (sắp xếp tài liệu) Duplo DFC-122 – DFC-122 | Hương Sơn</title>
  <meta name="description" content="Máy phối trang Duplo DFC-122 tự động sắp xếp các trang tài liệu đã in thành bộ theo đúng thứ tự, thay cho việc phối thủ công — thường dùng kèm máy in nhân " />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/" />
  <meta property="og:type" content="product" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Máy phối trang (sắp xếp tài liệu) Duplo DFC-122 – DFC-122 | Hương Sơn" />
  <meta property="og:description" content="Máy phối trang Duplo DFC-122 tự động sắp xếp các trang tài liệu đã in thành bộ theo đúng thứ tự, thay cho việc phối thủ công — thường dùng kèm máy in nhân " />
  <meta property="og:url" content="https://huongsonco.com.vn/san-pham/may-phoi-trang-hoan-thien-sau-in/duplo-dfc-122/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/products/duplo-dfc-122.jpg" alt="Máy phối trang (sắp xếp tài liệu) Duplo DFC-122" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Máy phối trang (sắp xếp tài liệu) Duplo DFC-122</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Máy phối trang Duplo DFC-122 tự động sắp xếp các trang tài liệu đã in thành bộ theo đúng thứ tự, thay cho việc phối thủ công — thường dùng kèm máy in nhân bản siêu tốc Duplo.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/" class="hover:text-white transition">Sản phẩm</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/san-pham/may-phoi-trang-hoan-thien-sau-in/" class="hover:text-white transition">Máy phối trang – thiết bị hoàn thiện sau in</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Máy phối trang (sắp xếp tài liệu) Duplo DFC-122</span>
      </nav>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-7">
          <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            ...
            <div><dt class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1">Danh mục</dt><dd class="text-[15px] font-semibold text-[#181923]"><a href="/san-pham/may-phoi-trang-hoan-thien-sau-in/" class="hover:text-[#1A9900]">Máy phối trang – Hoàn thiện sau in</a></dd></div>
          </dl>
  ...
  <section class="py-14 bg-[#181924] bg-cover bg-center" style="background-image: linear-gradient(rgba(24,25,36,0.92), rgba(24,25,36,0.96)), url('/assets/images/xxx_home-bg_xxx.jpg');">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
      ...
      <div class="flex flex-wrap items-center gap-4 flex-shrink-0">
        ...
        <a href="/san-pham/may-phoi-trang-hoan-thien-sau-in/" class="border border-gray-500 hover:border-[#1A9900] hover:text-[#1A9900] text-white font-bold text-xs uppercase tracking-wider px-8 py-4 transition">Xem Máy phối trang – thiết bị hoàn thiện sau in</a>
