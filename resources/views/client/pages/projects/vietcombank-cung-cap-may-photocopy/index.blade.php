...
@section('title', "Hương Sơn cung cấp máy photocopy cho hệ thống Vietcombank toàn quốc | Hương Sơn")
@section('meta_description', "Hương Sơn đã cung cấp máy photocopy Konica Minolta (2022–2023) và lô 127 máy Toshiba (2024) cho hệ thống Ngân hàng Vietcombank toàn quốc.")
@section('canonical', url('/du-an/vietcombank-cung-cap-may-photocopy/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/du-an/vietcombank-cung-cap-may-photocopy/"
    }
  ]
}</script>
<script type="application/ld+json">{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Cung cấp máy photocopy cho hệ thống Ngân hàng Vietcombank toàn quốc",
  "description": "Theo thông tin Hương Sơn tự công bố công khai trên website huongsonco.com.vn, năm 2022–2023 Hương Sơn đã cung cấp cho hệ thống Ngân hàng Vietcombank lô máy photocopy Konica Minolta; năm 2024 tiếp tục cung cấp lô 127 máy photocopy Toshiba cho hệ thống Vietcombank toàn quốc.",
  "datePublished": "2022 – 2024",
  "dateModified": "2022 – 2024",
  "author": {
    "@id": "https://huongsonco.com.vn/#organization"
  },
  "publisher": {
  ...
  "mainEntityOfPage": "https://huongsonco.com.vn/du-an/vietcombank-cung-cap-may-photocopy/",
  "inLanguage": "vi-VN"
}</script>
@endsection
...
<head>
  ...
  <title>Hương Sơn cung cấp máy photocopy cho hệ thống Vietcombank toàn quốc | Hương Sơn</title>
  <meta name="description" content="Hương Sơn đã cung cấp máy photocopy Konica Minolta (2022–2023) và lô 127 máy Toshiba (2024) cho hệ thống Ngân hàng Vietcombank toàn quốc." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/du-an/vietcombank-cung-cap-may-photocopy/" />
  <meta property="og:type" content="article" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Hương Sơn cung cấp máy photocopy cho hệ thống Vietcombank toàn quốc | Hương Sơn" />
  <meta property="og:description" content="Hương Sơn đã cung cấp máy photocopy Konica Minolta (2022–2023) và lô 127 máy Toshiba (2024) cho hệ thống Ngân hàng Vietcombank toàn quốc." />
  <meta property="og:url" content="https://huongsonco.com.vn/du-an/vietcombank-cung-cap-may-photocopy/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Cung cấp máy photocopy cho hệ thống Ngân hàng Vietcombank toàn quốc" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Case Study Ngân hàng</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Cung cấp máy photocopy cho hệ thống Ngân hàng Vietcombank toàn quốc</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Ngân hàng TMCP Ngoại thương Việt Nam (Vietcombank) – hệ thống toàn quốc · 2022 – 2024</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/du-an/" class="hover:text-white transition">Dự án</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Cung cấp máy photocopy cho hệ thống Ngân hàng Vietcombank toàn quốc</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-12  " style="background-color: rgb(247, 243, 238);">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Ngân hàng TMCP Ngoại thương Việt Nam (Vietcombank) – hệ thống toàn quốc</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Nhiệm vụ</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Cung cấp máy photocopy cho hệ thống chi nhánh và phòng giao dịch toàn quốc</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Thiết bị</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Máy photocopy Konica Minolta (2022–2023); lô 127 máy photocopy Toshiba (2024)</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Thời gian</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">2022 – 2024</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Giá trị</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Không công bố giá trị hợp đồng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Hồ sơ</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Tự công bố công khai trên website huongsonco.com.vn (mục Tin tức – Sự kiện)</p>
          </div></div>
    </div>
  </section>

  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-10 max-w-4xl">Theo thông tin Hương Sơn tự công bố công khai trên website huongsonco.com.vn, năm 2022–2023 Hương Sơn đã cung cấp cho hệ thống Ngân hàng Vietcombank lô máy photocopy Konica Minolta; năm 2024 tiếp tục cung cấp lô 127 máy photocopy Toshiba cho hệ thống Vietcombank toàn quốc.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-3">Bài toán</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Hệ thống chi nhánh và phòng giao dịch Vietcombank trên toàn quốc cần trang bị đồng bộ máy photocopy đa chức năng, đảm bảo tiến độ giao hàng và lắp đặt trên diện rộng.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-3">Giải pháp</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Hương Sơn cung cấp thiết bị theo từng đợt: máy Konica Minolta năm 2022–2023 và lô 127 máy Toshiba năm 2024, phục vụ nhu cầu trang bị và thay thế thiết bị của hệ thống.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-4">Kết quả</h2><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Cung cấp thành công 2 đợt thiết bị cho hệ thống ngân hàng có quy mô toàn quốc.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Lô cung cấp năm 2024 gồm 127 máy Toshiba — quy mô lớn nhất được công bố của Hương Sơn tính đến thời điểm hiện tại.</span>
        </li>
      </ul>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
        <div class="lg:col-span-7">
          ...
          <p class="text-[15.5px] text-gray-600 leading-relaxed mb-6">
            Xem <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/ngan-hang-tai-chinh/">giải pháp liên quan</a>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="proj-vietcombank-cung-cap-may-photocopy-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-proj-vietcombank-cung-cap-may-photocopy-hp">Bỏ trống ô này</label>
            <input type="text" id="f-proj-vietcombank-cung-cap-may-photocopy-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
