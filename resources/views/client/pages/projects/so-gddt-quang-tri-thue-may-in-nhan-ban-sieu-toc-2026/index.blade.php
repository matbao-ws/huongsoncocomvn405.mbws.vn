...
@section('title', "Case study: Sở GD&ĐT Quảng Trị thuê máy in nhân bản Duplo 2026 | Hương Sơn")
@section('meta_description', "Hương Sơn cung cấp 02 máy in nhân bản siêu tốc Duplo, tốc độ 150–155 bản/phút, phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT 2026 cho Sở GD&ĐT Quảng Trị.")
@section('canonical', url('/du-an/so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/du-an/so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026/"
    }
  ]
}</script>
<script type="application/ld+json">{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Thuê máy in nhân bản siêu tốc Duplo phục vụ Kỳ thi Tốt nghiệp THPT 2026",
  "description": "Theo Hợp đồng kinh tế số 200426/HĐKT/TTB/HS-SGDĐT ngày 12/5/2026, Hương Sơn cung cấp dịch vụ thuê 02 máy in nhân bản siêu tốc phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT năm 2026 cho Sở GD&ĐT Quảng Trị. Hợp đồng yêu cầu máy đạt tốc độ khoảng 150–155 bản/phút và giao máy trước thời điểm sử dụng để đơn vị làm quen.",
  "datePublished": "2026",
  "dateModified": "2026",
  "author": {
    "@id": "https://huongsonco.com.vn/#organization"
  ...
  "mainEntityOfPage": "https://huongsonco.com.vn/du-an/so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026/",
  "inLanguage": "vi-VN"
}</script>
@endsection
...
<head>
  ...
  <title>Case study: Sở GD&ĐT Quảng Trị thuê máy in nhân bản Duplo 2026 | Hương Sơn</title>
  <meta name="description" content="Hương Sơn cung cấp 02 máy in nhân bản siêu tốc Duplo, tốc độ 150–155 bản/phút, phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT 2026 cho Sở GD&ĐT Quảng Trị." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/du-an/so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026/" />
  <meta property="og:type" content="article" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Case study: Sở GD&ĐT Quảng Trị thuê máy in nhân bản Duplo 2026 | Hương Sơn" />
  <meta property="og:description" content="Hương Sơn cung cấp 02 máy in nhân bản siêu tốc Duplo, tốc độ 150–155 bản/phút, phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT 2026 cho Sở GD&ĐT Quảng Trị." />
  <meta property="og:url" content="https://huongsonco.com.vn/du-an/so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Thuê máy in nhân bản siêu tốc Duplo phục vụ Kỳ thi Tốt nghiệp THPT 2026" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Thuê máy in nhân bản siêu tốc Duplo phục vụ Kỳ thi Tốt nghiệp THPT 2026</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Sở Giáo dục và Đào tạo Quảng Trị · 2026</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/du-an/" class="hover:text-white transition">Dự án</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Thuê máy in nhân bản siêu tốc Duplo phục vụ Kỳ thi Tốt nghiệp THPT 2026</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-12  " style="background-color: rgb(247, 243, 238);">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Sở Giáo dục và Đào tạo Quảng Trị</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Nhiệm vụ</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Thuê máy in nhân bản siêu tốc phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT 2026</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Thiết bị</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Máy in nhân bản siêu tốc Duplo, tốc độ 150–155 bản/phút – 02 máy</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Thời gian</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">16 ngày theo hợp đồng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Giá trị</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">46.400.000 đồng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Hồ sơ</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Hợp đồng kinh tế số 200426/HĐKT/TTB/HS-SGDĐT ngày 12/5/2026</p>
          </div></div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-10 max-w-4xl">Theo Hợp đồng kinh tế số 200426/HĐKT/TTB/HS-SGDĐT ngày 12/5/2026, Hương Sơn cung cấp dịch vụ thuê 02 máy in nhân bản siêu tốc phục vụ sao đề thi Kỳ thi Tốt nghiệp THPT năm 2026 cho Sở GD&amp;ĐT Quảng Trị. Hợp đồng yêu cầu máy đạt tốc độ khoảng 150–155 bản/phút và giao máy trước thời điểm sử dụng để đơn vị làm quen.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-3">Bài toán</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Sở GD&amp;ĐT Quảng Trị cần thiết bị in sao đề thi tốc độ cao, ổn định trong suốt kỳ thi tốt nghiệp THPT — một nhiệm vụ không được phép gián đoạn.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-3">Giải pháp</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Hương Sơn cung cấp 02 máy in nhân bản siêu tốc Duplo đạt 150–155 bản/phút, giao trước thời điểm sử dụng chính thức để Sở kiểm tra và làm quen thiết bị, đúng theo nguyên tắc điều hành EXAM PRO của Hương Sơn.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-4">Kết quả</h2><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        ...
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Giao máy trước thời điểm sử dụng chính thức, đáp ứng yêu cầu làm quen thiết bị trước kỳ thi.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Duy trì hoạt động ổn định trong suốt thời gian hợp đồng theo yêu cầu của Sở.</span>
        </li>
      </ul>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        ...
        <form class="lead-form" id="proj-so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026-form" method="post" action="/api/lead" novalidate>
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-proj-so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026-hp">Bỏ trống ô này</label>
            <input type="text" id="f-proj-so-gddt-quang-tri-thue-may-in-nhan-ban-sieu-toc-2026-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
