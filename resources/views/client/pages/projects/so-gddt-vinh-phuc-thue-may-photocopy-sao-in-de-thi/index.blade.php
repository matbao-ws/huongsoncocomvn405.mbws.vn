...
@section('title', "Case study: Sở GD&ĐT Vĩnh Phúc thuê máy photocopy in sao đề thi | Hương Sơn")
@section('meta_description', "Hương Sơn cung cấp dịch vụ thuê 02 máy photocopy Toshiba 7518A/8518A phục vụ in sao đề thi cho Sở GD&ĐT tỉnh Vĩnh Phúc, có đầy đủ hồ sơ hợp đồng, bàn giao và nghiệm thu.")
@section('canonical', url('/du-an/so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/du-an/so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi/"
    }
  ]
}</script>
<script type="application/ld+json">{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Thuê máy photocopy phục vụ in sao đề thi – Sở GD&ĐT Vĩnh Phúc",
  "description": "Hương Sơn cung cấp dịch vụ thuê 02 máy photocopy Toshiba 7518A/8518A phục vụ in sao đề thi cho Sở GD&ĐT tỉnh Vĩnh Phúc. Khối lượng thuê thực tế được xác nhận là 04 ngày (thay vì 05 ngày theo hợp đồng ban đầu), thể hiện đầy đủ trong biên bản nghiệm thu.",
  "datePublished": "2025",
  "dateModified": "2025",
  "author": {
    "@id": "https://huongsonco.com.vn/#organization"
  ...
  "mainEntityOfPage": "https://huongsonco.com.vn/du-an/so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi/",
  "inLanguage": "vi-VN"
}</script>
@endsection
...
<head>
  ...
  <title>Case study: Sở GD&ĐT Vĩnh Phúc thuê máy photocopy in sao đề thi | Hương Sơn</title>
  <meta name="description" content="Hương Sơn cung cấp dịch vụ thuê 02 máy photocopy Toshiba 7518A/8518A phục vụ in sao đề thi cho Sở GD&ĐT tỉnh Vĩnh Phúc, có đầy đủ hồ sơ hợp đồng, bàn giao và nghiệm thu." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/du-an/so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi/" />
  <meta property="og:type" content="article" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Case study: Sở GD&ĐT Vĩnh Phúc thuê máy photocopy in sao đề thi | Hương Sơn" />
  <meta property="og:description" content="Hương Sơn cung cấp dịch vụ thuê 02 máy photocopy Toshiba 7518A/8518A phục vụ in sao đề thi cho Sở GD&ĐT tỉnh Vĩnh Phúc, có đầy đủ hồ sơ hợp đồng, bàn giao và nghiệm thu." />
  <meta property="og:url" content="https://huongsonco.com.vn/du-an/so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <header class="site-header bg-[#181924] w-full z-40 transition-all duration-300 border-b border-gray-800/50">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <nav class="hidden xl:flex items-center space-x-6" aria-label="Điều hướng chính">
        ...
        <a href="/du-an/" class="nav-link text-[#1A9900] font-medium text-sm transition py-2">DỰ ÁN</a>
        <div class="relative has-dropdown group py-2">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Thuê máy photocopy phục vụ in sao đề thi – Sở GD&amp;ĐT Vĩnh Phúc" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Case Study Giáo dục</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Thuê máy photocopy phục vụ in sao đề thi – Sở GD&amp;ĐT Vĩnh Phúc</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Sở Giáo dục và Đào tạo tỉnh Vĩnh Phúc · 2025</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/du-an/" class="hover:text-white transition">Dự án</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Thuê máy photocopy phục vụ in sao đề thi – Sở GD&amp;ĐT Vĩnh Phúc</span>
      </nav>
    </div>
  </section>

  <section class="py-12  " style="background-color: rgb(247, 243, 238);">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Khách hàng</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Sở Giáo dục và Đào tạo tỉnh Vĩnh Phúc</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Nhiệm vụ</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Thuê máy photocopy phục vụ in sao đề thi</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Thiết bị</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Toshiba e-STUDIO 7518A / 8518A – 02 máy</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Thời gian</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">05 ngày theo hợp đồng; khối lượng thực tế nghiệm thu 04 ngày</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Giá trị</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Giá trị hợp đồng ban đầu: 17.200.000 đồng; giá trị nghiệm thu sau điều chỉnh: 14.560.000 đồng</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1A9900] mb-1.5">Hồ sơ</p>
            <p class="text-[15px] text-[#181923] font-semibold leading-relaxed">Thương thảo, hợp đồng, bàn giao, nghiệm thu, thanh lý, báo giá</p>
          </div></div>
    </div>
  </section>

  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-10 max-w-4xl">Hương Sơn cung cấp dịch vụ thuê 02 máy photocopy Toshiba 7518A/8518A phục vụ in sao đề thi cho Sở GD&amp;ĐT tỉnh Vĩnh Phúc. Khối lượng thuê thực tế được xác nhận là 04 ngày (thay vì 05 ngày theo hợp đồng ban đầu), thể hiện đầy đủ trong biên bản nghiệm thu.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-3">Bài toán</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Sở GD&amp;ĐT Vĩnh Phúc cần thiết bị in sao đề thi trong thời gian ngắn, đảm bảo tiến độ và bảo mật cho kỳ thi.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-3">Giải pháp</h2><p class="text-[15.5px] text-gray-600 leading-[1.85] mb-8 max-w-4xl">Hương Sơn cung cấp 02 máy photocopy Toshiba 7518A/8518A theo hình thức thuê, kèm hồ sơ đầy đủ từ thương thảo đến thanh lý.</p><h2 class="text-[13px] font-bold uppercase tracking-[0.16em] text-[#181923] mb-4">Kết quả</h2><ul class="grid grid-cols-1 md:grid-cols-1 gap-x-10 gap-y-3.5">
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">02 máy Toshiba 7518A/8518A được giao đúng hợp đồng, xác nhận trong biên bản bàn giao.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Biên bản nghiệm thu xác nhận dịch vụ đúng quy cách, chất lượng và thời gian sử dụng thực tế.</span>
        </li>
        <li class="flex items-start space-x-3">
          <i class="fa-solid fa-check text-[#1A9900] text-xs mt-1.5 flex-shrink-0"></i>
          <span class="text-[15px] text-gray-600 leading-relaxed">Khối lượng thuê được điều chỉnh minh bạch từ 05 xuống 04 ngày theo thực tế sử dụng, thể hiện rõ trong hồ sơ nghiệm thu — không có chênh lệch giữa các bên.</span>
        </li>
      </ul>
    </div>
  </section>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="border-l-4 border-[#1A9900] bg-[#f5f8fb] px-6 py-5">
        <p class="text-[14.5px] text-gray-600 leading-relaxed">Hương Sơn không công bố nội dung đề thi hoặc thông tin vận hành nhạy cảm liên quan đến kỳ thi.</p>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
        <div class="lg:col-span-7">
          ...
          <p class="text-[15.5px] text-gray-600 leading-relaxed mb-6">
            Xem <a class="text-[#1A9900] font-medium hover:underline" href="/giai-phap/giao-duc/in-de-thi/">giải pháp liên quan</a>
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Yêu cầu phương án tương tự</h2>
        ...
        <form class="lead-form" id="proj-so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="project" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-proj-so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi-hp">Bỏ trống ô này</label>
            <input type="text" id="f-proj-so-gddt-vinh-phuc-thue-may-photocopy-sao-in-de-thi-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
