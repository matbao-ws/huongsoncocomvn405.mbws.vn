...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/nhan-tu-van/phuong-an-in-de-thi/"
    }
  ]
}</script>
@endsection
...
<head>
  ...
  <title>Yêu cầu phương án in đề thi – EXAM PRO | Hương Sơn</title>
  <meta name="description" content="Yêu cầu phương án cho thuê máy in đề thi, máy in nhân bản Duplo phục vụ kỳ thi — kèm máy dự phòng, vật tư và kỹ thuật trực." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/nhan-tu-van/phuong-an-in-de-thi/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Yêu cầu phương án in đề thi – EXAM PRO | Hương Sơn" />
  <meta property="og:description" content="Yêu cầu phương án cho thuê máy in đề thi, máy in nhân bản Duplo phục vụ kỳ thi — kèm máy dự phòng, vật tư và kỹ thuật trực." />
  <meta property="og:url" content="https://huongsonco.com.vn/nhan-tu-van/phuong-an-in-de-thi/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Phương án in đề thi" class="w-full h-full object-cover object-center" loading="eager" />
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Phương án in đề thi</h2>
        ...
        <form class="lead-form" id="phuong-an-in-de-thi-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="lead_phuong-an-in-de-thi" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-phuong-an-in-de-thi-hp">Bỏ trống ô này</label>
            <input type="text" id="f-phuong-an-in-de-thi-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
