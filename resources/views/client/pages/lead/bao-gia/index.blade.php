...
@section('canonical', url('/nhan-tu-van/bao-gia/'))
@section('jsonld')
...
<head>
  ...
  <title>Yêu cầu báo giá máy photocopy, máy in, thiết bị văn phòng | Hương Sơn</title>
  <meta name="description" content="Gửi yêu cầu báo giá máy photocopy, máy in nhân bản, máy scan và vật tư. Hương Sơn phản hồi trong giờ làm việc kèm cơ cấu giá rõ ràng." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/nhan-tu-van/bao-gia/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Yêu cầu báo giá máy photocopy, máy in, thiết bị văn phòng | Hương Sơn" />
  <meta property="og:description" content="Gửi yêu cầu báo giá máy photocopy, máy in nhân bản, máy scan và vật tư. Hương Sơn phản hồi trong giờ làm việc kèm cơ cấu giá rõ ràng." />
  <meta property="og:url" content="https://huongsonco.com.vn/nhan-tu-van/bao-gia/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Yêu cầu báo giá" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Yêu cầu báo giá</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Gửi loại thiết bị, số lượng và thời điểm cần — Hương Sơn báo giá kèm cơ cấu giá tách rõ từng khoản, không nhồi một chữ 'trọn gói' gây hiểu nhầm phạm vi.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/nhan-tu-van/" class="hover:text-white transition">Nhận tư vấn</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Yêu cầu báo giá</span>
      </nav>
    </div>
  </section>
