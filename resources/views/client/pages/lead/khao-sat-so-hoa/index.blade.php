...
@section('title', "Yêu cầu khảo sát số hóa tài liệu, hồ sơ | Hương Sơn")
@section('meta_description', "Đăng ký khảo sát số hóa hồ sơ, tài liệu — scan, OCR, chuẩn hóa dữ liệu cho Sở GD&ĐT, trường học và cơ quan Nhà nước.")
@section('canonical', url('/nhan-tu-van/khao-sat-so-hoa/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/nhan-tu-van/khao-sat-so-hoa/"
    }
  ]
}</script>
@endsection
...
<head>
  ...
  <title>Yêu cầu khảo sát số hóa tài liệu, hồ sơ | Hương Sơn</title>
  <meta name="description" content="Đăng ký khảo sát số hóa hồ sơ, tài liệu — scan, OCR, chuẩn hóa dữ liệu cho Sở GD&ĐT, trường học và cơ quan Nhà nước." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/nhan-tu-van/khao-sat-so-hoa/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Yêu cầu khảo sát số hóa tài liệu, hồ sơ | Hương Sơn" />
  <meta property="og:description" content="Đăng ký khảo sát số hóa hồ sơ, tài liệu — scan, OCR, chuẩn hóa dữ liệu cho Sở GD&ĐT, trường học và cơ quan Nhà nước." />
  <meta property="og:url" content="https://huongsonco.com.vn/nhan-tu-van/khao-sat-so-hoa/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Khảo sát số hóa" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Khảo sát số hóa</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Mô tả khối lượng và loại tài liệu cần số hóa — Hương Sơn khảo sát và đề xuất phương án thiết bị, quy trình và đơn giá theo trang.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/nhan-tu-van/" class="hover:text-white transition">Nhận tư vấn</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Khảo sát số hóa</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Khảo sát số hóa</h2>
        ...
        <form class="lead-form" id="khao-sat-so-hoa-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="lead_khao-sat-so-hoa" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-khao-sat-so-hoa-hp">Bỏ trống ô này</label>
            <input type="text" id="f-khao-sat-so-hoa-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
