...
@section('title', "Yêu cầu hỗ trợ kỹ thuật, bảo trì máy photocopy | Hương Sơn")
@section('meta_description', "Gửi yêu cầu hỗ trợ kỹ thuật, bảo trì hoặc sửa chữa máy photocopy, máy in. Hương Sơn tiếp nhận và phân loại mức độ xử lý.")
@section('canonical', url('/nhan-tu-van/yeu-cau-ky-thuat/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/nhan-tu-van/yeu-cau-ky-thuat/"
    }
  ]
}</script>
@endsection
...
<head>
  ...
  <title>Yêu cầu hỗ trợ kỹ thuật, bảo trì máy photocopy | Hương Sơn</title>
  <meta name="description" content="Gửi yêu cầu hỗ trợ kỹ thuật, bảo trì hoặc sửa chữa máy photocopy, máy in. Hương Sơn tiếp nhận và phân loại mức độ xử lý." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/nhan-tu-van/yeu-cau-ky-thuat/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Yêu cầu hỗ trợ kỹ thuật, bảo trì máy photocopy | Hương Sơn" />
  <meta property="og:description" content="Gửi yêu cầu hỗ trợ kỹ thuật, bảo trì hoặc sửa chữa máy photocopy, máy in. Hương Sơn tiếp nhận và phân loại mức độ xử lý." />
  <meta property="og:url" content="https://huongsonco.com.vn/nhan-tu-van/yeu-cau-ky-thuat/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Yêu cầu kỹ thuật" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Yêu cầu kỹ thuật</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Mô tả sự cố hoặc nhu cầu kỹ thuật — Hương Sơn tiếp nhận và phân loại mức độ xử lý theo cam kết SLA.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/nhan-tu-van/" class="hover:text-white transition">Nhận tư vấn</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Yêu cầu kỹ thuật</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Yêu cầu kỹ thuật</h2>
        ...
        <form class="lead-form" id="yeu-cau-ky-thuat-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="lead_yeu-cau-ky-thuat" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-yeu-cau-ky-thuat-hp">Bỏ trống ô này</label>
            <input type="text" id="f-yeu-cau-ky-thuat-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
          ...
          </div><input type="hidden" name="nhu_cau" value="KYTHUAT" />
          <div class="sm:col-span-1">
