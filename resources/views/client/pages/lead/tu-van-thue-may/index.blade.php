...
@section('title', "Tư vấn thuê máy photocopy, máy in theo tháng | Hương Sơn")
@section('meta_description', "Nhận tư vấn thuê máy photocopy, máy in A3/A4, máy scan theo tháng hoặc theo sản lượng — có gói bao mực và bảo trì.")
@section('canonical', url('/nhan-tu-van/tu-van-thue-may/'))
@section('jsonld')
...
<script type="application/ld+json">{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://huongsonco.com.vn/nhan-tu-van/tu-van-thue-may/"
    }
  ]
}</script>
@endsection
...
<head>
  ...
  <title>Tư vấn thuê máy photocopy, máy in theo tháng | Hương Sơn</title>
  <meta name="description" content="Nhận tư vấn thuê máy photocopy, máy in A3/A4, máy scan theo tháng hoặc theo sản lượng — có gói bao mực và bảo trì." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/nhan-tu-van/tu-van-thue-may/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Tư vấn thuê máy photocopy, máy in theo tháng | Hương Sơn" />
  <meta property="og:description" content="Nhận tư vấn thuê máy photocopy, máy in A3/A4, máy scan theo tháng hoặc theo sản lượng — có gói bao mực và bảo trì." />
  <meta property="og:url" content="https://huongsonco.com.vn/nhan-tu-van/tu-van-thue-may/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Tư vấn thuê máy" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Tư vấn thuê máy</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Cho Hương Sơn biết loại thiết bị, sản lượng dự kiến và thời gian thuê — nhận tư vấn gói Basic/Standard/Business/Enterprise phù hợp.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <a href="/nhan-tu-van/" class="hover:text-white transition">Nhận tư vấn</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Tư vấn thuê máy</span>
      </nav>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Tư vấn thuê máy</h2>
        ...
        <form class="lead-form" id="tu-van-thue-may-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="lead_tu-van-thue-may" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-tu-van-thue-may-hp">Bỏ trống ô này</label>
            <input type="text" id="f-tu-van-thue-may-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
