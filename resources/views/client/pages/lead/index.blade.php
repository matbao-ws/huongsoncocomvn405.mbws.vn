...
@section('title', "Nhận tư vấn – Báo giá, thuê máy, in đề thi, số hóa | Hương Sơn")
@section('meta_description', "Gửi yêu cầu tư vấn theo đúng nhu cầu: báo giá, thuê máy, phương án in đề thi, khảo sát số hóa hoặc hỗ trợ kỹ thuật.")
@section('canonical', url('/nhan-tu-van/'))
@section('jsonld')
  ...
  "itemListElement": [
    {
      ...
      "url": "https://huongsonco.com.vn/nhan-tu-van/bao-gia/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Tư vấn thuê máy",
      "url": "https://huongsonco.com.vn/nhan-tu-van/tu-van-thue-may/"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Phương án in đề thi",
      "url": "https://huongsonco.com.vn/nhan-tu-van/phuong-an-in-de-thi/"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Khảo sát số hóa",
      "url": "https://huongsonco.com.vn/nhan-tu-van/khao-sat-so-hoa/"
    },
    {
      "@type": "ListItem",
      "position": 5,
      "name": "Yêu cầu kỹ thuật",
      "url": "https://huongsonco.com.vn/nhan-tu-van/yeu-cau-ky-thuat/"
    },
    {
      "@type": "ListItem",
      "position": 6,
      "name": "Tải hồ sơ năng lực",
      "url": "https://huongsonco.com.vn/ve-huong-son/tai-nguyen/"
    }
  ]
}</script>
@endsection
...
<head>
  ...
  <title>Nhận tư vấn – Báo giá, thuê máy, in đề thi, số hóa | Hương Sơn</title>
  <meta name="description" content="Gửi yêu cầu tư vấn theo đúng nhu cầu: báo giá, thuê máy, phương án in đề thi, khảo sát số hóa hoặc hỗ trợ kỹ thuật." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/nhan-tu-van/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Nhận tư vấn – Báo giá, thuê máy, in đề thi, số hóa | Hương Sơn" />
  <meta property="og:description" content="Gửi yêu cầu tư vấn theo đúng nhu cầu: báo giá, thuê máy, phương án in đề thi, khảo sát số hóa hoặc hỗ trợ kỹ thuật." />
  <meta property="og:url" content="https://huongsonco.com.vn/nhan-tu-van/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <header class="site-header bg-[#181924] w-full z-40 transition-all duration-300 border-b border-gray-800/50">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <nav class="hidden xl:flex items-center space-x-6" aria-label="Điều hướng chính">
        ...
        <a href="/nhan-tu-van/" class="nav-link text-[#1A9900] font-medium text-sm transition py-2">NHẬN TƯ VẤN</a>
      </nav>
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Nhận tư vấn từ Hương Sơn" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      ...
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Nhận tư vấn từ Hương Sơn</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Chọn đúng nhu cầu để được tư vấn nhanh nhất, hoặc gửi yêu cầu chung để Hương Sơn liên hệ.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Nhận tư vấn</span>
      </nav>
    </div>
  </section>
    ...
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="border-l-2 border-[#1A9900] pl-5">
            ...
            <p class="text-[15px] text-[#181923] leading-relaxed">Điểm tiếp nhận yêu cầu tư vấn của Hương Sơn, chia theo 6 loại nhu cầu phổ biến nhất.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Dành cho ai</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Khách hàng đã xác định được nhu cầu cụ thể: báo giá, thuê máy, in đề thi, số hóa, kỹ thuật hoặc tài liệu.</p>
          </div>
          <div class="border-l-2 border-[#1A9900] pl-5">
            <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-[#1A9900] mb-2">Điều gì xảy ra sau khi gửi</p>
            <p class="text-[15px] text-[#181923] leading-relaxed">Yêu cầu được ghi nhận kèm nguồn truy cập và nội dung cụ thể, chuyển tới bộ phận phụ trách để liên hệ trong giờ làm việc.</p>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 bg-white ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <a href="/nhan-tu-van/bao-gia/" class="group border border-gray-200 bg-white p-7 flex flex-col items-start hover:border-[#1A9900] transition">
          <span class="w-12 h-12 bg-[#181924] group-hover:bg-[#1A9900] text-white flex items-center justify-center mb-5 transition"><i class="fa-solid fa-file-invoice-dollar text-lg"></i></span>
          <h3 class="text-[17px] font-bold text-[#181923] group-hover:text-[#1A9900] transition mb-2">Yêu cầu báo giá</h3>
          <span class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider mt-auto pt-3">
            <span>Gửi yêu cầu</span><i class="fa-solid fa-arrow-right text-[10px]"></i>
          </span>
        </a>
        <a href="/nhan-tu-van/tu-van-thue-may/" class="group border border-gray-200 bg-white p-7 flex flex-col items-start hover:border-[#1A9900] transition">
          <span class="w-12 h-12 bg-[#181924] group-hover:bg-[#1A9900] text-white flex items-center justify-center mb-5 transition"><i class="fa-solid fa-handshake text-lg"></i></span>
          <h3 class="text-[17px] font-bold text-[#181923] group-hover:text-[#1A9900] transition mb-2">Tư vấn thuê máy</h3>
          <span class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider mt-auto pt-3">
            <span>Gửi yêu cầu</span><i class="fa-solid fa-arrow-right text-[10px]"></i>
          </span>
        </a>
        <a href="/nhan-tu-van/phuong-an-in-de-thi/" class="group border border-gray-200 bg-white p-7 flex flex-col items-start hover:border-[#1A9900] transition">
          <span class="w-12 h-12 bg-[#181924] group-hover:bg-[#1A9900] text-white flex items-center justify-center mb-5 transition"><i class="fa-solid fa-print text-lg"></i></span>
          <h3 class="text-[17px] font-bold text-[#181923] group-hover:text-[#1A9900] transition mb-2">Phương án in đề thi</h3>
          <span class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider mt-auto pt-3">
            <span>Gửi yêu cầu</span><i class="fa-solid fa-arrow-right text-[10px]"></i>
          </span>
        </a>
        <a href="/nhan-tu-van/khao-sat-so-hoa/" class="group border border-gray-200 bg-white p-7 flex flex-col items-start hover:border-[#1A9900] transition">
          <span class="w-12 h-12 bg-[#181924] group-hover:bg-[#1A9900] text-white flex items-center justify-center mb-5 transition"><i class="fa-solid fa-file-arrow-up text-lg"></i></span>
          <h3 class="text-[17px] font-bold text-[#181923] group-hover:text-[#1A9900] transition mb-2">Khảo sát số hóa</h3>
          <span class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider mt-auto pt-3">
            <span>Gửi yêu cầu</span><i class="fa-solid fa-arrow-right text-[10px]"></i>
          </span>
        </a>
        <a href="/nhan-tu-van/yeu-cau-ky-thuat/" class="group border border-gray-200 bg-white p-7 flex flex-col items-start hover:border-[#1A9900] transition">
          <span class="w-12 h-12 bg-[#181924] group-hover:bg-[#1A9900] text-white flex items-center justify-center mb-5 transition"><i class="fa-solid fa-screwdriver-wrench text-lg"></i></span>
          <h3 class="text-[17px] font-bold text-[#181923] group-hover:text-[#1A9900] transition mb-2">Yêu cầu kỹ thuật</h3>
          <span class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider mt-auto pt-3">
            <span>Gửi yêu cầu</span><i class="fa-solid fa-arrow-right text-[10px]"></i>
          </span>
        </a>
        <a href="/ve-huong-son/tai-nguyen/" class="group border border-gray-200 bg-white p-7 flex flex-col items-start hover:border-[#1A9900] transition">
          <span class="w-12 h-12 bg-[#181924] group-hover:bg-[#1A9900] text-white flex items-center justify-center mb-5 transition"><i class="fa-solid fa-download text-lg"></i></span>
          <h3 class="text-[17px] font-bold text-[#181923] group-hover:text-[#1A9900] transition mb-2">Tải hồ sơ năng lực</h3>
          <span class="inline-flex items-center space-x-1 text-[#1A9900] font-bold text-xs uppercase tracking-wider mt-auto pt-3">
            <span>Gửi yêu cầu</span><i class="fa-solid fa-arrow-right text-[10px]"></i>
          </span>
        </a></div>
  ...
  <section class="py-16 bg-[#f5f8fb] ">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white border border-gray-200 p-6 sm:p-9">
        <h2 class="text-xl sm:text-[26px] font-bold text-[#181923] mb-2">Gửi yêu cầu chung</h2>
        ...
        <form class="lead-form" id="hub-form" method="post" action="/api/lead" novalidate>
          
          <input type="hidden" name="page_type" value="lead_hub" />
          ...
          <div class="hidden" aria-hidden="true">
            <label for="f-hub-hp">Bỏ trống ô này</label>
            <input type="text" id="f-hub-hp" name="_hp" tabindex="-1" autocomplete="off" />
          </div>
