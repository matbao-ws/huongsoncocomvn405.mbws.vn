...
<head>
  ...
  <title>Dịch vụ – Bảo trì, kỹ thuật, vận hành thiết bị | Hương Sơn</title>
  <meta name="description" content="4 nhóm dịch vụ Hương Sơn: bảo trì – sửa chữa, dịch vụ kỹ thuật, vận hành thiết bị, thu mua máy cũ – đổi máy mới." />
  <meta name="robots" content="index,follow" />
  <link rel="canonical" href="https://huongsonco.com.vn/dich-vu/" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Hương Sơn" />
  <meta property="og:title" content="Dịch vụ – Bảo trì, kỹ thuật, vận hành thiết bị | Hương Sơn" />
  <meta property="og:description" content="4 nhóm dịch vụ Hương Sơn: bảo trì – sửa chữa, dịch vụ kỹ thuật, vận hành thiết bị, thu mua máy cũ – đổi máy mới." />
  <meta property="og:url" content="https://huongsonco.com.vn/dich-vu/" />
...
<body class="bg-white text-[#5b5d62] antialiased selection:bg-[#1A9900] selection:text-white">
  ...
  <section class="relative bg-[#181924] min-h-[340px] sm:min-h-[400px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/images/xxx_about-hero_xxx.jpg" alt="Dịch vụ kỹ thuật, bảo trì và vận hành thiết bị" class="w-full h-full object-cover object-center" loading="eager" />
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full text-center">
      <span class="font-handwriting text-3xl text-[#5eb74c] font-bold block mb-2">Technical &amp; Operations</span>
      <h1 class="text-3xl sm:text-[42px] font-bold text-white mb-4 leading-tight">Dịch vụ kỹ thuật, bảo trì và vận hành thiết bị</h1>
      <p class="max-w-3xl mx-auto text-gray-300 text-[15px] leading-relaxed">Bốn nhóm dịch vụ đi kèm mọi hợp đồng thiết bị của Hương Sơn — từ bảo trì, kỹ thuật, vận hành đến đổi máy cũ lấy máy mới.</p>
      <nav class="mt-7 text-[12.5px] text-gray-400 flex items-center justify-center flex-wrap" aria-label="Breadcrumb">
        <a href="/" class="hover:text-white transition">Trang chủ</a> <i class="fa-solid fa-angle-right text-[9px] mx-2 text-gray-500"></i> <span class="text-[#1A9900]" aria-current="page">Dịch vụ</span>
      </nav>
    </div>
  </section>
