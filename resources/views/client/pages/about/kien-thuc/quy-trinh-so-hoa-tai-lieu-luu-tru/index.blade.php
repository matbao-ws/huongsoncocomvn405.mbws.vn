  ...
  <section class="relative bg-[#0d1626] py-12 sm:py-16 overflow-hidden border-b border-white/10 text-white">
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center space-x-2 text-xs text-gray-300 mb-4 flex-wrap">
        ...
        <span>/</span>
        <span class="text-gray-300 truncate max-w-xs">Quy trình số hóa hồ sơ, tài liệu lưu trữ cơ quan Nhà nước và trường học từ A đến Z</span>
      </div>
      <div class="max-w-4xl">
        ...
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white leading-tight mb-4 tracking-tight drop-shadow-md">Quy trình số hóa hồ sơ, tài liệu lưu trữ cơ quan Nhà nước và trường học từ A đến Z</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <figure class="my-8 rounded-lg overflow-hidden border border-gray-200 shadow-md bg-white">
          <div class="h-64 sm:h-80 md:h-[400px] w-full overflow-hidden bg-gray-900/5">
            <img src="/assets/images/hero-projects.jpg" alt="Quy trình số hóa hồ sơ, tài liệu lưu trữ cơ quan Nhà nước và trường học từ A đến Z" class="w-full h-full object-cover" loading="eager" />
          </div>
          <figcaption class="bg-gray-50 px-5 py-3 text-xs text-gray-600 flex flex-col sm:flex-row sm:items-center justify-between gap-1 border-t border-gray-200/80">
            <span><i class="fa-solid fa-camera mr-1.5 text-[#1A9900]"></i>Hình ảnh thiết bị &amp; giải pháp: <strong>Quy trình số hóa hồ sơ, tài liệu lưu trữ cơ quan Nhà nước và trường học từ A đến Z</strong></span>
          ...
          <div class="prose max-w-none text-gray-700">
              ...
              <figure class="my-8 rounded-lg overflow-hidden border border-gray-200/90 shadow-sm bg-white">
                <div class="w-full bg-gray-50 flex items-center justify-center p-3 sm:p-5 min-h-[220px]">
                  <img src="/assets/images/banners/highspeed_scanner_1787905830483.jpg" alt="Quy trình scan và OCR tiếng Việt" class="max-h-[380px] w-auto object-contain mx-auto transition duration-300 hover:scale-[1.02]" loading="lazy" />
                </div>
                <figcaption class="bg-gray-50 px-4 py-2.5 text-xs text-gray-500 italic text-center border-t border-gray-100 flex items-center justify-center gap-1.5">
                  ...
                  <span>Quy trình quét bóc tách và nhận dạng ký tự quang học OCR tiếng Việt đạt chuẩn Thông tư 02/2019/TT-BNV.</span>
                </figcaption>
              </figure>
        ...
        <div id="thiet-bi-phan-mem" class="mb-12 scroll-mt-28">
          ...
          <div class="prose max-w-none text-gray-700">
              ...
              <figure class="my-8 rounded-lg overflow-hidden border border-gray-200/90 shadow-sm bg-white">
                <div class="w-full bg-gray-50 flex items-center justify-center p-3 sm:p-5 min-h-[220px]">
                  <img src="/assets/images/products/ricoh-fi-7600.jpg" alt="Máy scan công nghiệp Ricoh fi-7600" class="max-h-[380px] w-auto object-contain mx-auto transition duration-300 hover:scale-[1.02]" loading="lazy" />
                </div>
                <figcaption class="bg-gray-50 px-4 py-2.5 text-xs text-gray-500 italic text-center border-t border-gray-100 flex items-center justify-center gap-1.5">
                  <i class="fa-solid fa-circle-info text-[#1A9900] text-[11px]"></i>
                  <span>Máy scan công nghiệp Ricoh fi-7600 công suất 44.000 trang/ngày phục vụ các dự án số hóa tài liệu lưu trữ khối lượng lớn.</span>
                </figcaption>
              </figure>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3"><a href="/giai-phap/scan-so-hoa/" class="flex items-center space-x-2 p-3.5 bg-gray-50 border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Giải pháp số hóa tài liệu hồ sơ lưu trữ trọn gói</span></a><a href="/san-pham/may-scan-so-hoa/" class="flex items-center space-x-2 p-3.5 bg-gray-50 border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Danh mục máy scan tài liệu tốc độ cao Ricoh</span></a><a href="/nhan-tu-van/khao-sat-so-hoa/" class="flex items-center space-x-2 p-3.5 bg-gray-50 border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Khảo sát khối lượng tài liệu số hóa tận nơi</span></a></div>
        </div>
        </article>
