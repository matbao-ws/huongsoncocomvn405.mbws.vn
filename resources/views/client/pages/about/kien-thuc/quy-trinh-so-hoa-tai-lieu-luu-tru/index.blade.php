...
@section('meta_description', "Hướng dẫn 7 bước số hóa hồ sơ tài liệu lưu trữ: chuẩn bị tài liệu, quét scan, xử lý ảnh, OCR nhận dạng văn bản, đặt tên file, kiểm tra chất lượng và nhập CSDL.")
...
[
  ...
  },
  {
    ...
    "description": "Cẩm nang hướng dẫn đầy đủ 7 bước chuẩn hóa trong quy trình số hóa tài liệu lưu trữ theo Thông tư 02/2019/TT-BNV: tiêu chuẩn kỹ thuật quét ảnh, phần mềm OCR nhận dạng chữ và phương pháp kiểm soát chất lượng dữ liệu đầu ra.",
  ...
  <section class="py-16 bg-white">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div id="7-buoc-quy-trinh" class="mb-12 scroll-mt-28">
          <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100">3. Chi tiết 7 bước trong quy trình số hóa chuyên nghiệp</h2>
          <div class="prose max-w-none text-gray-700">
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3"><a href="/giai-phap/scan-so-hoa/" class="flex items-center space-x-2 p-3 bg-white border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Giải pháp Scan – Số hóa tài liệu tổng thể</span></a><a href="/san-pham/may-scan-so-hoa/ricoh-fi-8170/" class="flex items-center space-x-2 p-3 bg-white border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Máy scan chuyên dụng Ricoh fi-8170</span></a><a href="/giai-phap/giao-duc/so-hoa-ho-so-truong-hoc/" class="flex items-center space-x-2 p-3 bg-white border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Dự án số hóa hồ sơ cho ngành Giáo dục</span></a><a href="/nhan-tu-van/khao-sat-so-hoa/" class="flex items-center space-x-2 p-3 bg-white border border-gray-200 hover:border-[#1A9900] hover:text-[#1A9900] text-sm font-semibold transition rounded-sm"><i class="fa-solid fa-arrow-right text-[#1A9900] text-xs"></i><span>Đăng ký nhận báo giá &amp; phương án số hóa</span></a></div>
        </div>
        </article>
