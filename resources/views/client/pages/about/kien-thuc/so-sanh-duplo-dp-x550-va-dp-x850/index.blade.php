...
<section class="bg-[#181924] py-16 lg:py-20 text-white relative">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-4xl">
        ...
        <h1 class="text-2xl sm:text-4xl font-bold text-white leading-tight mb-4">So sánh máy in nhân bản siêu tốc Duplo DP-X550 và DP-X850: Lựa chọn nào tối ưu?</h1>
