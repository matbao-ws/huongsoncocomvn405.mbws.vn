...
<section class="bg-[#181924] py-16 lg:py-20 text-white relative">
    <div class="max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-4xl">
        ...
        <h1 class="text-2xl sm:text-4xl font-bold text-white leading-tight mb-4">Cách chọn mực in và linh kiện tiêu hao máy photocopy chính hãng tránh hỏng trống gạt</h1>
