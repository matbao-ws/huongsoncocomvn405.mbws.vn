  ...
  <section class="relative bg-[#0d1626] py-12 sm:py-16 overflow-hidden border-b border-white/10 text-white">
    ...
    <div class="relative z-10 max-w-[1370px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center space-x-2 text-xs text-gray-300 mb-4 flex-wrap">
        ...
        <span>/</span>
        <span class="text-gray-300 truncate max-w-xs">Top 5 dòng máy photocopy cho thuê được các doanh nghiệp lựa chọn nhiều nhất 2026</span>
      </div>
      <div class="max-w-4xl">
        ...
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white leading-tight mb-4 tracking-tight drop-shadow-md">Top 5 dòng máy photocopy cho thuê được các doanh nghiệp lựa chọn nhiều nhất 2026</h1>
        <div class="flex flex-wrap items-center gap-4 text-xs text-gray-300 font-medium pt-3 border-t border-white/10">
          <span class="flex items-center gap-1.5"><i class="fa-regular fa-calendar text-[#5eb74c]"></i>2026-09-20</span>
          <span>•</span>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div class="prose max-w-none text-gray-700">
              ...
              <figure class="my-8 rounded-lg overflow-hidden border border-gray-200/90 shadow-sm bg-white">
                <div class="w-full bg-gray-50 flex items-center justify-center p-3 sm:p-5 min-h-[220px]">
                  <img src="/assets/images/products/toshiba-e-studio-3028a.jpg" alt="Toshiba e-STUDIO 2528A" class="max-h-[380px] w-auto object-contain mx-auto transition duration-300 hover:scale-[1.02]" loading="lazy" />
                </div>
                <figcaption class="bg-gray-50 px-4 py-2.5 text-xs text-gray-500 italic text-center border-t border-gray-100 flex items-center justify-center gap-1.5">
                  ...
                  <span>Toshiba e-STUDIO 2528A / 3028A: Model máy photocopy văn phòng được ưa chuộng nhất nhờ độ bền cao và tiết kiệm năng lượng.</span>
                </figcaption>
              </figure>
        ...
        <div id="huong-dan-chon-theo-quy-mo" class="mb-12 scroll-mt-28">
          ...
          <div class="prose max-w-none text-gray-700">
              ...
              <figure class="my-8 rounded-lg overflow-hidden border border-gray-200/90 shadow-sm bg-white">
                <div class="w-full bg-gray-50 flex items-center justify-center p-3 sm:p-5 min-h-[220px]">
                  <img src="/assets/images/products/120-toshiba-e-studio-6528a.jpg" alt="Toshiba e-STUDIO 6528A công suất lớn" class="max-h-[380px] w-auto object-contain mx-auto transition duration-300 hover:scale-[1.02]" loading="lazy" />
                </div>
                <figcaption class="bg-gray-50 px-4 py-2.5 text-xs text-gray-500 italic text-center border-t border-gray-100 flex items-center justify-center gap-1.5">
                  <i class="fa-solid fa-circle-info text-[#1A9900] text-[11px]"></i>
                  <span>Toshiba e-STUDIO 6528A: Công suất cực lớn 65 trang/phút phục vụ khối in ấn tập trung tại tổng công ty và tập đoàn.</span>
                </figcaption>
              </figure>
