      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <article class="lg:col-span-8">
          <div class="bg-gray-50 border border-gray-200 p-6 mb-10 rounded-sm">
            ...
            <ul class="space-y-1"><li class="mb-2"><a href="#dac-thu-ky-thi" class="text-gray-600 hover:text-[#1A9900] text-[14.5px] transition block leading-relaxed">• 1. Đặc thù và yêu cầu tuyệt đối của kỳ thi THPT</a></li><li class="mb-2"><a href="#tieu-chuan-ky-thuat" class="text-gray-600 hover:text-[#1A9900] text-[14.5px] transition block leading-relaxed">• 2. Tiêu chuẩn kỹ thuật đối với hệ thống máy in sao</a></li><li class="mb-2"><a href="#vi-sao-chon-duplo" class="text-gray-600 hover:text-[#1A9900] text-[14.5px] transition block leading-relaxed">• 3. Vì sao máy in nhân bản Duplo là lựa chọn số 1?</a></li><li class="mb-2"><a href="#phuong-an-du-phong" class="text-gray-600 hover:text-[#1A9900] text-[14.5px] transition block leading-relaxed">• 4. Phương án máy dự phòng N+1 và an toàn vận hành</a></li><li class="mb-2"><a href="#quy-trinh-ban-giao" class="text-gray-600 hover:text-[#1A9900] text-[14.5px] transition block leading-relaxed">• 5. Quy trình bàn giao và cách ly tại khu vực in sao đề thi</a></li></ul>
          </div>
        ...
        <div id="vi-sao-chon-duplo" class="mb-12 scroll-mt-28">
          <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100">3. Vì sao máy in nhân bản Duplo là lựa chọn số 1?</h2>
          <div class="prose max-w-none text-gray-700">
        ...
        <div id="phuong-an-du-phong" class="mb-12 scroll-mt-28">
          <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100">4. Phương án máy dự phòng N+1 và an toàn vận hành</h2>
          <div class="prose max-w-none text-gray-700">
        ...
        <div id="quy-trinh-ban-giao" class="mb-12 scroll-mt-28">
          <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100">5. Quy trình bàn giao và cách ly tại khu vực in sao đề thi</h2>
          <div class="prose max-w-none text-gray-700">
              <p class="text-[15.5px] text-gray-600 leading-[1.85] mb-4">
