  ...
  },
  {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@@type": "Answer",
          "text": "Đúng. Hương Sơn là Đại lý ủy quyền phân phối chính thức Toshiba tại miền Bắc từ năm 2017 và là Đại lý bán hàng Konica Minolta từ năm 2021, cam kết 100% máy mới nguyên đai nguyên kiện và bảo hành chính hãng."
        }
      },
      {
        "@@type": "Question",
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
          ...
          <div class="border border-gray-200 bg-white p-5 rounded-sm">
            ...
            <p class="text-[14.5px] text-gray-600 leading-relaxed pl-6">Đúng. Hương Sơn là Đại lý ủy quyền phân phối chính thức Toshiba tại miền Bắc từ năm 2017 và là Đại lý bán hàng Konica Minolta từ năm 2021, cam kết 100% máy mới nguyên đai nguyên kiện và bảo hành chính hãng.</p>
          </div>
          <div class="border border-gray-200 bg-white p-5 rounded-sm">
            <h4 class="text-base font-bold text-gray-900 mb-2 flex items-start">
              <i class="fa-solid fa-circle-question text-[#1A9900] mr-2.5 mt-1 flex-shrink-0"></i>
