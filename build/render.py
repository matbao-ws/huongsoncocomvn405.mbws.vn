...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/custom.css?v=2.1.0" />{schema_tags}
</head>
...
def drawer():
  ...
  <div class="fixed bottom-6 right-6 z-40 flex flex-col items-center space-y-3 pointer-events-none">
    ...
    <button id="back-to-top" class="pointer-events-auto w-10 h-10 rounded-full bg-gray-900/90 hover:bg-[{BRAND}] text-white flex items-center justify-center shadow-md transition-all duration-300 opacity-0 invisible translate-y-4 hover:scale-110" aria-label="Lên đầu trang">
